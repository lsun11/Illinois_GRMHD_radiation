...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     ...
     write(*,*) "HELLO BEFORE _P gupij_bhns calculation!",cctk_lsh,gxx(9,9,9)
     write(*,*) "HELLO BEFORE _P gupij_bhns calculation: _P LEVEL!",cctk_lsh,gxx_p(9,9,9)
     write(*,*) "HELLO BEFORE _P gupij_bhns calculation: _P_P LEVEL!",cctk_lsh,gxx_p_p(9,9,9)
     ...
     write(*,*) "HELLO BEFORE _P BHNS_compute_Bi_and_update_conservatives"
     ...
     call BHNS_compute_Bi_and_update_conservatives(ext,X,Y,Z,PhysicalRadius, &
          P,rho_b,vx,vy,vz,u0, &
     ...
     !   Remember that the magnetic fields are assumed zero until they are computed inside BHNS_compute_Bi_and_update_conservatives() on each
     !   timelevel. 
     Bx = 0.D0
     By = 0.D0
     Bz = 0.D0

     write(*,*) "HELLO AFTER _P BHNS_compute_Bi_and_update_conservatives"
...
subroutine BHNS_compute_Bi_and_update_conservatives(ext,X,Y,Z,PhysicalRadius, &
     P,rho_b,vx,vy,vz,u0, &
     phi,gxx,gxy,gxz,gyy,gyz,gzz,shiftx,shifty,shiftz,lapm1, &
     tau,mhd_st_x,mhd_st_y,mhd_st_z,st_x,st_y,st_z, &
     A_phi,A_phix,A_phiy,A_phiz, & 
...
end subroutine BHNS_compute_Bi_and_update_conservatives
