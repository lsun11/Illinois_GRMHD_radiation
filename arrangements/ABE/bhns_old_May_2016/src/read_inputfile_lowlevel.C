...
extern "C" void read_inputfile_bhns(const cGH *cctkGH,int genID_cmdline_output_enable,int fisheye_enable,
  ...
  //  int filename_checksum = ext[1]*301+ext[2]*1+ext[0]*1000000 + 1241*CCTK_MyProc(cctkGH)+(int)(999999*dx)+(int)(fabs(xmin)*10.)+(int)(fabs(zmin)*100.) + nStatic;
  char filename[100];
  ...
  if(genID_cmdline_output_enable==1) {
    ...
    //    printf("blah %d %d %d %d %d %d %d %d\n",ext[1]*301,ext[2]*1,ext[0]*1000000,1241*CCTK_MyProc(cctkGH),(int)(999999*dx),(int)(fabs(xmin)*10.),
    //	   (int)(fabs(zmin)*100.),(int)(fabs(xmax)*9999));
  } else {
