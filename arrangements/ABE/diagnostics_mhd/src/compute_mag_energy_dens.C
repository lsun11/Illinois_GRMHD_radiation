...
extern "C" void CCTK_FCALL CCTK_FNAME(compute_mag_energy_dens_cpp)
  (const cGH **cctkGH,int *cctk_lsh, double *phi, double *lapm1, 
   ...
   double *gyy, double *gyz, double *gzz, double *half_b2u0sqrtg, double *Tem0_0_sqrtg, double *b2);

void compute_mag_energy_dens_cpp(const cGH *cctkGH,int *cctk_lsh, double *phi, 
   double *lapm1, double *shiftx, double *shifty, double *shiftz, double *vx, 
   double *vy, double *vz, double *Bx, double *By, double *Bz,
   double *gxx, double *gxy, double *gxz, double *gyy, double *gyz, 
   double *gzz, double *half_b2u0sqrtg, double *Tem0_0_sqrtg, double *b2_global) { 
...
#pragma omp parallel for
  for(int k=0;k<cctk_lsh[2];k++)
	...
	if(b2>0.1) printf("B2 too big in compute_mag_energy_dens_cpp, b2=%e \t psi4=%e\n",b2,psi4);
	b2_global[index]=b2;
...
extern "C" void CCTK_FCALL CCTK_FNAME(compute_mag_energy_dens_cpp)
  (const cGH **cctkGH,int *cctk_lsh, double *phi, double *lapm1, 
   ...
   double *half_b2u0sqrtg, double *Tem0_0_sqrtg, double *b2) 
{
  compute_mag_energy_dens_cpp(*cctkGH, cctk_lsh, phi, lapm1, shiftx,shifty,shiftz,
                           vx,vy,vz, Bx,By,Bz, gxx, gxy, gxz, gyy, gyz, gzz, 
                           half_b2u0sqrtg,Tem0_0_sqrtg,b2);
}
