...
extern "C" void CCTK_FCALL CCTK_FNAME(mag_bondi_compute_b2_cpp)
...
void mag_bondi_compute_b2_cpp(const cGH *cctkGH,int *cctk_lsh, double *phi, 
...
{
  mag_bondi_compute_b2_cpp(*cctkGH, cctk_lsh, phi, lapm1, shiftx,shifty,shiftz,
