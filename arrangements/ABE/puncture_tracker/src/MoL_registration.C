...
extern "C" void puncture_tracker_RegisterVars(CCTK_ARGUMENTS)
{
  ...
  // Register evolution & RHS groups
  group = CCTK_GroupIndex("puncture_tracker::punc_pos_vars");
  rhs = CCTK_GroupIndex("puncture_tracker::punc_pos_rhs");
