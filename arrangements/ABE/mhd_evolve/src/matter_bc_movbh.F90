subroutine matter_bc_mhd_movbh(ext, xc,yc,zc,bigP,RP,DR,X, Y, Z, &
     ...
     nvec,dvec,rhovec,Pvec,vvec,have_bdry_min,have_bdry_max, compute_microphysics, enable_OS_collapse, rad_evolve_enable, rad_closure_scheme)
  implicit none
...
! Storage variables:
  ...
  real*8			     :: E_radl,F_radxl,F_radyl,F_radzl,F_rad0l,Y_el
