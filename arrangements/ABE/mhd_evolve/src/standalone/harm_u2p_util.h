...
extern void primtoU_g( FTYPE prim[], FTYPE gcov[][NDIM], FTYPE gcon[][NDIM], FTYPE gdet,  FTYPE U[], FTYPE &P_cold, FTYPE &eps_cold, int &neos, int &ergo_star, FTYPE &ergo_sigma, FTYPE T_fluid, FTYPE *rho_tab, FTYPE *P_tab, FTYPE *k_tab, FTYPE *gamma_tab, FTYPE *eps_tab, int &enable_OS_collapse, int &compute_microphysics);
