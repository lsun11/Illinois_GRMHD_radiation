...
inline void find_cp_cm_rad2_nue(double &cplus,double &cminus,double &v02,double &u0,
                       double &vi,double &lapse,double &shifti,double &psim4,double &gupii);


extern "C" void CCTK_FCALL CCTK_FNAME(flux_rad_nue_cpp)
...
extern "C" void flux_rad_nue_cpp(int flux_direction, const cGH *cctkGH,int *ext,double *X,double *Y,double *Z,
			     double *tau_rad_flux, double *tau_rad_flux_diag,
			     double *S_radx_flux, double *S_rady_flux, double *S_radz_flux,
			     double *E_radr, double *E_radl,
			     double *F_radxr, double *F_radxl,
...
#pragma omp parallel for
	...
	for(int i=istart;i<iend;i++) {
	  ...
	  if (rad_closure_scheme ==0)
	      ...
	      if (flux_direction==1) {
		find_cp_cm_rad2_nue(cplusl,cminusl,v02lL,u0l,
				vxlL,alpha_fL,betax_fL,psim4,gupxx_fL);
		find_cp_cm_rad2_nue(cplusr,cminusr,v02rL,u0r,
...
void flux_hll_cpp_frad_nue(int *ext,double &Ur,double &Ul,double &Fr,double &Fl,double &F,double &cmax,double &cmin) {
