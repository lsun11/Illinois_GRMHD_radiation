/*
  Compute gupij_wdns's.  You need to do this after every regridding,
...
CCTK_FILEVERSION(BSSN_compute_gupij_wdns)


  extern "C" void CCTK_FCALL CCTK_FNAME(BSSN_compute_gupij_wdns)
  (const cGH **cctkGH,int *cctk_lsh,
   double *gxx,double *gxy,double *gxz,double *gyy,double *gyz,double *gzz,
   double *gupxx,double *gupxy,double *gupxz,double *gupyy,double *gupyz,double *gupzz);


extern "C" void BSSN_compute_gupij_wdns(const cGH *cctkGH,int *cctk_lsh,
				   double *gxx,double *gxy,double *gxz,double *gyy,double *gyz,double *gzz,
				   double *gupxx,double *gupxy,double *gupxz,double *gupyy,double *gupyz,double *gupzz) {
...
extern "C" void CCTK_FCALL CCTK_FNAME(BSSN_compute_gupij_wdns)
  (const cGH **cctkGH,int *cctk_lsh,
   ...
   double *gupxx,double *gupxy,double *gupxz,double *gupyy,double *gupyz,double *gupzz)
{
  BSSN_compute_gupij_wdns(*cctkGH,cctk_lsh,
