...
subroutine WDNS_setup_emfield_part1_Pmax(CCTK_ARGUMENTS)
  implicit none
  ...
  if(CCTK_ITERATION .eq. ITERATION_TO_RESET_MAGNETIC_FIELDS .or. CCTK_ITERATION .eq. 0) then
     ...
     wdns_P_max = reduction_value

     write(*,*) "INSIDE WDNS_setup_emfield_part1_Pmax.  PMAX = ",wdns_P_max
  end if

end subroutine WDNS_setup_emfield_part1_Pmax
