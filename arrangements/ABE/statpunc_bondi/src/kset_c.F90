...
!
!-----------------------------------------------------------------------------
subroutine statpunc_kset_c(ex, X, Y, Z,  &
     Axx, Axy, Axz, Ayy, Ayz, Azz, trK, &
     gxx, gxy, gxz, gyy, gyz, gzz, &
     betax, betay, betaz, lapse,  &
     Symmetry) !,glob_imin,glob_jmin,glob_kmin,Nx,Nz,  &
!     PI_SYMM_betax,PI_SYMM_betay,PI_SYMM_betaz,  &
!     PI_SYMM_gxx,PI_SYMM_gxy,PI_SYMM_gxz,  &
!     PI_SYMM_gyy,PI_SYMM_gyz,PI_SYMM_gzz)
  implicit none
  interface
...
!----------------------------------------------------------
  Axx = ( betax*gxxx + betay*gxxy + betaz*gxxz &
       ...
       + gxx*betaxx + gxy*betayx + gxz*betazx) & 
       / (TWO * (lapse + ONE) )
  write(*,*) "inside kset_c: ",Axx(2,2,2),betax(2,2,2),gxxx(2,2,2),betay(2,2,2),gxxy(2,2,2),betaz(2,2,2),gxxz(2,2,2),gxx(2,2,2),betaxx(2,2,2),gxy(2,2,2),gxz(2,2,2),betazx(2,2,2),gxx(2,2,2),betaxx(2,2,2),gxy(2,2,2),betayx(2,2,2),gxz(2,2,2),betazx(2,2,2),lapse(2,2,2),gxz(2,2,2)
  !write(*,*) "inside kset_c: ",Axx(2,2,2),betax(2,2,2),gxxx(2,2,2),betay(2,2,2),gxxy(2,2,2),betaz(2,2,2),gxxz(2,2,2),gxx(2,2,2),betaxx(2,2,2),gxy(2,2,2),gxz(2,2,2),betazx(2,2,2),gxx(2,2,2),betaxx(2,2,2),gxy(2,2,2),betayx(2,2,2),gxz(2,2,2),betazx(2,2,2),lapse(2,2,2),gxz(2,2,2)
...
!  Axx = (2.D0*gxx*betaxx + betax*gxxx * 2.D0 - (2.D0/3.D0)*(betaxx + betayy + betazz) ) / (TWO * (lapse + ONE) )

! * betaxx - (2.D0/3.D0) * (betaxx + betayy + betazz) ) / (TWO * (lapse + ONE) ) 
...
!  endif
end subroutine statpunc_kset_c
