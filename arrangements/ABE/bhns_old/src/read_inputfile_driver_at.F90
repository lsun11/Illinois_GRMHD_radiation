...
!  integer               :: nphase
  ...
  write(6, *)  " VVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVV"
  Allocate(abc(0:20))
  Allocate(abi(0:20))
  Allocate(rhoi(0:20))
  Allocate(tedi(0:20))
  write(6, *)  " HHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH"
  ...
  write(6,*) "$$$$$$$$$$$$$$$$$$$$$$$$$$$ ENTER read_inputfile_driver.F90 $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$"
...
!           gamma1, gamma2, gamma3, kappa1, kappa2, kappa3, rhoo1, rhoo2)
     ...
     write(6,*) "QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ nphase = ", nphase
  ...
  if(piecewise.eq.0) then  
     ...
     ! neos=2
     neos = nphase-1    ! **** Number of interfaces ****
                        ! **** nphase = neos + 1    ****

     write(6,* ) "AAAAAAAAAAAAAAAAAAAAAAAAAAA neos=", neos 
     ...
     do ia=1, neos
       ! Transition densities, pressures, specific internal energies
       rho_tab(ia) = rhoi(ia)
       P_tab(ia)   = k_tab(ia)*(rho_tab(ia)**gamma_tab(ia))
       eps_tab(ia) = tedi(ia)/rhoi(ia) - 1.0d0
     end do
...
!     eps_tab(2) = an2*P_tab(2)/rho_tab(2) + c2
  ...
  write(6,*) "$$$$$$$$$$$$$$$$$$$$$$$$$$$ EXIT read_inputfile_driver.F90 $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$"
