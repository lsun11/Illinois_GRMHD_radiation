...
subroutine compute_magnetar_hybrid_bhns(ex, DEPLETION, RADEQUAT, DELTA, &
     ...
     rho_b, u0, h, rho_b_atm, Omega_Frame,PhysR,eps_flag,K_poly,n,RESET_RHO_B_ATM,rhob_fac2)
  implicit none
...
!  integer, dimension(3)                    :: ext
  integer				   :: neos, RESET_RHO_B_ATM
  real*8, dimension(neos)                  :: rho_tab,P_tab,eps_tab
  real*8, dimension(neos+1)                :: k_tab, gamma_tab
  real*8                                   :: rho_b_atm, gamma_th, rhob_fac2, rho_b_atm2
