...
!       write(6,*)  "nnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn"
!       write(6,*)  eps_tab(ia-1)
!       write(6,*)  P_tab(ia)/rho_tab(ia)
!       write(6,*)  P_tab(ia-1)/rho_tab(ia-1)
!       write(6,*)  gamma_tab(ia)
!       write(6,*)  (P_tab(ia)/rho_tab(ia) - P_tab(ia-1)/rho_tab(ia-1))/(gamma_tab(ia)-1.0d0)
!       write(6,*)  "nnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn"
...
!  print *, "eps=",eps_tab(1),eps_tab(2),eps_tab(3)
