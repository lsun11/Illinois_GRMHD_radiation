...
write(*,*) 'In bhns local2, rho_b_atm = ',rho_b_atm,dX
  ...
  write(6,*) "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ ENTER bhns_initialdata_local2  @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
...
!      elsewhere ( ( (rho_b - rho_tab(1))/rho_tab(1).gt. 1.d-15).and.(  (rho_b - rho_tab(2))/rho_tab(2).le.1.d-15 ) )
...
!     if((rho_b - rho_tab(1))/rho_tab(1).le.1.0d-15) then
     ...
     elsewhere((rho_b - rho_tab(neos))/rho_tab(neos).ge.1.0d-15) 
       ...
       h    = (eps_tab(neos) + P_tab(neos))/rho_tab(neos) &
     ...
     do ia=1,neos-1
       where(((rho_b - rho_tab(ia))*(rho_b - rho_tab(ia+1))).le.0.0d0) 
         ...
         h    = (eps_tab(ia) + P_tab(ia))/rho_tab(ia) &
     ...
     do i=1,cctk_lsh(1)
       write(6,*) "PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP", P(i,1,1), h(i,1,1)
     end do
  ...
  write(6,*) "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ EXIT bhns_initialdata_local2 @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
