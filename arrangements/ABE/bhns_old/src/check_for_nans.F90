subroutine check_for_nans(ext,rho_b,P,vx,vy,vz, phi,lapm1,shiftx,shifty,shiftz, gxx,gxy,gxz,gyy,gyz,gzz,gupxx,gupxy,gupxz,gupyy,gupyz,gupzz, &  
  ...
  INTEGER :: i,j,k
  real*8, dimension(ext(1),ext(2),ext(3))  :: rho_b,P,vx,vy,vz, phi,lapm1,shiftx,shifty,shiftz, gxx,gxy,gxz,gyy,gyz,gzz,gupxx,gupxy,gupxz,gupyy,gupyz,gupzz,& 
        Bx,By,Bz,rho_star,tau,st_x,st_y,st_z
