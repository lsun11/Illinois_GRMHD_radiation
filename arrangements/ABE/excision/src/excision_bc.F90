...
!-------------------------------------------------------------------------+
!
! Use Alcubierre's simple excision method
!
...
!-------------------------------------------------------------------------+
!
! Use Alcubierre's simple excision method for scalar
!
...
!-------------------------------------------------------------------------+
!
! Use Alcubierre's simple excision method for vector components
!                                             (or for 3 scalars)
! excision region : sphere
!
!-------------------------------------------------------------------------+
