...
subroutine lm_modes(cctkGH,Symmetry,l,m,N_theta,N_phi,ntot, &
  ...
  do i=1,N_theta
     ...
     do j=1,N_phi
        ...
        !==============================================================================
        ! IMPORTANT DERIVATION DON'T DELETE:
        ! Notice that we've already divided Xlmr, Xlmi by sintheta!
        ...
        !==============================================================================
        ! Okay, Xlmi and Xlmr are antisymmetric across the equatorial plane, and the Wlm's are symmetric
        !  Also, the Psi4re is symmetric and Psi4im is antisymmetric.
        !  We must throw away all equatorially antisymmetric products manually, or we'll get a wrong answer.
        ...
        !    Integrand = Y^{star}lm(s=-2) Yl'm'(s=-2)
