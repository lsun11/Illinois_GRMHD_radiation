...
!!$       if(dm(i,j,k)==outEZ) then
      ...
      if(im+4-1 .gt. imax) then
         ...
         !  This is a global grid operation, but shouldn't happen very often.
...
!         call return_funcvals_at_points(cctkGH,1,ext,cctk_gsh,dX,dY,dZ,Xlocal1d,Ylocal1d,Zlocal1d,Xglobal,Yglobal,Zglobal,pointcoords,fxx,fxxa(4))
!         call return_funcvals_at_points(cctkGH,1,ext,cctk_gsh,dX,dY,dZ,Xlocal1d,Ylocal1d,Zlocal1d,Xglobal,Yglobal,Zglobal,pointcoords,fxy,fxya(4))
!         call return_funcvals_at_points(cctkGH,1,ext,cctk_gsh,dX,dY,dZ,Xlocal1d,Ylocal1d,Zlocal1d,Xglobal,Yglobal,Zglobal,pointcoords,fxz,fxza(4))
!         call return_funcvals_at_points(cctkGH,1,ext,cctk_gsh,dX,dY,dZ,Xlocal1d,Ylocal1d,Zlocal1d,Xglobal,Yglobal,Zglobal,pointcoords,fyy,fyya(4))
!         call return_funcvals_at_points(cctkGH,1,ext,cctk_gsh,dX,dY,dZ,Xlocal1d,Ylocal1d,Zlocal1d,Xglobal,Yglobal,Zglobal,pointcoords,fyz,fyza(4))
!         call return_funcvals_at_points(cctkGH,1,ext,cctk_gsh,dX,dY,dZ,Xlocal1d,Ylocal1d,Zlocal1d,Xglobal,Yglobal,Zglobal,pointcoords,fzz,fzza(4))
