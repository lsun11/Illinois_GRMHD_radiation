...
subroutine BNS_finalize_initialdata(CCTK_ARGUMENTS)
  ...
  real*8 			           :: dT,dX,dY,dZ,P_max,q_max,tau_max,rho_max,rhos_max,rho_fail_max_step,M_fail_step,q_atmos
...
!  double * Zh; Zh = new double[Nzh*2];
  ...
  glob_imax = cctk_lsh(1)
  glob_jmax = cctk_lsh(2)
  glob_kmax = cctk_lsh(3)
