...
subroutine bns_dump_binfiles(CCTK_ARGUMENTS)
  implicit none
...
!     call setup_global_coord_arrays(CCTK_PASS_FTOF)
     ...
     if(Symmetry == EQUATORIAL) then
        if(Z(1,1,1) .lt. 0.D0) then
           kadj = kadj + cctk_nghostzones(3)
        end if
     end if

    ! Dump bin files
     open(19,file='DUMP_Input',status='old')
     do 
    ...
    ! This is ugly. Need to fix it later.
       if (filename=='phi') then 
          call bns_outputbinfile(ierr,cctkGH,cctk_gsh,cctk_lsh,local_origin,cctk_time,xyz_glob_min,xyz_glob_max,cctk_iteration,phi,filename,Symmetry)
       elseif (filename=='rho_b') then
          call bns_outputbinfile(ierr,cctkGH,cctk_gsh,cctk_lsh,local_origin,cctk_time,xyz_glob_min,xyz_glob_max,cctk_iteration,rho_b,filename,Symmetry)
       elseif (filename=='rho_star') then
          call bns_outputbinfile(ierr,cctkGH,cctk_gsh,cctk_lsh,local_origin,cctk_time,xyz_glob_min,xyz_glob_max,cctk_iteration,rho_star,filename,Symmetry)
       elseif (filename=='P') then
          call bns_outputbinfile(ierr,cctkGH,cctk_gsh,cctk_lsh,local_origin,cctk_time,xyz_glob_min,xyz_glob_max,cctk_iteration,P,filename,Symmetry)
       elseif (filename=='vx') then
          call bns_outputbinfile(ierr,cctkGH,cctk_gsh,cctk_lsh,local_origin,cctk_time,xyz_glob_min,xyz_glob_max,cctk_iteration,vx,filename,Symmetry)
       elseif (filename=='vy') then
          call bns_outputbinfile(ierr,cctkGH,cctk_gsh,cctk_lsh,local_origin,cctk_time,xyz_glob_min,xyz_glob_max,cctk_iteration,vy,filename,Symmetry)
       elseif (filename=='vz') then
          call bns_outputbinfile(ierr,cctkGH,cctk_gsh,cctk_lsh,local_origin,cctk_time,xyz_glob_min,xyz_glob_max,cctk_iteration,vz,filename,Symmetry)
       elseif (filename=='lapm1') then
          call bns_outputbinfile(ierr,cctkGH,cctk_gsh,cctk_lsh,local_origin,cctk_time,xyz_glob_min,xyz_glob_max,cctk_iteration,lapm1,filename,Symmetry)
       elseif (filename=='Bx') then
          call bns_outputbinfile(ierr,cctkGH,cctk_gsh,cctk_lsh,local_origin,cctk_time,xyz_glob_min,xyz_glob_max,cctk_iteration,Bx,filename,Symmetry)
       elseif (filename=='By') then
          call bns_outputbinfile(ierr,cctkGH,cctk_gsh,cctk_lsh,local_origin,cctk_time,xyz_glob_min,xyz_glob_max,cctk_iteration,By,filename,Symmetry)
       elseif (filename=='Bz') then
          call bns_outputbinfile(ierr,cctkGH,cctk_gsh,cctk_lsh,local_origin,cctk_time,xyz_glob_min,xyz_glob_max,cctk_iteration,Bz,filename,Symmetry)
       elseif (filename=='shifty') then 
          call bns_outputbinfile(ierr,cctkGH,cctk_gsh,cctk_lsh,local_origin,cctk_time,xyz_glob_min,xyz_glob_max,cctk_iteration,shifty,filename,Symmetry)
       else 
...
end subroutine bns_dump_binfiles
