...
!  Azz = Azz*exp(-4.d0*phi)
 ...
 gamma_th = 1.d0 + 1.d0/n_poly
  ...
  write(*,*) "AFTER compute_OS_rad_hybrid F_rad0(20,2,2): ",F_rad0(20,2,2)
  ...
  call CartSymGN(dummy,cctkGH,'rad_evolve::rad_conservatives')
  call CartSymGN(dummy,cctkGH,'rad_evolve::rad_primitives')
  ...
  !is this correct?
  call CartSymGN(dummy,cctkGH,'rad_evolve::rad_conservatives')
  call CCTK_SyncGroup(dummy,cctkGH,'rad_evolve::rad_conservatives')
  call CartSymGN(dummy,cctkGH,'rad_evolve::rad_primitives')
  call CCTK_SyncGroup(dummy,cctkGH,'rad_evolve::rad_primitives')
...
!  end do
  ...
  write(*,*) "AT END OF OS_rad_finalize_initialdata F_rad0(20,2,2): ",F_rad0(20,2,2)
