...
subroutine disk_moncrief_matter_local_2(CCTK_ARGUMENTS)
  implicit none
...
!!!!!!FIX THIS!!!!!!!!!!!!!
  ...
  ah1_radii_last_disk_moncrief = 1.d0
  ah2_radii_last_disk_moncrief = 1.d0
!temporary
  xh1_last_disk_moncrief = -10.0125d0
  xh2_last_disk_moncrief = 10.0125d0
  yh1_last_disk_moncrief = 0.0
  yh2_last_disk_moncrief = 0.0
  zh1_last_disk_moncrief = 0.d0
  zh2_last_disk_moncrief = 0.d0
!!!!!!FIX THIS!!!!!!!!!!!!!

  surf1_radii_last_disk_moncrief = 0.d0
  surf2_radii_last_disk_moncrief = 0.d0
  surf3_radii_last_disk_moncrief = 0.d0
  surf4_radii_last_disk_moncrief = 0.d0

end subroutine disk_moncrief_matter_local_2
