...
extern "C" void CCTK_FCALL CCTK_FNAME(hbpuncture_upwind_2)
...
extern "C" void hbpuncture_upwind_2(const cGH *cctkGH,int *nghostzones,int *cctk_lsh,
...
extern "C" void CCTK_FCALL CCTK_FNAME(hbpuncture_upwind_2)
  (const cGH **cctkGH,int *nghostzones,int *cctk_lsh,double *dT, double *dx, double *dy, double *dz,
   ...
   double *tempx,double *tempy,double *tempz,int *Symmetry) 
{
  hbpuncture_upwind_2(*cctkGH,nghostzones,cctk_lsh, *dT,  *dx,  *dy,  *dz,
