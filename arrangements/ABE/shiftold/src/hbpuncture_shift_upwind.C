...
extern "C" void CCTK_FCALL CCTK_FNAME(hbpuncture_upwind)
...
extern "C" void hbpuncture_upwind(const cGH *cctkGH,int *nghostzones,int *cctk_lsh,
	...
	for(int i=istart;i<iend;i++) {
	  ...
	  if(betazL > 0.0) {
	    ...
	    dtshiftz_rhsL += betazL*D3_up_lt_gf(dtshiftz_old,i,j,k);
          ...
          // This turns our shift evolution equation to 000, in the parlance of arXiv:gr-qc/0610128v1, 
          //  which makes the linearized BSSN equations strongly hyperbolic (arXiv:gr-qc/0605030v2, Table 1: YYY choice)
...
extern "C" void CCTK_FCALL CCTK_FNAME(hbpuncture_upwind)
  (const cGH **cctkGH,int *nghostzones,int *cctk_lsh,double *dT, double *dx, double *dy, double *dz,
   ...
   double *tempx,double *tempy,double *tempz,int *Symmetry) 
{
  hbpuncture_upwind(*cctkGH,nghostzones,cctk_lsh, *dT,  *dx,  *dy,  *dz,
