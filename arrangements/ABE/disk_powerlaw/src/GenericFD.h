...
#define D21_c6(gf,i,j,k)                    \
       ((+  2. *gf[CCTK_GFINDEX3D(cctkGH,i+3,j+3,k)] \
         -  2. *gf[CCTK_GFINDEX3D(cctkGH,i+3,j-3,k)] \
         - 27. *gf[CCTK_GFINDEX3D(cctkGH,i+2,j+2,k)] \
         + 27. *gf[CCTK_GFINDEX3D(cctkGH,i+2,j-2,k)] \
         + 270.*gf[CCTK_GFINDEX3D(cctkGH,i+1,j+1,k)] \
         - 270.*gf[CCTK_GFINDEX3D(cctkGH,i+1,j-1,k)] \
         - 270.*gf[CCTK_GFINDEX3D(cctkGH,i-1,j+1,k)] \
         + 270.*gf[CCTK_GFINDEX3D(cctkGH,i-1,j-1,k)] \
         + 27.* gf[CCTK_GFINDEX3D(cctkGH,i-2,j+2,k)] \
         - 27.* gf[CCTK_GFINDEX3D(cctkGH,i-2,j-2,k)] \
         -  2.* gf[CCTK_GFINDEX3D(cctkGH,i-3,j+3,k)] \
         +  2.* gf[CCTK_GFINDEX3D(cctkGH,i-3,j-3,k)]) * dxi * dyi / 720.)


#define D32_c6(gf,i,j,k)                    \
       ((+  2. *gf[CCTK_GFINDEX3D(cctkGH,i,j+3,k+3)] \
         -  2. *gf[CCTK_GFINDEX3D(cctkGH,i,j+3,k-3)] \
         - 27. *gf[CCTK_GFINDEX3D(cctkGH,i,j+2,k+2)] \
         + 27. *gf[CCTK_GFINDEX3D(cctkGH,i,j+2,k-2)] \
         + 270.*gf[CCTK_GFINDEX3D(cctkGH,i,j+1,k+1)] \
         - 270.*gf[CCTK_GFINDEX3D(cctkGH,i,j+1,k-1)] \
         - 270.*gf[CCTK_GFINDEX3D(cctkGH,i,j-1,k+1)] \
         + 270.*gf[CCTK_GFINDEX3D(cctkGH,i,j-1,k-1)] \
         + 27.* gf[CCTK_GFINDEX3D(cctkGH,i,j-2,k+2)] \
         - 27.* gf[CCTK_GFINDEX3D(cctkGH,i,j-2,k-2)] \
         -  2.* gf[CCTK_GFINDEX3D(cctkGH,i,j-3,k+3)] \
         +  2.* gf[CCTK_GFINDEX3D(cctkGH,i,j-3,k-3)]) * dzi * dyi / 720.)

#define D31_c6(gf,i,j,k)                    \
       ((+  2. *gf[CCTK_GFINDEX3D(cctkGH,i+3,j,k+3)] \
         -  2. *gf[CCTK_GFINDEX3D(cctkGH,i+3,j,k-3)] \
         - 27. *gf[CCTK_GFINDEX3D(cctkGH,i+2,j,k+2)] \
         + 27. *gf[CCTK_GFINDEX3D(cctkGH,i+2,j,k-2)] \
         + 270.*gf[CCTK_GFINDEX3D(cctkGH,i+1,j,k+1)] \
         - 270.*gf[CCTK_GFINDEX3D(cctkGH,i+1,j,k-1)] \
         - 270.*gf[CCTK_GFINDEX3D(cctkGH,i-1,j,k+1)] \
         + 270.*gf[CCTK_GFINDEX3D(cctkGH,i-1,j,k-1)] \
         + 27.* gf[CCTK_GFINDEX3D(cctkGH,i-2,j,k+2)] \
         - 27.* gf[CCTK_GFINDEX3D(cctkGH,i-2,j,k-2)] \
         -  2.* gf[CCTK_GFINDEX3D(cctkGH,i-3,j,k+3)] \
         +  2.* gf[CCTK_GFINDEX3D(cctkGH,i-3,j,k-3)]) * dzi * dxi / 720.)
