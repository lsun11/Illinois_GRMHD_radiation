...
subroutine OS_toy_diagnostics(CCTK_ARGUMENTS)
  ...
  real*8                                   :: rho_analytic,SymmFactor
...
!     print *,"J_ADM_VolInt=",J_ADM_VolInt,"SymmFactor=",SymmFactor                             
     ...
     ! J_ADM volume integral is computed in scheduler of diagnostics_vacuum                     
     data_headers(14) = "J_1.1exVolr"
     export_data(14) = J_ADM_VolInt_inner*SymmFactor

     ! J_ADM volume integral is computed in scheduler of diagnostics_vacuum                     
     data_headers(15) = "J_1.1exVolr/2"
     export_data(15) = J_ADM_VolInt_inner2*SymmFactor
