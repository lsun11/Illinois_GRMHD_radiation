...
!------------------------------------
subroutine bbh_cookpfeiffer_rot_diagnostics(CCTK_ARGUMENTS)
...
!!$     omega = sqrt(Mass_adm/(binary_separation*binary_separation*binary_separation))*(1.0+Mass_adm/(2.0*binary_separation)*(eta-3.0)); 
