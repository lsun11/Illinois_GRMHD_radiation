/*@@
   ...
   @desc
              ...
              calling routine
   @enddesc
   @version $Header: /cactus/CactusEinstein/StaticConformal/src/ConfPhys.c,v 1.4 2004/05/17 12:28:57 goodale Exp $
 @@*/
                    

#include "cctk.h"

static const char *rcsid = "$Header: /cactus/CactusEinstein/StaticConformal/src/ConfPhys.c,v 1.4 2004/05/17 12:28:57 goodale Exp $";
