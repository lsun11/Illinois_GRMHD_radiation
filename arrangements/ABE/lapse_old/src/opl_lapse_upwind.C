...
extern "C" void CCTK_FCALL CCTK_FNAME(opl_lapse_upwind)
...
extern "C" void opl_lapse_upwind(const cGH *cctkGH,int *nghostzones,int *cctk_lsh, int Symmetry, int opl_advect_enable,
				 double dT,double dx, double dy, double dz,
				 double *lapsex,double *lapsey,double *lapsez,
				 double *betax,double *betay,double *betaz,
				 double *lapse_old, double *lapse_rhs) {
...
extern "C" void CCTK_FCALL CCTK_FNAME(opl_lapse_upwind)
  (const cGH **cctkGH,int *nghostzones,int *cctk_lsh,int *Symmetry,int *opl_advect_enable,
   ...
   double *lapse_old, double *lapse_rhs)
{
  opl_lapse_upwind(*cctkGH,nghostzones,cctk_lsh,*Symmetry,*opl_advect_enable,
		   *dT,*dx,*dy,*dz,
