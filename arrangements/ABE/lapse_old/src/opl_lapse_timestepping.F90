...
subroutine opl_lapse_timestepping(CCTK_ARGUMENTS)
  ...
  interface
     subroutine opl_lapse_rhs(cctkGH, cctk_nghostzones,ext,Symmetry,opl_alap, &
  ...
  call opl_lapse_rhs(cctkGH,cctk_nghostzones,cctk_lsh,Symmetry, opl_alap, &
       r,PhysicalRadius,RadiusDerivative, &
