subroutine compute_boost_metric_Aij_quasiisotropic(m0,sam,x0_bh,vx_boost,ex,x,y,z, &
...
!
  ...
  ! Horizon radius in quasi-isotropic radial coordinate
  rh = 0.5d0*sqrt(m0*m0 - a*a)
  rh2 = rh*rh
  ...
  do k=kmin,kmax
     do j=jmin,jmax
	   ...
	   yl = y(i,j,k)
	   zl = z(i,j,k)
           call boost_kerr_quasiisotropic_alp_beta_gij_gupij(m0,a,vx_boost,xl,yl,zl, &
	   ...
	   betax(i,j,k) = betaxl
           betay(i,j,k) = betayl
           betaz(i,j,k) = betazl
    	   call dt_boost_gammaij_quasiisotropic(m0,a,vx_boost,xl,yl,zl,gxxt,gxyt,gxzt,gyyt,gyzt,gzzt)
           call cov_derv_beta_quasiisotropic(m0,a,vx_boost,xl,yl,zl,betaxl,betayl,betazl, &
...
end subroutine compute_boost_metric_Aij_quasiisotropic

subroutine dt_boost_gammaij_quasiisotropic(m0,a,vx_boost,x,y,z,gxxt,gxyt,gxzt,gyyt,gyzt,gzzt)
  implicit none
...
!
  ...
  delta = 1.d-4*r
  f1o2d = 0.5d0/delta
  call compute_kerr_quasiisotropic_metric(m0,a,gamma*x+delta,y,z,gtt1,gtx1,gty1,gtz1, &
                        gxx1,gxy1,gxz1,gyy1,gyz1,gzz1,g4uptt0,g4uptx0,g4upty0,g4uptz0, &
                        gupxx0,gupxy0,gupxz0,gupyy0,gupyz0,gupzz0)
  call compute_kerr_quasiisotropic_metric(m0,a,gamma*x-delta,y,z,gtt0,gtx0,gty0,gtz0, &
...
end subroutine dt_boost_gammaij_quasiisotropic

! Compute D_i beta_j + D_j beta_i for the boosted metric and shift 
!
subroutine cov_derv_beta_quasiisotropic(m0,a,vx_boost,x,y,z,betax,betay,betaz, &
                        beta_xx, beta_xy, beta_xz, beta_yy, beta_yz, beta_zz)
  implicit none
  real*8,  intent(in)                                :: m0,a,x,y,z,vx_boost
...
!
  ...
  ! x-derivatives
  call boost_kerr_quasiisotropic_alp_beta_gij_gupij(m0,a,vx_boost,x+delta,y,z,alp0,betax0,betay0,betaz0, &
  ...
  ! y-derivatives
  call boost_kerr_quasiisotropic_alp_beta_gij_gupij(m0,a,vx_boost,x,y+delta,z,alp0,betax0,betay0,betaz0, &
                        gxx1,gxy1,gxz1,gyy1,gyz1,gzz1,gupxx0,gupxy0,gupxz0,gupyy0,gupyz0,gupzz0)
  beta_x1 = gxx1*betax0 + gxy1*betay0 + gxz1*betaz0
  beta_y1 = gxy1*betax0 + gyy1*betay0 + gyz1*betaz0
  beta_z1 = gxz1*betax0 + gyz1*betay0 + gzz1*betaz0
  ...
  ! z-derivatives
  call boost_kerr_quasiisotropic_alp_beta_gij_gupij(m0,a,vx_boost,x,y,z+delta,alp0,betax0,betay0,betaz0, &
                        gxx1,gxy1,gxz1,gyy1,gyz1,gzz1,gupxx0,gupxy0,gupxz0,gupyy0,gupyz0,gupzz0)
  beta_x1 = gxx1*betax0 + gxy1*betay0 + gxz1*betaz0
  beta_y1 = gxy1*betax0 + gyy1*betay0 + gyz1*betaz0
  beta_z1 = gxz1*betax0 + gyz1*betay0 + gzz1*betaz0
...
end subroutine cov_derv_beta_quasiisotropic

subroutine boost_kerr_quasiisotropic_alp_beta_gij_gupij(m0,a,vx_boost,x,y,z,alp,betax,betay,betaz, &
...
!
  ...
  call compute_kerr_quasiisotropic_metric(m0,a,gamma*x,y,z,gtt0,gtx0,gty0,gtz0, &
                        gxx0,gxy0,gxz0,gyy0,gyz0,gzz0,g4uptt0,g4uptx0,g4upty0,g4uptz0, &
                        gupxx0,gupxy0,gupxz0,gupyy0,gupyz0,gupzz0)
...
end subroutine boost_kerr_quasiisotropic_alp_beta_gij_gupij

subroutine compute_kerr_quasiisotropic_metric(m0,a,x,y,z,gtt,gtx,gty,gtz, & 
  ...
  real*8 :: r_l, x_l, y_l, z_l, Delta
  real*8  :: rh_out, rh_in, riso, rh_iso
!
...
end subroutine compute_kerr_quasiisotropic_metric
