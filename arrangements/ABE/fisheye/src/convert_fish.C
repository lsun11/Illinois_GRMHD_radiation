...
extern "C" void CCTK_FCALL CCTK_FNAME(trans_phys_fish_tensor_flat)
  (const cGH **cctkGH,int *cctk_lsh,int *Symmetry,
   double *xG, double *yG, double *zG, 
   double *RpG,double *dRG,
   double *gxx,double *gxy,double *gxz,double *gyy,double *gyz,double *gzz);

extern "C" void CCTK_FCALL CCTK_FNAME(trans_phys_fish_tensor)
  (const cGH **cctkGH,int *cctk_lsh,int *Symmetry,
   double *xG, double *yG, double *zG, 
   double *RpG,double *dRG,
   double *gxx,double *gxy,double *gxz,double *gyy,double *gyz,double *gzz);

extern "C" void CCTK_FCALL CCTK_FNAME(trans_phys_fish_tensor_inv)
  (const cGH **cctkGH,int *cctk_lsh,int *Symmetry,
   double *xG, double *yG, double *zG, 
   double *RpG,double *dRG,
   double *gxx,double *gxy,double *gxz,double *gyy,double *gyz,double *gzz);
...
extern "C" void CCTK_FCALL CCTK_FNAME(trans_phys_fish_gamt_flat)
  (const cGH **cctkGH,int *cctk_lsh,int *Symmetry,
   double *xG, double *yG, double *zG, 
   double *RpG,double *dRG,double *d2RG,
   double *Gammax,double *Gammay,double *Gammaz);

extern "C" void CCTK_FCALL CCTK_FNAME(trans_phys_fish_phi)
  (const cGH **cctkGH,int *cctk_lsh,int *Symmetry,
   double *xG, double *yG, double *zG, 
   double *RpG,double *dRG,
   double *phi);
