  ...
  do k=1,cctk_lsh(3)
     do j=1,cctk_lsh(2)
        do i=1,cctk_lsh(1)
           ...
           call recompute_vars(rho_b_l,P_l,vx_l,vy_l,vz_l,Bx_l,By_l,Bz_l,AUX,m,rho_s_l,tau_l, &
                mhd_st_x_l,mhd_st_y_l,mhd_st_z_l,st_x_l,st_y_l,st_z_l,w_l,h_l,u0_l,Ex_l,Ey_l,Ez_l,&
                sbt_l,sbx_l,sby_l,sbz_l,rho_l,Sx_l,Sy_l,Sz_l,Sxx_l,Sxy_l,Sxz_l,Syy_l,Syz_l,Szz_l, &
                neos, rho_tab, P_tab, eps_tab, k_tab, gamma_tab, gamma_th,rho_b_atm)	   
           ...
           rho_star(i,j,k) = rho_s_l
           tau(i,j,k) = tau_l
           mhd_st_x(i,j,k) = mhd_st_x_l
           mhd_st_y(i,j,k) = mhd_st_y_l
           mhd_st_z(i,j,k) = mhd_st_z_l
