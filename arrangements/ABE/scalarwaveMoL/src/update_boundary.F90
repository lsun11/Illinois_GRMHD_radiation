     ...
     if(scawave_have_bdry_min(1)==1) then
        ...
        do k = kmin, kmax - 1
	      ...
	      phi_stagger_new(i,j,k) = 3.d0*phi_stagger_new(i+1,j,k) - 3.d0*phi_stagger_new(i+2,j,k) + phi_stagger_new(i+3,j,k)
              phi_dot_stagger_new(i,j,k) = 3.d0*phi_dot_stagger_new(i+1,j,k) - 3.d0*phi_dot_stagger_new(i+2,j,k) + phi_dot_stagger_new(i+3,j,k)
     ...
     if(scawave_have_bdry_min(2)==1) then
        ...
        do k = kmin, kmax - 1
           do i = imin, imax
              ...
              phi_dot_stagger_new(i,j,k) = 3.d0*phi_dot_stagger_new(i,j+1,k) - 3.d0*phi_dot_stagger_new(i,j+2,k) + phi_dot_stagger_new(i,j+3,k)
              !!phi_stagger_new(i,j,k) = phi_stagger_old(i,j,k)
              !!phi_dot_stagger_new(i,j,k) = phi_dot_stagger_old(i,j,k)
              ! ************
           enddo
     ...
     if(scawave_have_bdry_max(3)==1) then
        ...
        do j = jmin, jmax
           do i = imin, imax
              ...
              phi_dot_stagger_new(i,j,k) = 3.d0*phi_dot_stagger_new(i,j,k-1) - 3.d0*phi_dot_stagger_new(i,j,k-2) + phi_dot_stagger_new(i,j,k-3)
              !!phi_stagger_new(i,j,k) = phi_stagger_old(i,j,k)
              !!phi_dot_stagger_new(i,j,k) = phi_dot_stagger_old(i,j,k)
              ! ************
           enddo
