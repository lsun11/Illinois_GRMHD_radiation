...
!--------------------------------------------------
subroutine Integrate_vol_integrand_movingbox_bin(CCTK_ARGUMENTS)
  ...
  real*8  :: VolIntegralx1,VolIntegraly1,VolIntegralz1,VolIntegraldenom1,d3x
...
end subroutine Integrate_vol_integrand_movingbox_bin
