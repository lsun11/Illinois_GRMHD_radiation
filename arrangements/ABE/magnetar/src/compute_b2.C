...
extern "C" void CCTK_FCALL CCTK_FNAME(magnetar_compute_b2_cpp)
...
void magnetar_compute_b2_cpp(const cGH *cctkGH,int *cctk_lsh, double *phi, 
...
extern "C" void CCTK_FCALL CCTK_FNAME(magnetar_compute_b2_cpp)
  (const cGH **cctkGH,int *cctk_lsh, double *phi, double *lapm1, 
   ...
   double *b2)
{
  magnetar_compute_b2_cpp(*cctkGH, cctk_lsh, phi, lapm1, shiftx,shifty,shiftz,
