...
static int general_newton_raphson( FTYPE x[], int n, void (*funcd) (FTYPE [], FTYPE [], FTYPE [], FTYPE [][NEWT_DIM], FTYPE *, FTYPE *, int,FTYPE &,FTYPE &,FTYPE &,FTYPE &,FTYPE &, FTYPE &, FTYPE & , int &, int &, FTYPE &,FTYPE *, FTYPE *, FTYPE *,FTYPE *, FTYPE *),FTYPE &Bsq,FTYPE &QdotBsq,FTYPE &Qtsq,FTYPE &Qdotn,FTYPE &D,FTYPE &P_cold, FTYPE &eps_cold, int &neos, int &ergo_star, FTYPE &ergo_sigma, FTYPE *rho_tab, FTYPE *P_tab, FTYPE *gamma_tab, FTYPE *eps_tab, FTYPE *k_tab);
static void func_vsq( FTYPE [], FTYPE [], FTYPE [], FTYPE [][NEWT_DIM], FTYPE *f, FTYPE *df, int n,FTYPE &Bsq,FTYPE &QdotBsq,FTYPE &Qtsq,FTYPE &Qdotn,FTYPE &D, FTYPE &P_cold, FTYPE &eps_cold, int &neos, int &ergo_star, FTYPE &ergo_sigma, FTYPE *rho_tab, FTYPE *P_tab, FTYPE *gamma_tab, FTYPE *eps_tab, FTYPE *k_tab);
...
static FTYPE pressure_W_vsq(FTYPE W, FTYPE vsq, FTYPE &D, FTYPE &P_cold, FTYPE &eps_cold, int &neos, int &ergo_star, FTYPE &ergo_sigma, FTYPE *rho_tab, FTYPE *P_tab, FTYPE *eps_tab, FTYPE *k_tab, FTYPE *gamma_tab);
...
static FTYPE dpdvsq_calc(FTYPE W, FTYPE vsq, FTYPE &D, FTYPE &P_cold, FTYPE &eps_cold, int &neos, int &ergo_star, FTYPE &ergo_sigma,FTYPE *rho_tab, FTYPE *P_tab, FTYPE *eps_tab, FTYPE *k_tab, FTYPE *gamma_tab);
			    ...
			    FTYPE gcon[NDIM][NDIM], FTYPE gdet,  FTYPE prim[NPR], int &neos, int &ergo_star, FTYPE &ergo_sigma, FTYPE *rho_tab, FTYPE *P_tab, FTYPE *eps_tab,  FTYPE *k_tab,  FTYPE *gamma_tab)
{
  ...
  p = pressure_rho0_u(rho0,u,P_cold, eps_cold, neos, ergo_star, ergo_sigma, rho_tab, P_tab, eps_tab, k_tab, gamma_tab) ;
  w = rho0 + u + p ;
  ...
  retval = general_newton_raphson( x_2d, n, func_vsq, Bsq,QdotBsq,Qtsq,Qdotn,D, P_cold, eps_cold, neos, ergo_star, ergo_sigma, rho_tab, P_tab, gamma_tab, eps_tab, k_tab) ;  
  ...
  //  compute_pcold_epscold_cpp(rho0, P_cold, eps_cold, neos, ergo_star, ergo_sigma, rho_tab, P_tab, eps_tab, k_tab, gamma_tab); 
  p = pressure_rho0_w(rho0,w,P_cold, eps_cold, neos, ergo_star, ergo_sigma, rho_tab, P_tab, eps_tab, k_tab, gamma_tab) ;
...
static int general_newton_raphson( FTYPE x[], int n, 
			    void (*funcd) (FTYPE [], FTYPE [], FTYPE [], 
					   ...
					   FTYPE *,FTYPE *, FTYPE *),FTYPE &Bsq,FTYPE &QdotBsq,FTYPE &Qtsq,FTYPE &Qdotn,FTYPE &D, FTYPE &P_cold, FTYPE &eps_cold, int &neos, int &ergo_star, FTYPE &ergo_sigma, FTYPE *rho_tab, FTYPE *P_tab, FTYPE *gamma_tab, FTYPE *eps_tab, FTYPE *k_tab)
{
  ...
  while( keep_iterating ) { 
    ...
    (*funcd) (x, dx, resid, jac, &f, &df, n, Bsq,QdotBsq,Qtsq,Qdotn,D, P_cold, eps_cold, neos, ergo_star, ergo_sigma, rho_tab, P_tab, gamma_tab, eps_tab, k_tab);  /* returns with new dx, f, df */
		     ...
		     FTYPE *rho_tab, FTYPE *P_tab, FTYPE *gamma_tab, FTYPE *eps_tab, FTYPE *k_tab)
{
  ...
  p_tmp  = pressure_W_vsq( W, vsq , D, P_cold, eps_cold, neos, ergo_star, ergo_sigma, rho_tab, P_tab, eps_tab, k_tab, gamma_tab);
  ...
  dPdvsq = dpdvsq_calc( W, vsq, D, P_cold, eps_cold, neos, ergo_star, ergo_sigma, rho_tab, P_tab, eps_tab, k_tab, gamma_tab);
