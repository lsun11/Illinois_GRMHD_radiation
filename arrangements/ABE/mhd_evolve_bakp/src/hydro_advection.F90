...
! write(*,*) "inside advect_rho_e", m,mmax,rho_star_rhs(15,2,2),e_rhs(15,2,2),frm(15,2,2),fem(15,2,2),fem(15,2,2),frm(15,2,2),frm(16,2,2),frm(17,2,2)
 if (m==1) then
  ...
  if (Symmetry==AXISYM) then
    ...
    !frm = drho_bm
    !fem = dP_m
 !   write(*,*) "inside advect_rho_e", m,mmax,rho_star_rhs(15,2,2),e_rhs(15,2,2),frm(15,2,2),fem(15,2,2),fem(3,2,2),frm(16,2,2),frm(17,2,2)
 ...
 elseif (m==2) then
    ...
    e_rhs(:,mmax,:) = 0.d0
    rho_star_rhs(:,mmax,:) = 0.d0
 !   write(*,*) "inside advect_rho_e", m,mmax,rho_star_rhs(15,2,2),e_rhs(15,2,2),frm(15,2,2),fem(15,2,2),fem(2,3,2),frm(16,2,2),frm(17,2,2)
 elseif (m==3) then
...
!  write(*,*) "NABLA_HYDRO: ",m,rho_b(15,2,2),drho_b_m(15,2,2),P(15,2,2),dP_m(15,2,2),dvx_m(15,2,2),vx(15,2,2),Symmetry,vx(15,2,2),vy(15,2,2),vz(15,2,2)
...
!  write(*,*) "face_avg",gxx(15,2,2),gxy(15,2,2),gxz(15,2,2),gyy(15,2,2),gyz(15,2,2),gzz(15,2,2),gxx_f(15,2,2),gxy_f(15,2,2),gxz_f(15,2,2),gyy_f(15,2,2),gyz_f(15,2,2),gzz_f(15,2,2)
