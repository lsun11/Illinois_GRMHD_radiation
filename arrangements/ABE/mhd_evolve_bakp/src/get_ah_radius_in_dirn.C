...
extern "C" void CCTK_FCALL CCTK_FNAME(mhd_evolve_get_ah_radius_in_dirn)
  (const cGH **cctkGH,const double &horizdirn_x,const double &horizdirn_y,const double &horizdirn_z,double &output_radius);

extern "C" void mhd_evolve_get_ah_radius_in_dirn(const cGH *cctkGH,const double &horizdirn_x,const double &horizdirn_y,const double &horizdirn_z,double &output_radius) {
...
extern "C" void CCTK_FCALL CCTK_FNAME(mhd_evolve_get_ah_radius_in_dirn)
  (const cGH **cctkGH,const double &horizdirn_x,const double &horizdirn_y,const double &horizdirn_z,double &output_radius)
{  
  mhd_evolve_get_ah_radius_in_dirn(*cctkGH,horizdirn_x,horizdirn_y,horizdirn_z,output_radius);
}
