...
!                        ((SYMMETRY .eq. NO_SYMM) .or. (Z(1,1,kmin) .lt. 0.d0))
!              if(i==15 .and. j==2 .and. k==2) then
!                 write(*,*) "INSIDE REPAIR_FAILURES", x_ogb_p,x_ogb_n,y_ogb_p,y_ogb_n,z_ogb_p,z_ogb_n
!              end if
