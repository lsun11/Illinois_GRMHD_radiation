  ...
  extern "C" void mhd_evolve_InitSymBound(CCTK_ARGUMENTS)
{
  ...
  // printf("Start mhd_evolve_InitSymBound!!!!! aka mhd_bc0"); 
  ...
  if(cctk_iteration==0) {
    ...
    if(Symmetry==2) {
      ...
      SetCartSymVN(cctkGH, sym,"mhd_evolve::F_rad0r");

      SetCartSymVN(cctkGH, sym,"mhd_evolve::E_radl");
      SetCartSymVN(cctkGH, sym,"mhd_evolve::F_rad0l");

      SetCartSymVN(cctkGH, sym,"mhd_evolve::P_rad");
      SetCartSymVN(cctkGH, sym,"mhd_evolve::P_radr");
      SetCartSymVN(cctkGH, sym,"mhd_evolve::P_radl");
      ...
      SetCartSymVN(cctkGH, sym,"mhd_evolve::dP_rad_m");
      */
      ...
      SetCartSymVN(cctkGH, sym,"mhd_evolve::F_radxl");
      ...
      SetCartSymVN(cctkGH, sym,"mhd_evolve::F_radyl");
      ...
      SetCartSymVN(cctkGH, sym,"mhd_evolve::F_radzl");
