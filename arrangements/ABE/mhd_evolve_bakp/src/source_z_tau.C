...
#pragma omp parallel for
	...
	*/
	...
	if(isnan(tau_rhs[index])){
          printf("tau_rhs is nan found!!!! checkpoint 1!!!! rad_opacity_abs, E_radL, rad_const, T_fluidL, rad_opacity_sct, F_rad0L= %e, %e, %e, %e, %e \n", rad_opacity_abs, E_radL, rad_const, T_fluidL, rad_opacity_sct);
            }
...
#pragma omp parallel for
	...
	*/      
        ...
        if(isnan(tau_rhs[index])){
          printf("tau_rhs is nan found!!!! checkpoint 2!!!! rad_opacity_abs, E_radL, rad_const, T_fluidL, rad_opacity_sct, F_rad0L= %e, %e, %e, %e, %e \n", rad_opacity_abs, E_radL, rad_const, T_fluidL, rad_opacity_sct);
            }
...
#pragma omp parallel for
	...
	*/
	if(isnan(tau_rhs[index])){
          printf("tau_rhs is nan found!!!! checkpoint 3!!!! rad_opacity_abs, E_radL, rad_const, T_fluidL, rad_opacity_sct, F_rad0L= %e, %e, %e, %e, %e \n", rad_opacity_abs, E_radL, rad_const, T_fluidL, rad_opacity_sct);
	    }
