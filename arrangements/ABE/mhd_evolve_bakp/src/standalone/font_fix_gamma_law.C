...
//  printf("5 check NaNs on W0 %e  Sf20 %e rhob0%e rho_starL %e \n",W0,Sf20,rhob0,rho_starL);
  ...
  while(fontcheck && itcount < maxits) {
     ...
     compute_pcold_epscold_cpp(rhob0, P_cold, eps_cold, neos, ergo_star, ergo_sigma, rho_tab,P_tab,eps_tab,k_tab,gamma_tab);
	...
	//	printf("6 check NaNs on h %e rho_starL %e Psim6 %e Sf20 %e rho_starL %e \n",h,rho_starL,Psim6,Sf20,rho_starL);
     ...
     compute_pcold_epscold_cpp(rhob1, P_cold, eps_cold, neos, ergo_star, ergo_sigma, rho_tab,P_tab,eps_tab,k_tab,gamma_tab);
