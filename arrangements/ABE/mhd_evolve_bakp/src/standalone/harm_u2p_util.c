...
void primtoU_g( FTYPE prim[], FTYPE gcov[][NDIM], FTYPE gcon[][NDIM], FTYPE gdet, 
		...
		FTYPE &ergo_sigma, FTYPE *rho_tab, FTYPE *P_tab, FTYPE *k_tab, FTYPE *gamma_tab, FTYPE *eps_tab);
...
void primtoU_g(
	       ...
	       FTYPE *rho_tab, FTYPE *P_tab, FTYPE *k_tab, FTYPE *gamma_tab, FTYPE *eps_tab
	       ) {
  int i,j ;
  FTYPE rho0 ;
