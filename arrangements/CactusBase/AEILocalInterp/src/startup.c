 /*@@
   ...
   @enddesc
   @version   $Id: startup.c,v 1.2 2006/08/31 15:11:19 schnetter Exp $
 @@*/
...
static const char *rcsid = "$Header: /numrelcvs/AEIThorns/AEILocalInterp/src/startup.c,v 1.2 2006/08/31 15:11:19 schnetter Exp $";
