/*@@
  ...
  @version   $Header: /numrelcvs/AEIThorns/AEILocalInterp/src/template.c,v 1.16 2007/03/06 13:40:37 jthorn Exp $
  @@*/
...
"                              is not supported!"
			   ...
			   interp_coords_type_code);
							/*NOTREACHED*/
		//BADreturn UTIL_ERROR_BAD_INPUT;	/*** ERROR RETURN ***/
...
"        ==> N_parts=%d"
	   ...
	   out, (int) output_array_type_codes[out], N_output_parts);
								/*NOTREACHED*/
                     //BAD return UTIL_ERROR_BAD_INPUT;	/*** ERROR RETURN ***/
		    }
...
"            see src/include/cctk_Constants.h)"
	   ...
	   out, (int) output_array_type_codes[out], N_output_parts);
								/*NOTREACHED*/
//BADreturn UTIL_ERROR_BAD_INPUT;
							/*** ERROR RETURN ***/
				}
...
"                              (0-origin) output #out=%d"
	   ...
	   (int) operation_codes[out],
	   out);
//BAD return UTIL_ERROR_BAD_INPUT;
							/*** ERROR RETURN ***/
