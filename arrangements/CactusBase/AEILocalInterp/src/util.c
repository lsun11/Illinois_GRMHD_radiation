 /*@@
   ...
   @enddesc
   @version   $Id: util.c,v 1.2 2007/01/15 12:06:36 jthorn Exp $
 @@*/
...
static const char *rcsid = "$Header: /numrelcvs/AEIThorns/AEILocalInterp/src/util.c,v 1.2 2007/01/15 12:06:36 jthorn Exp $";
#ifndef AEILOCALINTERP_STANDALONE_TEST
