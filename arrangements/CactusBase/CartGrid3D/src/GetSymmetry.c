/*@@
  ...
  @enddesc
  @version   $Id: GetSymmetry.c,v 1.6 2007/02/16 12:33:40 tradke Exp $
@@*/
...
static const char *rcsid = "$Header: /cactusdevcvs/CactusBase/CartGrid3D/src/GetSymmetry.c,v 1.6 2007/02/16 12:33:40 tradke Exp $";
