 /*@@
   ...
   @enddesc
   @version   $Id: Startup.c,v 1.22 2008/05/25 19:53:24 yye00 Exp $
 @@*/
...
static const char *rcsid = "$Header: /cactusdevcvs/CactusBase/CartGrid3D/src/Startup.c,v 1.22 2008/05/25 19:53:24 yye00 Exp $";
