/*@@
   ...
   @enddesc
   @version    $Id: WriteScalar.c,v 1.17 2005/11/01 18:50:38 yye00 Exp $
@@*/
...
static const char *rcsid = "$Header: /cactusdevcvs/CactusBase/IOBasic/src/WriteScalar.c,v 1.17 2005/11/01 18:50:38 yye00 Exp $";
