 /*@@
   ...
   @enddesc
   @version   $Id: OutputInfo.c,v 1.44 2004/08/12 22:11:01 yye00 Exp $
 @@*/
...
static const char *rcsid = "$Header: /cactusdevcvs/CactusBase/IOBasic/src/OutputInfo.c,v 1.44 2004/08/12 22:11:01 yye00 Exp $";
