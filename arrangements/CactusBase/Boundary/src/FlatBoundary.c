 /*@@
   ...
   @endhistory
   @version   $Id: FlatBoundary.c,v 1.49 2006/10/05 16:56:28 schnetter Exp $
 @@*/
...
static const char *rcsid = "$Header: /cactusdevcvs/CactusBase/Boundary/src/FlatBoundary.c,v 1.49 2006/10/05 16:56:28 schnetter Exp $";
