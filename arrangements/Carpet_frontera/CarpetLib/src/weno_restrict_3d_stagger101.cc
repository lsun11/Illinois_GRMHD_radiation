...
#define DSTIND3(i,j,k)                                  \
      ...
      for (int j=0; j<regjext; ++j) {
        for (int i=0; i<regiext; ++i) {
	      ...
	      for (int ii=0; ii<5; ii++) {
	          f1di[ii] = src [SRCIND3(2*i+ii-2, 2*j, 2*k+kk-2)];
	      }
	      f1dk[kk] = weno_5pt(f1di,0.5,0.0,1.0);
	  }
  ...
  template <>
  void
  restrict_3d_stagger101 (CCTK_COMPLEX8 const * restrict const src,
                   ivect3 const & restrict srcext,
  ...
  template <>
  void
  restrict_3d_stagger101 (CCTK_COMPLEX16 const * restrict const src,
                   ivect3 const & restrict srcext,
  ...
  template <>
  void
  restrict_3d_stagger101 (CCTK_COMPLEX32 const * restrict const src,
                   ivect3 const & restrict srcext,
