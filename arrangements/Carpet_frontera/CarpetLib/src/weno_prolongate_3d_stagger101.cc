   ...
   l8000:
    ...
    for (int kk=0; kk<5; kk++) {
        for (int ii=0; ii<5; ii++) {
            f1di[ii] = src[SRCIND3(is+ii-2,js,ks+kk-2)];
        }
        f1dk[kk] = weno_5pt(f1di,-0.25,0.0,1.0);
    }
...
//printf("l8001: %d %d %d %d %d %d %e %e\n",id,jd,kd,is,js,ks,dst[DSTIND3(id,jd,kd)],src[SRCIND3(is,js,ks)]);
   ...
   l8010:
    ...
    for (int kk=0; kk<5; kk++) {
        ...
        f1dk[kk] = weno_5pt(f1dj,0.5,0.0,1.0);
    }
    dst[DSTIND3(id,jd,kd)] = weno_5pt(f1dk,-0.25,0.0,1.0);
...
//printf("l8111: %d %d %d %d %d %d %e %e\n",id,jd,kd,is,js,ks,dst[DSTIND3(id,jd,kd)],src[SRCIND3(is,js,ks)]);
  ...
  template <>
  void
  prolongate_3d_stagger101 (CCTK_COMPLEX8 const * restrict const src,
                        ivect3 const & restrict srcext,
                        ...
                        ibbox3 const & restrict regbbox)
  {
    CCTK_WARN (CCTK_WARN_ABORT, "STAGGER101 for complex numbers is not supported");
  }
#endif
  ...
  template <>
  void
  prolongate_3d_stagger101 (CCTK_COMPLEX16 const * restrict const src,
                        ivect3 const & restrict srcext,
  ...
  template <>
  void
  prolongate_3d_stagger101 (CCTK_COMPLEX32 const * restrict const src,
                        ivect3 const & restrict srcext,
