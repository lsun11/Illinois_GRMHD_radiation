/* Fake prolongation. Only keep check of refinement boundaries.
...
#define DSTIND3(i,j,k)                          \
                        ...
                        ibbox3 const & restrict regbbox)
  {
    ...
    // Initialize the destination array to 0
...
//printf("l8111: %d %d %d %d %d %d %e %e\n",id,jd,kd,is,js,ks,dst[DSTIND3(id,jd,kd)],src[SRCIND3(is,js,ks)]);
  ...
  template <>
  void
  prolongate_3d_FAKE (CCTK_COMPLEX8 const * restrict const src,
                        ivect3 const & restrict srcext,
  ...
  template <>
  void
  prolongate_3d_FAKE (CCTK_COMPLEX16 const * restrict const src,
                        ivect3 const & restrict srcext,
  ...
  template <>
  void
  prolongate_3d_FAKE (CCTK_COMPLEX32 const * restrict const src,
                        ivect3 const & restrict srcext,
