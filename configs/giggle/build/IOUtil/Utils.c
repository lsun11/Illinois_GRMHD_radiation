/*@@
   ...
   @enddesc
   @version   $Id: Utils.c,v 1.37 2008/01/28 16:07:18 schnetter Exp $
 @@*/
...
static const char *rcsid = "$Header: /cactusdevcvs/CactusBase/IOUtil/src/Utils.c,v 1.37 2008/01/28 16:07:18 schnetter Exp $";
                                    ...
                                    int out_every_default)
{
  ...
  request->vectors = calloc ((request->vdim + 6) * request->vdim + 1,
                             sizeof (CCTK_INT));
