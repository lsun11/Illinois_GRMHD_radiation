 /*@@
   ...
   @enddesc
   @version   $Id: Startup.c,v 1.31 2008/02/29 14:35:18 schnetter Exp $
 @@*/
...
static const char *rcsid="$Header: /cactusdevcvs/CactusBase/IOUtil/src/Startup.c,v 1.31 2008/02/29 14:35:18 schnetter Exp $";
...
static void *SetupGH (tFleshConfig *config, int convergence_level, cGH *GH)
{
  ...
  i = IOUtil_CreateDirectory (GH, out_dir,
  ...
  {
    case 3 : myGH->downsample[2] = out_downsample_z;
    case 2 : myGH->downsample[1] = out_downsample_y;
    case 1 : myGH->downsample[0] = out_downsample_x;
  }
