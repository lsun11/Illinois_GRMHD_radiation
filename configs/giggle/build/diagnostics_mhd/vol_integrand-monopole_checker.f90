...
!---------------------------------------------------------
subroutine monopole_integrand(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_time,&
...
!!!$omp end parallel do
           ...
           do k=2,cctk_lsh(3)-1
              do j=2,cctk_lsh(2)-1
                 do i=2,cctk_lsh(1)-1
                    VolIntegrand(i,j,k) = abs(((Bxtilde(i+1,j,k)          - Bxtilde(i-1,j,k)) * hdxi) + ((Bytilde(i,j+1,k)         &
  & - Bytilde(i,j-1,k)) * hdyi) + ((Bztilde(i,j,k+1)          - Bztilde(i,j,k-1)) * hdzi))
                 end do
              end do
           end do
           !$omp end parallel do
