...
!-----------------------------------------------------------------------------
subroutine minternal_cold_hybrid_4surf_integrand(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bb&
  ...
  &d_nue,zeta_rad_nux, X0coordinates,X0mask,X0space_mask_group,X1coordinates,X1mask,X1space_mask_group,X2coordinates,X2mask,X2space&
  &_mask_group,coarse_dx,coarse_dy,coarse_dz,emask,r,space_mask,x,y,z)
  implicit none
  !~~~~~> ABE Functions used:
  interface
