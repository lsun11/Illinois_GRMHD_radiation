...
!--------------------------------------------------
      subroutine Integrate_vol_integrand_mhd(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,c&
  ...
  INTEGER*4 horizon_number
     ...
     call CCTK_Reduce(ierr,cctkGH, -1, handle, 1, 107, VolIntegral2, 1, vindex)
     call CCTK_ReductionHandle(handle,"sum")
     call CCTK_VarIndex(vindex,"diagnostics_vacuum::VolIntegrand3")
     call CCTK_Reduce(ierr,cctkGH, -1, handle, 1, 107, VolIntegral3, 1, vindex)
     call CCTK_ReductionHandle(handle,"sum")
     call CCTK_VarIndex(vindex,"diagnostics_vacuum::VolIntegrand4")
     call CCTK_Reduce(ierr,cctkGH, -1, handle, 1, 107, VolIntegral4, 1, vindex)
...
!!     em_energy_between_VolInt = VolIntegral*d3x
         ...
         rad_energy_nue_VolInt = VolIntegral*d3x
         rad_energy_nux_VolInt = VolIntegral*d3x
!!     else if(WhichIntegral==116) then
