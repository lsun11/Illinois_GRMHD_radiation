...
!----------------------------
subroutine bremsstrahlung_qei_integrand(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_d&
  ...
  real*8 :: pi
  parameter(AXISYM = 4)
  write(*,*) "Start vol_integrand-bremsstrahlung_qei"
        ...
        do j = cctk_nghostzones(2)+1,cctk_lsh(2)-cctk_nghostzones(2)
           do i = cctk_nghostzones(1)+1,cctk_lsh(1)-cctk_nghostzones(1)
              ...
              if (((rr1 .gt. inner_lum_rad_ratio*rad_est_1) .or. (found_horizon1 .eq. 0)) .and. &
                 ...
                 q_ei = xi*(n_tilde*n_inf)**2*(8.d0*pi/3.d0)*(alp_re2_c)*(me_c2)*F_ei
                 q_ee = (n_tilde*n_inf)**2*(alp_re2_c)*(me_c2)*F_ee
                 !VolIntegrand(i,j,k) = lapse*sqrtgamma*(q_ei+q_ee) 
                 VolIntegrand(i,j,k) = sqrtgamma*q_ei*GM_o_c2**3
                 !check_emissivity(i,j,k)=sqrtgamma*q_ei*GM_o_c2**3
              endif
           end do
        end do
     end do
...
end subroutine bremsstrahlung_qei_integrand
