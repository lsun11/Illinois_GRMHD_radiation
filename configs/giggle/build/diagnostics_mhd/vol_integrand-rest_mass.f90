...
!----------------------------
subroutine rest_mass_integrand(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_time&
...
end subroutine rest_mass_integrand
