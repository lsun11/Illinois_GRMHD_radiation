...
!----------------------------
subroutine  meq12_integrand(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_time,cc&
...
!              if (rho_b(i,j,k).gt.rhob_cutoff) then
                 ...
                 VolIntegrand(i,j,k) = rho_star(i,j,k)*cos(phiangle)
                 VolIntegrand2(i,j,k) = rho_star(i,j,k)*sin(phiangle)
                 VolIntegrand3(i,j,k) = rho_star(i,j,k)*cos(2.d0*phiangle)
                 VolIntegrand4(i,j,k) = rho_star(i,j,k)*sin(2.d0*phiangle)
              end if
           end do
        end do
     end do
...
end subroutine meq12_integrand
