...
!------------------------------------
subroutine interp_driver_carp(cctkGH,num_points,pointcoords,gridfunc_varindex,output)
  implicit none
...
!  call CCTK_InterpHandle (interp_handle, uniform cartesian)
  if (interp_handle .lt. 0) then
     call CCTK_Warn(0,50,"interp_driver_carp.F90","diagnostics_vacuum","Cannot get handle for interpolation ! Forgot to activate an&
  ...
  if (param_table_handle .lt. 0) then
     call CCTK_Warn(0,56,"interp_driver_carp.F90","diagnostics_vacuum","Cannot create parameter table for interpolator")
  endif
  call CCTK_CoordSystemHandle (coord_system_handle, "cart3d")
  if (coord_system_handle .lt. 0) then
     call CCTK_Warn(0,61,"interp_driver_carp.F90","diagnostics_vacuum","Cannot get handle for cart3d coordinate system ! Forgot to &
...
end subroutine interp_driver_carp
