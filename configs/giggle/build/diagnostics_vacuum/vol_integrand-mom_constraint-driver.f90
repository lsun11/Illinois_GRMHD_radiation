!------------------------------------------------------------------
! Sets the Momentum constraint integrand to zero on the ghostzones
!------------------------------------------------------------------
subroutine mom_constraint_integrand(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta&
...
end subroutine mom_constraint_integrand
