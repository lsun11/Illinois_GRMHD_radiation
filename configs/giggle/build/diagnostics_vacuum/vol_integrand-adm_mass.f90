...
!
!-----------------------------------------------------------------------------
subroutine ADM_mass_integrand(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_time,&
  ...
  & X0coordinates,X0mask,X0space_mask_group,X1coordinates,X1mask,X1space_mask_group,X2coordinates,X2mask,X2space_mask_group,coarse_&
  &dx,coarse_dy,coarse_dz,emask,r,space_mask,x,y,z)
  implicit none
  !~~~~~> Input parameters:
  INTEGER cctk_dim
