 /*@@
   ...
   @enddesc
   @version   $Header: /cactusdevcvs/CactusBase/Boundary/src/Boundary.c,v 1.39 2006/10/05 16:55:10 schnetter Exp $
 @@*/
...
static const char *rcsid = "$Header: /cactusdevcvs/CactusBase/Boundary/src/Boundary.c,v 1.39 2006/10/05 16:55:10 schnetter Exp $";
...
CCTK_INT Bdry_Boundary_RegisterPhysicalBC(CCTK_POINTER_TO_CONST _GH,
                                          ...
                                          CCTK_STRING bc_name);
CCTK_INT Bdry_Boundary_SelectVarForBC(CCTK_POINTER_TO_CONST _GH,
                                      CCTK_INT faces,
...
void Boundary_ApplyPhysicalBCs(CCTK_ARGUMENTS)
{
  ...
  {
#ifdef DEBUG
    printf("Boundary_ApplyPhysicalBCs: looping through bcdata list, at bcdata entry for %s bc\n", current_bcdata->bc_name);
