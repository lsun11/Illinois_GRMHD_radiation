 /*@@
   ...
   @enddesc
   @version   $Id: StaticBoundary.c,v 1.20 2006/10/05 16:56:28 schnetter Exp $
 @@*/
...
static const char *rcsid = "$Header: /cactusdevcvs/CactusBase/Boundary/src/StaticBoundary.c,v 1.20 2006/10/05 16:56:28 schnetter Exp $";
...
void CCTK_FCALL bndstaticdirvi_
                           (int *ierr,
                            const cGH **GH,
                            const int *stencil_size,
                            const int *dir,
                            const int *vi);
void CCTK_FCALL bndstaticvi_
                           (int *ierr,
                            const cGH **GH,
                            const int *stencil,
                            const int *vi);
void CCTK_FCALL bndstaticdirgi_
                           (int *ierr,
                            const cGH **GH,
                            const int *stencil_size,
                            const int *dir,
                            const int *gi);
void CCTK_FCALL bndstaticgi_
                           (int *ierr,
                            const cGH **GH,
                            const int *stencil,
                            const int *gi);
void CCTK_FCALL bndstaticdirvn_
                           (int *ierr,
                            const cGH **GH,
                            const int *stencil_size,
                            const int *dir,
                            ONE_FORTSTRING_ARG);
void CCTK_FCALL bndstaticvn_
                           (int *ierr,
                            const cGH **GH,
                            const int *stencil,
                            ONE_FORTSTRING_ARG);
void CCTK_FCALL bndstaticdirgn_
                           (int *ierr,
                            const cGH **GH,
                            const int *stencil_size,
                            const int *dir,
                            ONE_FORTSTRING_ARG);
void CCTK_FCALL bndstaticgn_
                           (int *ierr,
                            const cGH **GH,
                            const int *stencil,
                            ONE_FORTSTRING_ARG);
