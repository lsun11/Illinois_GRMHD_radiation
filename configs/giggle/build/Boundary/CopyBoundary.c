 /*@@
   ...
   @endhistory
   @version   $Id: CopyBoundary.c,v 1.36 2006/10/05 16:56:28 schnetter Exp $
 @@*/
...
static const char *rcsid = "$Header: /cactusdevcvs/CactusBase/Boundary/src/CopyBoundary.c,v 1.36 2006/10/05 16:56:28 schnetter Exp $";
