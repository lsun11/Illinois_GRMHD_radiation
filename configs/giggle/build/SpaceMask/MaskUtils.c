/*@@
  ...
  @desc
  @version   $Header: /cactusdevcvs/CactusEinstein/SpaceMask/src/MaskUtils.c,v 1.13 2005/12/18 21:40:52 schnetter Exp $
@@*/
...
static const char* rcsid = "$Header: /cactusdevcvs/CactusEinstein/SpaceMask/src/MaskUtils.c,v 1.13 2005/12/18 21:40:52 schnetter Exp $";
...
void CCTK_FCALL spacemask_gettypebits_(CCTK_INT* type_bits,
                                                  ONE_FORTSTRING_ARG);
void CCTK_FCALL spacemask_getstatebits_(CCTK_INT* state_bits,
                                                   TWO_FORTSTRING_ARG);
void CCTK_FCALL spacemask_setstate_(CCTK_INT* mask,
                                               CCTK_INT* point, TWO_FORTSTRING_ARG);
void CCTK_FCALL spacemask_checkstate_(int* retval,
                                                 CCTK_INT* mask,
                                                 CCTK_INT* point,
                                                 TWO_FORTSTRING_ARG);
...
void
CCTK_FCALL spacemask_registertype_(int* ierr, char* type_name,
...
void
CCTK_FCALL spacemask_gettypebits_(CCTK_INT* type_bits,
                                             ONE_FORTSTRING_ARG)
{
...
void
CCTK_FCALL spacemask_getstatebits_(CCTK_INT* state_bits,
                                              TWO_FORTSTRING_ARG)
{
...
void
CCTK_FCALL spacemask_setstate_(CCTK_INT* mask,
                                          CCTK_INT* point, TWO_FORTSTRING_ARG)
{
...
void
CCTK_FCALL spacemask_checkstate_(int* retval,
                                            CCTK_INT* mask,
                                            CCTK_INT* point,
                                            TWO_FORTSTRING_ARG)
{
