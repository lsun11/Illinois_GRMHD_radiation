...
!----------------------------------------
subroutine mhd_shock_rest_mass_integrand1d(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cct&
  ...
  &ctk_convfac,cctk_nghostzones,cctk_iteration,cctkGH, X0mhd_shock_private,X1mhd_shock_private,X2mhd_shock_private,shock_rest_mass_&
  &integrand,shock_restmass_VolInt, X0BSSN_AH,X0BSSN_aux_private,X0BSSN_aux_restrict2,X0BSSN_diag_restrict,X0BSSN_gupij,X0BSSN_matt&
