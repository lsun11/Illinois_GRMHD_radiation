/*@@
   ...
   @desc
            Creates the CCTK variables for thorn LoopControl
   @enddesc
 @@*/


#define THORN_IS_LoopControl 1
...
static int CCTKi_BindingsFortranWrapperLoopControl(void *_GH, void *fpointer);
...
#endif
  void (*function)(LOOPCONTROL_C2F_PROTO);
  DECLARE_LOOPCONTROL_C2F
  INITIALISE_LOOPCONTROL_C2F
  (void) (_cctk_zero + 0);
#ifndef CCTK_DEBUG
  (void) (_cctk_dummy_var + 0);
#endif

  function = (void (*) (LOOPCONTROL_C2F_PROTO)) fpointer;
  function (PASS_LOOPCONTROL_C2F (GH));
...
int CactusBindingsVariables_LoopControl_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("LoopControl", CCTKi_BindingsFortranWrapperLoopControl);
