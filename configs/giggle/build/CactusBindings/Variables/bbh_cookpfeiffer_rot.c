/*@@
   @file    bbh_cookpfeiffer_rot.c
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Creates the CCTK variables for thorn bbh_cookpfeiffer_rot
   @enddesc
 @@*/


#define THORN_IS_bbh_cookpfeiffer_rot 1
...
static int CCTKi_BindingsFortranWrapperbbh_cookpfeiffer_rot(void *_GH, void *fpointer);
...
#endif
  void (*function)(BBH_COOKPFEIFFER_ROT_C2F_PROTO);
  DECLARE_BBH_COOKPFEIFFER_ROT_C2F
  INITIALISE_BBH_COOKPFEIFFER_ROT_C2F
  (void) (_cctk_zero + 0);
#ifndef CCTK_DEBUG
  (void) (_cctk_dummy_var + 0);
#endif

  function = (void (*) (BBH_COOKPFEIFFER_ROT_C2F_PROTO)) fpointer;
  function (PASS_BBH_COOKPFEIFFER_ROT_C2F (GH));
...
int CactusBindingsVariables_bbh_cookpfeiffer_rot_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("bbh_cookpfeiffer_rot", CCTKi_BindingsFortranWrapperbbh_cookpfeiffer_rot);
