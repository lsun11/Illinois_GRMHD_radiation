/*@@
   ...
   @desc
            Creates the CCTK variables for thorn zlib
   @enddesc
 @@*/


#define THORN_IS_zlib 1
...
static int CCTKi_BindingsFortranWrapperzlib(void *_GH, void *fpointer);
...
static int CCTKi_BindingsFortranWrapperzlib(void *_GH, void *fpointer)
{
  ...
  function = (void (*) (ZLIB_C2F_PROTO)) fpointer;
  function (PASS_ZLIB_C2F (GH));
...
int CactusBindingsVariables_zlib_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("zlib", CCTKi_BindingsFortranWrapperzlib);
