/*@@
   ...
   @desc
            Creates the CCTK variables for thorn excision
   @enddesc
 @@*/


#define THORN_IS_excision 1
...
static int CCTKi_BindingsFortranWrapperexcision(void *_GH, void *fpointer);
...
#endif
  void (*function)(EXCISION_C2F_PROTO);
  DECLARE_EXCISION_C2F
  INITIALISE_EXCISION_C2F
  (void) (_cctk_zero + 0);
#ifndef CCTK_DEBUG
  (void) (_cctk_dummy_var + 0);
#endif

  function = (void (*) (EXCISION_C2F_PROTO)) fpointer;
  function (PASS_EXCISION_C2F (GH));
...
int CactusBindingsVariables_excision_Initialise(void)
{
  ...
  if (CCTKi_CreateGroup ("EXCISION_INT_GFS", "EXCISION", "EXCISION",
                         "GF", "INT", "PROTECTED",
                         3, 1,
                         "NONE", "DEFAULT",
                         "", "",
                         ...
                         "excision_zone_gf") == 1)
  {
    warn_mixeddim_gfs = "excision_int_gfs";
    warn_mixeddim = 3;
  }
  ...
  CCTKi_RegisterFortranWrapper("excision", CCTKi_BindingsFortranWrapperexcision);
