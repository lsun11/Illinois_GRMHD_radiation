/*@@
   @file    CarpetTracker.c
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Creates the CCTK variables for thorn CarpetTracker
   @enddesc
 @@*/


#define THORN_IS_CarpetTracker 1
...
static int CCTKi_BindingsFortranWrapperCarpetTracker(void *_GH, void *fpointer);
...
#endif
  void (*function)(CARPETTRACKER_C2F_PROTO);
  DECLARE_CARPETTRACKER_C2F
  INITIALISE_CARPETTRACKER_C2F
  (void) (_cctk_zero + 0);
#ifndef CCTK_DEBUG
  (void) (_cctk_dummy_var + 0);
#endif

  function = (void (*) (CARPETTRACKER_C2F_PROTO)) fpointer;
  function (PASS_CARPETTRACKER_C2F (GH));
...
int CactusBindingsVariables_CarpetTracker_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("CarpetTracker", CCTKi_BindingsFortranWrapperCarpetTracker);
