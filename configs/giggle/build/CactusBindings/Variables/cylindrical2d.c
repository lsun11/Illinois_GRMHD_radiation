/*@@
   @file    cylindrical2d.c
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Creates the CCTK variables for thorn cylindrical2d
   @enddesc
 @@*/


#define THORN_IS_cylindrical2d 1
...
static int CCTKi_BindingsFortranWrappercylindrical2d(void *_GH, void *fpointer);
...
#endif
  void (*function)(CYLINDRICAL2D_C2F_PROTO);
  DECLARE_CYLINDRICAL2D_C2F
  INITIALISE_CYLINDRICAL2D_C2F
  (void) (_cctk_zero + 0);
#ifndef CCTK_DEBUG
  (void) (_cctk_dummy_var + 0);
#endif

  function = (void (*) (CYLINDRICAL2D_C2F_PROTO)) fpointer;
  function (PASS_CYLINDRICAL2D_C2F (GH));
...
int CactusBindingsVariables_cylindrical2d_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("cylindrical2d", CCTKi_BindingsFortranWrappercylindrical2d);
