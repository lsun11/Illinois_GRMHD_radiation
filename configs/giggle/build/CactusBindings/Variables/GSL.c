/*@@
   ...
   @desc
            Creates the CCTK variables for thorn GSL
   @enddesc
 @@*/


#define THORN_IS_GSL 1
...
static int CCTKi_BindingsFortranWrapperGSL(void *_GH, void *fpointer);
...
static int CCTKi_BindingsFortranWrapperGSL(void *_GH, void *fpointer)
{
  ...
  function = (void (*) (GSL_C2F_PROTO)) fpointer;
  function (PASS_GSL_C2F (GH));
...
int CactusBindingsVariables_GSL_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("GSL", CCTKi_BindingsFortranWrapperGSL);
