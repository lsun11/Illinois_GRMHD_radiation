/*@@
   @file    AEILocalInterp.c
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Creates the CCTK variables for thorn AEILocalInterp
   @enddesc
 @@*/


#define THORN_IS_AEILocalInterp 1
...
static int CCTKi_BindingsFortranWrapperAEILocalInterp(void *_GH, void *fpointer);
...
#endif
  void (*function)(AEILOCALINTERP_C2F_PROTO);
  DECLARE_AEILOCALINTERP_C2F
  INITIALISE_AEILOCALINTERP_C2F
  (void) (_cctk_zero + 0);
#ifndef CCTK_DEBUG
  (void) (_cctk_dummy_var + 0);
#endif

  function = (void (*) (AEILOCALINTERP_C2F_PROTO)) fpointer;
  function (PASS_AEILOCALINTERP_C2F (GH));
...
int CactusBindingsVariables_AEILocalInterp_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("AEILocalInterp", CCTKi_BindingsFortranWrapperAEILocalInterp);
