...
CCTK_INT CCTK_FCALL boundary_selectgroupforbc_ (const CCTK_POINTER_TO_CONST* GH ,
 const CCTK_INT* faces ,
 const CCTK_INT* boundary_width ,
 const CCTK_INT* table_handle ,
 TWO_FORTSTRING_ARG);
...
CCTK_INT CCTK_FCALL carpet_regrid_ (const CCTK_POINTER_TO_CONST* cctkGH ,
 const CCTK_POINTER* superregss ,
 const CCTK_POINTER* regsss ,
 const CCTK_INT* force);
CCTK_INT CCTK_FCALL carpet_regrid_ (const CCTK_POINTER_TO_CONST* cctkGH ,
...
CCTK_INT CCTK_FCALL carpet_regridmaps_ (const CCTK_POINTER_TO_CONST* cctkGH ,
 const CCTK_POINTER* superregsss ,
 const CCTK_POINTER* regssss ,
 const CCTK_INT* force);
CCTK_INT CCTK_FCALL carpet_regridmaps_ (const CCTK_POINTER_TO_CONST* cctkGH ,
...
CCTK_INT CCTK_FCALL getcoordrange_ (const CCTK_POINTER_TO_CONST* cctkGH ,
 const CCTK_INT* m ,
 const CCTK_INT* ml ,
 const CCTK_INT* size ,
 CCTK_INT* gsh ,
...
CCTK_INT CCTK_FCALL getlocalcomponents_ (const CCTK_POINTER_TO_CONST* cctkGH);
CCTK_INT CCTK_FCALL getlocalcomponents_ (const CCTK_POINTER_TO_CONST* cctkGH)
{
  CCTK_INT retval;
...
CCTK_POINTER_TO_CONST CCTK_FCALL getmpicommuniverse_ (const CCTK_POINTER_TO_CONST* cctkGH);
CCTK_POINTER_TO_CONST CCTK_FCALL getmpicommuniverse_ (const CCTK_POINTER_TO_CONST* cctkGH)
{
  CCTK_POINTER_TO_CONST retval;
...
CCTK_POINTER_TO_CONST CCTK_FCALL getmpicommworld_ (const CCTK_POINTER_TO_CONST* cctkGH);
CCTK_POINTER_TO_CONST CCTK_FCALL getmpicommworld_ (const CCTK_POINTER_TO_CONST* cctkGH)
{
  CCTK_POINTER_TO_CONST retval;
...
CCTK_INT CCTK_FCALL getrefinementlevel_ (const CCTK_POINTER_TO_CONST* cctkGH);
CCTK_INT CCTK_FCALL getrefinementlevel_ (const CCTK_POINTER_TO_CONST* cctkGH)
{
  CCTK_INT retval;
...
CCTK_INT CCTK_FCALL getrefinementlevels_ (const CCTK_POINTER_TO_CONST* cctkGH);
CCTK_INT CCTK_FCALL getrefinementlevels_ (const CCTK_POINTER_TO_CONST* cctkGH)
{
  CCTK_INT retval;
...
CCTK_INT CCTK_FCALL horizoncentroid_ (const CCTK_INT* horizon_number ,
 CCTK_REAL* centroid_x ,
 CCTK_REAL* centroid_y ,
 CCTK_REAL* centroid_z);
CCTK_INT CCTK_FCALL horizoncentroid_ (const CCTK_INT* horizon_number ,
...
CCTK_INT CCTK_FCALL horizonlocalcoordinateorigin_ (const CCTK_INT* horizon_number ,
 CCTK_REAL* origin_x ,
 CCTK_REAL* origin_y ,
 CCTK_REAL* origin_z);
CCTK_INT CCTK_FCALL horizonlocalcoordinateorigin_ (const CCTK_INT* horizon_number ,
...
CCTK_INT CCTK_FCALL horizonradiusindirection_ (const CCTK_INT* horizon_number ,
 const CCTK_INT* N_points ,
 const CCTK_REAL* x ,
 const CCTK_REAL* y ,
 const CCTK_REAL* z ,
...
CCTK_INT CCTK_FCALL horizonwasfound_ (const CCTK_INT* horizon_number);
CCTK_INT CCTK_FCALL horizonwasfound_ (const CCTK_INT* horizon_number)
{
  CCTK_INT retval;
...
CCTK_INT CCTK_FCALL multipatch_getsystemspecification_ (CCTK_INT* maps);
CCTK_INT CCTK_FCALL multipatch_getsystemspecification_ (CCTK_INT* maps)
{
  CCTK_INT retval;
...
CCTK_INT CCTK_FCALL multipatch_mapiscartesian_ (const CCTK_INT* map);
CCTK_INT CCTK_FCALL multipatch_mapiscartesian_ (const CCTK_INT* map)
{
  CCTK_INT retval;
...
CCTK_INT CCTK_FCALL queryprolongating_ (void);
CCTK_INT CCTK_FCALL queryprolongating_ (void)
{
  CCTK_INT retval;
...
CCTK_INT CCTK_FCALL registerschedulewrapper_ (CCTK_INT (*const func_before)(const CCTK_POINTER_TO_CONST* cctkGH ,
 const CCTK_POINTER* function ,
 const CCTK_POINTER* attribute ,
 const CCTK_POINTER* data) ,
 CCTK_INT (*const func_after)(const CCTK_POINTER_TO_CONST* cctkGH ,
...
CCTK_INT CCTK_FCALL regridlevel_ (const CCTK_POINTER_TO_CONST* cctkGH ,
 const CCTK_INT* current_max_reflevel ,
 const CCTK_INT* max_reflevels);
CCTK_INT CCTK_FCALL regridlevel_ (const CCTK_POINTER_TO_CONST* cctkGH ,
 const CCTK_INT* current_max_reflevel ,
...
void CCTK_FCALL setdriftcorrectposition_ (const CCTK_POINTER_TO_CONST* GH ,
 const CCTK_REAL* x ,
 const CCTK_REAL* y ,
 const CCTK_REAL* z);
void CCTK_FCALL setdriftcorrectposition_ (const CCTK_POINTER_TO_CONST* GH ,
...
CCTK_INT CCTK_FCALL unregisterschedulewrapper_ (CCTK_INT (*const func_before)(const CCTK_POINTER_TO_CONST* cctkGH ,
 const CCTK_POINTER* function ,
 const CCTK_POINTER* attribute ,
 const CCTK_POINTER* data) ,
 CCTK_INT (*const func_after)(const CCTK_POINTER_TO_CONST* cctkGH ,
...
CCTK_POINTER_TO_CONST CCTK_FCALL uniquebuildid_ (const CCTK_POINTER_TO_CONST* cctkGH);
CCTK_POINTER_TO_CONST CCTK_FCALL uniquebuildid_ (const CCTK_POINTER_TO_CONST* cctkGH)
{
  CCTK_POINTER_TO_CONST retval;
...
CCTK_POINTER_TO_CONST CCTK_FCALL uniqueconfigid_ (const CCTK_POINTER_TO_CONST* cctkGH);
CCTK_POINTER_TO_CONST CCTK_FCALL uniqueconfigid_ (const CCTK_POINTER_TO_CONST* cctkGH)
{
  CCTK_POINTER_TO_CONST retval;
...
CCTK_POINTER_TO_CONST CCTK_FCALL uniquerunid_ (const CCTK_POINTER_TO_CONST* cctkGH);
CCTK_POINTER_TO_CONST CCTK_FCALL uniquerunid_ (const CCTK_POINTER_TO_CONST* cctkGH)
{
  CCTK_POINTER_TO_CONST retval;
...
CCTK_POINTER_TO_CONST CCTK_FCALL uniquesimulationid_ (const CCTK_POINTER_TO_CONST* cctkGH);
CCTK_POINTER_TO_CONST CCTK_FCALL uniquesimulationid_ (const CCTK_POINTER_TO_CONST* cctkGH)
{
  CCTK_POINTER_TO_CONST retval;
...
CCTK_POINTER_TO_CONST CCTK_FCALL uniquesourceid_ (const CCTK_POINTER_TO_CONST* cctkGH);
CCTK_POINTER_TO_CONST CCTK_FCALL uniquesourceid_ (const CCTK_POINTER_TO_CONST* cctkGH)
{
  CCTK_POINTER_TO_CONST retval;
...
CCTK_POINTER CCTK_FCALL vardataptri_ (const CCTK_POINTER_TO_CONST* cctkGH ,
 const CCTK_INT* map ,
 const CCTK_INT* reflevel ,
 const CCTK_INT* component ,
 const CCTK_INT* timelevel ,
