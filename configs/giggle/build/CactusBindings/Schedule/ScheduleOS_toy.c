...
extern int mhd_os_initialdata_local_(void);
extern int os_rad_copy_to_prev_timelevel_(void);
extern int mhd_os_initialdata_global_(void);
extern int particle_tracer_toy_(void);
extern int os_rad_diag_integrals_(void);
...
if (enable_OS_collapse==1){
  {
    ...
    CCTKi_ScheduleFunction((void *)mhd_os_initialdata_local_,
                           "OS_initialdata",
                           "OS_toy",
                           "OS_toy",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)os_rad_copy_to_prev_timelevel_,
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)mhd_os_initialdata_global_,
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)particle_tracer_toy_,
                           "tracer_toy",
                           "OS_toy",
                           "OS_toy",
                           "do particle tracer",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)os_rad_diag_integrals_,
                           "OS_poststep",
                           "OS_toy",
                           "OS_toy",
