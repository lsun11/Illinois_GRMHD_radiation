...
extern int mhd_shock_initialdata_local_(void);
extern int mhd_shock_initialdata_global_(void);
...
if (read_radiation_shock_data == 1){
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)mhd_shock_initialdata_local_,
                           "initialdata",
                           "shock_mhd",
                           "mhd_shock",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)mhd_shock_initialdata_global_,
                           "third_initialdata",
                           "shock_mhd",
                           "mhd_shock",
                           "Set rho_b_atm, etc.",
