...
extern int lin_wave_initialdata_(void);
extern int lw_sanitycheck_restore_aij_(void);
extern int lw_diagnostics_local_(void);
extern int lw_diagnostics_(void);
...
void CCTKi_BindingsSchedule_linearized_wave(void)
{
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)lin_wave_initialdata_,
                           "first_initialdata",
                           "linearized_wave",
                           "linearized_wave",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)lw_sanitycheck_restore_aij_,
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)lw_diagnostics_local_,
                           "poststep_local",
                           "linearized_wave",
                           "linearized_wave",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)lw_diagnostics_,
                           "poststep",
                           "linearized_wave",
                           "linearized_wave",
