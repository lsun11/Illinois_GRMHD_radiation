...
extern int twopunctures_read_inputfile_driver_(void);
extern int twopunctures_initialdata_(void);
extern int twopunctures_diagnostics_(void);
...
void CCTKi_BindingsSchedule_TwoPunctures(void)
{
  ...
  CCTKi_ScheduleGroupStorage("TwoPunctures::M_ADM",1);
  {
    ...
    CCTKi_ScheduleFunction((void *)twopunctures_read_inputfile_driver_,
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)twopunctures_initialdata_,
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)twopunctures_diagnostics_,
                           "poststep",
                           "TwoPunctures",
                           "TwoPunctures",
