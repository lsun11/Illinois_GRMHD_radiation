...
extern int bbhlorene_read_inputfile_driver_(void);
extern int bbhlorene_initialdata_(void);
extern int bbhlorene_diagnostics_(void);
...
void CCTKi_BindingsSchedule_bbhlorene(void)
{
  ...
  CCTKi_ScheduleGroupStorage("diagnostics_vacuum::volIntegrals",1);
  {
    ...
    CCTKi_ScheduleFunction((void *)bbhlorene_read_inputfile_driver_,
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)bbhlorene_initialdata_,
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)bbhlorene_diagnostics_,
                           "poststep",
                           "bbhlorene",
                           "bbhlorene",
