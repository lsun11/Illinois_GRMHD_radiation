...
extern int ang_freq_ofbfield_initsym_(void);
extern int ang_freq_ofbfield_driver_(void);
extern int ang_freq_ofbfield_diagnostics_(void);
...
void CCTKi_BindingsSchedule_ang_freq_ofBfield(void)
{
  ...
  CCTKi_ScheduleGroupStorage("ang_freq_ofBfield::OmegF",3);
  {
    ...
    CCTKi_ScheduleFunction((void *)ang_freq_ofbfield_initsym_,
...
if(num_interp_radii_om>0) {
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)ang_freq_ofbfield_driver_,
                           "ang_freq",
                           "ang_freq_ofBfield",
                           "ang_freq_ofBfield",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)ang_freq_ofbfield_diagnostics_,
