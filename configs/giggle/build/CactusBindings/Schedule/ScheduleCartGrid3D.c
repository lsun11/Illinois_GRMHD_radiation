...
extern int SymmetryStartup(void);
extern int RegisterCartGrid3DCoords(void);
extern int RegisterSymmetryBoundaries(void);
extern int ParamCheck_CartGrid3D(void);
extern int CartGrid3D_SetRanges(void);
extern int CartGrid3D_SetRanges(void);
extern int CartGrid3D_SetRanges(void);
extern int CartGrid3D_SetCoordinates(void);
extern int CartGrid3D_SetCoordinates(void);
extern int CartGrid3D_SetCoordinates(void);
extern int CartGrid3D_ApplyBC(void);
