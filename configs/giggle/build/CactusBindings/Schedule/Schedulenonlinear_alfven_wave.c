...
extern int nonlinear_alfven_wave_initialdata_local_(void);
extern int nonlinear_alfven_wave_initialdata_global_(void);
extern int nonlinear_alfven_wave_analytic_time_(void);
...
void CCTKi_BindingsSchedule_nonlinear_alfven_wave(void)
{
  ...
  CCTKi_ScheduleGroupStorage("diagnostics_mhd::volIntegrals_mhd",1);
  {
    ...
    CCTKi_ScheduleFunction((void *)nonlinear_alfven_wave_initialdata_local_,
                           "initialdata",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)nonlinear_alfven_wave_initialdata_global_,
                           "third_initialdata",
                           "nonlinear_alfven_wave",
                           "nonlinear_alfven_wave",
                           "Set rho_b_atm, etc.",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)nonlinear_alfven_wave_analytic_time_,
