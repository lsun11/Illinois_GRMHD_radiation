...
extern int CarpetInterpStartup(void);
...
void CCTKi_BindingsSchedule_CarpetInterp(void)
{
  DECLARE_CCTK_PARAMETERS
  {
    ...
    CCTKi_ScheduleFunction((void *)CarpetInterpStartup,
                           "CarpetInterpStartup",
                           "CarpetInterp",
                           "interp",
                           "Startup routine",
...
/*@@
  @routine    CCTKi_BindingsParameterRecovery_CarpetInterp
  @author     Automatically generated by CreateScheduleBindings.pl
  @desc
              Creates the parameter recovery bindings for thorn CarpetInterp
  @enddesc
@@*/
