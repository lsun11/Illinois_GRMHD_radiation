subroutine convert_fish_matter(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_time&
  ...
  do k=1,ex(3)
     do j=1,ex(2)
        do i=1,ex(1)
           ...
           !  write(6,*)Boundary0:,vxi(60,1,1),vyi(60,1,1),vzi(60,1,1),jxx(60,1,1),jxy(60,1,1),jxz(60,1,1),vx(60,1,1),vy(60,1,1),vz(
           fac = DR*(RP/r)**2
