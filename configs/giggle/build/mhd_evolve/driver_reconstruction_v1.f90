...
!--------------------------------------------------------------------------
subroutine reconstruction_v1(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_time,c&
...
!  write(*,*) HELLO AFTER COMPUTE UR UL BZL = ,Bzl(2,2,2),Bzr(2,2,2),dBz_m(1,2,2),dBz_m(2,2,2),Bz(1,2,2),Bz(2,2,2)
  ...
  if(Reconstruction.ne.MC) then
     write(*,*) "SORRY, CENO OR PPM RECONSTRUCTION NOT SUPPORTED WITH RECONSTRUCTION V1.  Please try reconstruction_v2 for PPM, or &
  &port over CENO!"
     stop
     !call mhd_advect_1D_PPM_CENO_predict(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_
  end if
