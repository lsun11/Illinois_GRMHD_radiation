!-----------------------------------------------
! Zero out Bi_rhss (for em_evolve_ct_active=0)
!-----------------------------------------------
subroutine zero_emfields_rhs(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_time,c&
