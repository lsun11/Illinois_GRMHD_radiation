!-----------------------------------------------------
! Compute MHD fluxes and rhss in one direction: v2.0
!-----------------------------------------------------
subroutine mhd_flux_and_rhs1D_v2(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_ti&
