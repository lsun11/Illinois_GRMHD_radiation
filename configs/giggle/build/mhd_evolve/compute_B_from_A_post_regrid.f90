...
!
!-------------------------------------------------------------------------------
subroutine compute_B_from_A_post_regrid(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_d&
  ...
  &_convfac,cctk_nghostzones,cctk_iteration,cctkGH, X0em_fijs,X0em_ftijs,X0rad_fijs,X0rad_fijs_diag,X1em_fijs,X1em_ftijs,X1rad_fijs&
  &,X1rad_fijs_diag,X2em_fijs,X2em_ftijs,X2rad_fijs,X2rad_fijs_diag,S_radx_flux,S_radx_flux_x,S_radx_flux_xp1,S_radx_nue_flux,S_rad&
  &x_nux_flux,S_rady_flux,S_rady_nue_flux,S_rady_nux_flux,S_radz_flux,S_radz_nue_flux,S_radz_nux_flux,ftxy,ftxz,ftyx,ftyz,ftzx,ftzy&
  &,fxy,fxz,fyx,fyz,fzx,fzy,tau_rad_advect_diag,tau_rad_flux,tau_rad_flux_diag,tau_rad_flux_x,tau_rad_nue_flux,tau_rad_nux_flux,tau&
  &_rad_scalar_diag, X0BSSN_AH,X0BSSN_aux_private,X0BSSN_aux_restrict2,X0BSSN_diag_restrict,X0BSSN_gupij,X0BSSN_matter,X0BSSN_refbd&
...
!  call CartSymGN(dummy,cctkGH,mhd_evolve::temperatures)
  call compute_B_from_A(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_time,cctk_t&
  ...
  &hostzones,cctk_iteration,cctkGH, X0em_fijs,X0em_ftijs,X0rad_fijs,X0rad_fijs_diag,X1em_fijs,X1em_ftijs,X1rad_fijs,X1rad_fijs_diag&
  &,X2em_fijs,X2em_ftijs,X2rad_fijs,X2rad_fijs_diag,S_radx_flux,S_radx_flux_x,S_radx_flux_xp1,S_radx_nue_flux,S_radx_nux_flux,S_rad&
  &y_flux,S_rady_nue_flux,S_rady_nux_flux,S_radz_flux,S_radz_nue_flux,S_radz_nux_flux,ftxy,ftxz,ftyx,ftyz,ftzx,ftzy,fxy,fxz,fyx,fyz&
  &,fzx,fzy,tau_rad_advect_diag,tau_rad_flux,tau_rad_flux_diag,tau_rad_flux_x,tau_rad_nue_flux,tau_rad_nux_flux,tau_rad_scalar_diag&
