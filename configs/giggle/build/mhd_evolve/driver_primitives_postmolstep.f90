...
!--------------------------------------------------------------
!
subroutine mhd_primitives_postmolstep(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_del&
...
!              call EXIT(STATUS)                                                                                            
           ...
           write(*,*) "Inside driver_primitives_postmolstep.F90, microphysics_scheme,rad_evolve_enable,rad_closure_scheme=",microph&
  &ysics_scheme,rad_evolve_enable,rad_closure_scheme
              call  primitive_vars_rad_cpp(ext,cctk_nghostzones, X, Y, Z, &
                   rho_star, &
