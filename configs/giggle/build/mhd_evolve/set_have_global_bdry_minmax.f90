subroutine mhd_set_have_global_bdry_minmax(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cct&
  ...
  if(levelnumber==1.D0) then
     ...
     write(*,*) "SETTING have_global_bdry_minmaxs:",have_global_bdry_min,have_global_bdry_max
  end if
  do ierr=1,60
!     have_global_bdry_min(ierr) = int(levelnumber)*ierr
!     have_global_bdry_max(ierr) = (61-ierr)*int(levelnumber)
  end do
  write(*,*) "MHD MIN?:",levelnumber,have_global_bdry_min
end subroutine mhd_set_have_global_bdry_minmax
