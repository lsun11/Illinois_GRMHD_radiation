...
!-------------------------------------------------------
!
subroutine mhd_timestepping_v1(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_time&
  ...
  if(iter_count==1.and.em_evolve_enable==0) then
     ...
     if (handle .gt. 0) then
        ...
        call CCTK_Warn(1,60,"driver_timestepping_v1.F90","mhd_evolve","TestReduce: Invalid reduction operator")
     end if
     ...
     if (handle .gt. 0) then
        ...
        call CCTK_Warn(1,71,"driver_timestepping_v1.F90","mhd_evolve","TestReduce: Invalid reduction operator")
     end if
     ...
     if (handle .gt. 0) then
        ...
        call CCTK_Warn(1,82,"driver_timestepping_v1.F90","mhd_evolve","TestReduce: Invalid reduction operator")
     end if
  ...
  mhd_st_z_rhs = 0.D0
  m = 1
  call reconstruction_v1(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_time,cctk_&
  ...
  call mhd_flux_and_rhs1D_v1(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_time,c&
  ...
  if (Symmetry .ne. AXISYM) then
     m = 2
     call reconstruction_v1(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_time,cc&
  ...
  &ordinates,coarse_dx,coarse_dy,coarse_dz,r,x,y,z)
     call mhd_flux_and_rhs1D_v1(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_tim&
