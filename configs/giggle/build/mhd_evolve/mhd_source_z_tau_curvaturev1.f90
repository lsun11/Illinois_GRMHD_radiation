...
subroutine mhd_tau_curvature(ext,tau_rhs,rho_star,h,P,sbt,sbx,sby,sbz, &
  ...
  !
  !  write(*,*) inside mhd_tau_curv0, tau_rhs(16,2,2),rho_star(16,2,2),h(16,2,2),u0(16,2,2),sqrtg(16,2,2),b2(16,2,2),u0(16,2,2),Psi4
  ...
  !  write(*,*) inside mhd_tau_curv, tau_rhs(16,2,2),rho_star(16,2,2),h(16,2,2),u0(16,2,2),sqrtg(16,2,2),b2(16,2,2),u0(16,2,2),Psi4(
