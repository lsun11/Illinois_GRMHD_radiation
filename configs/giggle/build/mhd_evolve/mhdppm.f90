...
! write(*,*) inside mhdppm_ffv1,vx(15,2,2),vy(15,2,2),vz(15,2,2),vxl(15,2,2),vxr(15,2,2),vyl(15,2,2),vyr(15,2,2),vzl(15,2,2),vzr(15,
! write(*,*) inside mhdppm_ffv1,vx(2,3,2),vy(2,3,2),vz(2,3,2),vxl(2,3,2),vxr(2,3,2),vyl(2,3,2),vyr(2,3,2),vzl(2,3,2),vzr(2,3,2),Bxl(
! write(*,*) inside mhdppm_ffv1,rhor(15,2,2),Pr(15,2,2),vxr(15,2,2),Bxr(15,2,2),vyr(15,2,2),Byr(15,2,2),vzr(15,2,2),Bzr(15,2,2),delt
! write(*,*) inside mhdppm_ffv2,rhol(15,2,2),Pl(15,2,2),vxl(15,2,2),Bxl(15,2,2),vyl(15,2,2),Byl(15,2,2),vzl(15,2,2),Bzl(15,2,2),delt
...
! write(*,*) inside mhdppm_flatten0,rho_br(15,2,2),Pr(15,2,2),vxr(15,2,2),Bxr(15,2,2),vyr(15,2,2),Byr(15,2,2),vzr(15,2,2),Bzr(15,2,2
 if (m==1) then
    do k=kmin,kmax
       do j=jmin,jmax
          do i=imin+1,imax-1
...
! write(*,*) inside mhdppm_flatten1,rho_br(15,2,2),Pr(15,2,2),vxr(15,2,2),Bxr(15,2,2),vyr(15,2,2),Byr(15,2,2),vzr(15,2,2),Bzr(15,2,2
! write(*,*) inside mhdppm_flatten2,rho_bl(15,2,2),Pl(15,2,2),vxl(15,2,2),Bxl(15,2,2),vyl(15,2,2),Byl(15,2,2),vzl(15,2,2),Bzl(15,2,2
