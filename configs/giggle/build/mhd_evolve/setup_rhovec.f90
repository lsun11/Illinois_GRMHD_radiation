...
!
!-----------------------------------------------------------------------------
subroutine Setup_Rhovec(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_time,cctk_t&
  ...
  call CCTK_Reduce (err,cctkGH, -1,handle, 1, 107,rmax,1,index)
  ...
  ! no need to rescale k_poly; its already done
  !Eq. G30     
