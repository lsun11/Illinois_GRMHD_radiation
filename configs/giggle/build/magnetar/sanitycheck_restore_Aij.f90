...
!-----------------------------------------------------------------------------
!
subroutine magnetar_sanitycheck_restore_Aij(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cc&
...
!  end if
end subroutine magnetar_sanitycheck_restore_Aij
