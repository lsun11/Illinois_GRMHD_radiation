...
!--------------------------------------------------------
subroutine magnetar_setup_remaining_matter_quantities(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cc&
  ...
  &convlevel,cctk_convfac,cctk_nghostzones,cctk_iteration,cctkGH, RADEQUAT,magnetar_max_b2, X0BSSN_AH,X0BSSN_aux_private,X0BSSN_aux&
  ...
  &r,vz,vzl,vzr,w,zeta_rad,zeta_rad_nue,zeta_rad_nux, X0coordinates,X0radii,X0sf_radius,X1coordinates,X1sf_radius,X2coordinates,act&
  &ive_length,num_levels_length,positions_length,radii_length,sf_active_length,sf_coordinate_descriptors_length,sf_info_length,sf_m&
  &axreflevel_length,sf_minreflevel_length,sf_origin_length,sf_radius_length,sf_shape_descriptors_length,sf_valid_length,active,coa&
  &rse_dx,coarse_dy,coarse_dz,num_levels,position_x,position_y,position_z,r,radius,sf_active,sf_area,sf_centroid_x,sf_centroid_y,sf&
