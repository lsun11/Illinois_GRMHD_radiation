...
!--------------------------------------------------------
subroutine magnetar_compute_rho_b_atm(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_del&
  ...
  if (handle .gt. 0) then
     ...
     call CCTK_Warn(1,31,"initialdata_part2_global-compute_rho_b_atm.F90","magnetar","TestReduce: Invalid reduction operator")
  end if
