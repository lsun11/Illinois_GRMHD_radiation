...
!
!-----------------------------------------------------------------------------
subroutine BSSN_Gauge_Derivs(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_time,c&
...
!
  ...
  ext(2) = cctk_lsh(2)
  ext(3) = cctk_lsh(3)
  ! Zach says: Ive commented out the following function call for efficiency, since 
