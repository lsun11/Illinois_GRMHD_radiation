...
!-----------------------------------------------------------------------------
!
subroutine BSSN_timestepping_Cowling(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delt&
...
!
  ...
  ext = cctk_lsh
!The following call might not be necessary, but Ive added it here just in case...
