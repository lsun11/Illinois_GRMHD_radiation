...
!--------------------------------------------
subroutine driver_bssn_update_boundary(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_de&
  ...
  if(cctk_iteration.gt.0) then
     ...
     if(cctk_iteration.gt.0 .and. levelnumber==1.D0) then
        ...
        !need Syncs for axisymmetric, non-Carpet runs
