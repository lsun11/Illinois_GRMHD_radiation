...
!------------------------------------------------------------
subroutine lapse_postbc(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_time,cctk_t&
  ...
  &hostzones,cctk_iteration,cctkGH, X0lapse_vars_temp,X1lapse_vars_temp,X2lapse_vars_temp,trK_init, X0BSSN_AH,X0BSSN_aux_private,X0&
