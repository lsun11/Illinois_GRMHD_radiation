...
!------------------------------------------
subroutine hyperbolic_lapse_timestepping(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_&
  ...
  &k_convfac,cctk_nghostzones,cctk_iteration,cctkGH, X0lapse_vars_temp,X1lapse_vars_temp,X2lapse_vars_temp,trK_init, X0BSSN_AH,X0BS&
