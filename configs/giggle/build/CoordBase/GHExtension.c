 /*@@
   ...
   @enddesc
   @version   $Id: GHExtension.c,v 1.3 2008/02/20 00:20:00 schnetter Exp $
 @@*/
...
static const char *rcsid = "$Header: /cactusdevcvs/CactusBase/CoordBase/src/GHExtension.c,v 1.3 2008/02/20 00:20:00 schnetter Exp $";
