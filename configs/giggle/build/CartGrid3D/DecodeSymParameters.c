 ...
 /*@@
   ...
   @enddesc
   @version $Id: DecodeSymParameters.c,v 1.8 2004/05/17 12:28:55 goodale Exp $
 @@*/
...
static const char *rcsid = "$Header: /cactusdevcvs/CactusBase/CartGrid3D/src/DecodeSymParameters.c,v 1.8 2004/05/17 12:28:55 goodale Exp $";

CCTK_FILEVERSION(CactusBase_CartGrid3D_DecodeSymParameters_c)

void DecodeSymParameters3D(int sym[6]);
void CCTK_FCALL decodesymparameters3d_ (int sym[6]);
