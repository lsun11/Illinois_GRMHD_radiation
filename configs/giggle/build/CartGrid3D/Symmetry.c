 /*@@
   ...
   @endhistory
   @version   $Id: Symmetry.c,v 1.44 2008/02/20 00:24:06 schnetter Exp $
 @@*/
...
static const char *rcsid = "$Header: /cactusdevcvs/CactusBase/CartGrid3D/src/Symmetry.c,v 1.44 2008/02/20 00:24:06 schnetter Exp $";
 ...
 ********************************************************************/
void CCTK_FCALL cartsymgi_ (int *ierr, const cGH **GH, int *gindex);
void CCTK_FCALL cartsymgn_
                           (int *ierr, const cGH **GH, ONE_FORTSTRING_ARG);
void CCTK_FCALL cartsymvi_ (int *ierr, const cGH **GH, int *vindex);
