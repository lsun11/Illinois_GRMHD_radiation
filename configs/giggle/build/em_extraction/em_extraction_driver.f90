subroutine em_extraction_driver(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_tim&
  ...
  &x, X0coordinates,X1coordinates,X2coordinates,coarse_dx,coarse_dy,coarse_dz,r,x,y,z)
  implicit none
  INTEGER cctk_dim
...
!          SPx,SPy,SPz,T_hat0x,T_hat0y,T_hat0z)
     ones = 1
     ! Vasilis says: I m not so sure about the following, but its probably OK
