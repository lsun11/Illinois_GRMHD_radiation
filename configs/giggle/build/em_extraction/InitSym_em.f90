!
!
subroutine em_extraction_InitSym(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_ti&
...
!  call SetCartSymVN(ierr,cctkGH, ones,em_extraction::Tlow0upr)
  ! Vasilis says: Heres I m copying the (equatorial and no symmetry) symmetry 
