...
!-----------------------------------------------------------------------------
subroutine em_extract_diagnostics(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_t&
...
31         FORMAT("em_lum.lon.",I1)
        ...
        call em_radiative_luminosity(cctkGH,export_data(4),export_data(5),export_data(6),export_data(7),export_data(8),export_data(&
  &9),export_data(10),ii,cctk_time)
