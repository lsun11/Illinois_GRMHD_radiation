...
!------------------------------------------------
subroutine diagnostic_mag_bondi_accretion(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk&
  ...
  &tk_convfac,cctk_nghostzones,cctk_iteration,cctkGH, X0horizon_data_arrays,nn_d,nx_d,ny_d,nz_d,xmax_bondi,xn_d,yn_d,zmax_bondi,zn_&
  &d, X0BSSN_AH,X0BSSN_aux_private,X0BSSN_aux_restrict2,X0BSSN_diag_restrict,X0BSSN_gupij,X0BSSN_matter,X0BSSN_refbd,X0BSSN_rhs,X0B&
  ...
  &2_radr,v02l,v02r,vvec,vx,vxl,vxr,vy,vyl,vyr,vz,vzl,vzr,w,zeta_rad,zeta_rad_nue,zeta_rad_nux, X0coordinates,X0radii,X1coordinates&
  &,X2coordinates,active_length,num_levels_length,positions_length,radii_length,active,coarse_dx,coarse_dy,coarse_dz,num_levels,pos&
  &ition_x,position_y,position_z,r,radius,x,y,z)
  implicit none
  INTEGER cctk_dim
