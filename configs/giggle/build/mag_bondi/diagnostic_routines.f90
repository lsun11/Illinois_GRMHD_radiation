...
!
  ...
  if (interp_handle .lt. 0) then
     call CCTK_Warn(0,287,"diagnostic_routines.F90","mag_bondi","Cannot get handle for interpolation ! Forgot to activate an implem&
  &entation providing interpolation operators ??")
  endif
  ...
  if (param_table_handle .lt. 0) then
     call CCTK_Warn(0,294,"diagnostic_routines.F90","mag_bondi","Cannot create parameter table for interpolator")
  endif
  coord_system_handle = -1
  call CCTK_CoordSystemHandle (coord_system_handle, "cart3d")
  if (coord_system_handle .lt. 0) then
     call CCTK_Warn(0,300,"diagnostic_routines.F90","mag_bondi","Cannot get handle for cart3d coordinate system ! Forgot to activat&
  &e an implementation providing coordinates ??")
  endif
