subroutine mag_bondi_initialdata_part2p5(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_&
  ...
  &k_convfac,cctk_nghostzones,cctk_iteration,cctkGH, X0horizon_data_arrays,nn_d,nx_d,ny_d,nz_d,xmax_bondi,xn_d,yn_d,zmax_bondi,zn_d&
  ...
  &_radr,v02l,v02r,vvec,vx,vxl,vxr,vy,vyl,vyr,vz,vzl,vzr,w,zeta_rad,zeta_rad_nue,zeta_rad_nux, X0coordinates,X0radii,X1coordinates,&
  &X2coordinates,active_length,num_levels_length,positions_length,radii_length,active,coarse_dx,coarse_dy,coarse_dz,num_levels,posi&
  &tion_x,position_y,position_z,r,radius,x,y,z)
  implicit none
  INTEGER cctk_dim
  ...
  call CCTK_Reduce(ierr,cctkGH, -1,handle, 1, &
       107,zmax_bondi,1,vindex)
  call CCTK_VarIndex(vindex,"grid::X")
  call CCTK_Reduce(ierr,cctkGH, -1,handle, 1, &
       107,xmax_bondi,1,vindex)
