...
subroutine mag_bondi_compute_b2(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_tim&
  ...
  &,cctk_nghostzones,cctk_iteration,cctkGH, X0horizon_data_arrays,nn_d,nx_d,ny_d,nz_d,xmax_bondi,xn_d,yn_d,zmax_bondi,zn_d, X0BSSN_&
