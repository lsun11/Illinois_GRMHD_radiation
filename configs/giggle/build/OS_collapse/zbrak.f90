        SUBROUTINE zbrak(func,x1,x2,n,xb1,xb2,nb,M,r,Mdot,K,Gamma,G29_rhs)
        ...
        INTERFACE
           FUNCTION func(rho0,M,r,Mdot,K,Gamma,G29_rhs)
             USE nrtype
             IMPLICIT NONE
             REAL(DP), INTENT(IN) :: rho0,M,r,Mdot,K,Gamma,G29_rhs
             REAL(DP) :: func
           END FUNCTION func
        END INTERFACE
        INTEGER(I4B) :: i
        ...
        do i=0,n
                f(i)=func(x(i),M,r,Mdot,K,Gamma,G29_rhs)
        end do
