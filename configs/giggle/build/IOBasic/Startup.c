 /*@@
   ...
   @enddesc
   @version   $Id: Startup.c,v 1.24 2005/11/14 16:48:53 schnetter Exp $
 @@*/
...
static const char *rcsid = "$Header: /cactusdevcvs/CactusBase/IOBasic/src/Startup.c,v 1.24 2005/11/14 16:48:53 schnetter Exp $";
