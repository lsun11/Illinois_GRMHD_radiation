...
!------------------------------------
subroutine bbhlorene_diagnostics(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_ti&
  ...
  if(MOD(cctk_iteration,out_every)==0) then
     ...
     write(*,*) "HIowldy",surf_radius,bh_posn_x(1),bh_posn_y(1),bh_posn_z(1)
...
31         FORMAT('binary_bh.jon.',I1)
        ...
        write(*,*) "HOWDY:",surf_radius,rbr,drbdr,ddrbddr
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  write(*,*) "FINISHED WITH bbhlorene_diagnostics!"
end subroutine bbhlorene_diagnostics
