...
CCTK_POINTER CCTK_FCALL cctk_pointerto_
                                  (CCTK_POINTER var);
CCTK_POINTER CCTK_FCALL cctk_nullpointer_
                                  (void);
...
ONE_FORTSTRING_PTR(string2)
 ...
 /*@@
   ...
   @endreturndesc
@@*/
CCTK_POINTER CCTK_FCALL cctk_pointerto_ (CCTK_POINTER var)
{
  return (var);
}
 ...
 /*@@
   ...
   @endreturndesc
@@*/
CCTK_POINTER CCTK_FCALL cctk_nullpointer_ (void)
{
  return (NULL);
}
