 /*@@
   ...
   @enddesc
   @version   $Id: GroupsOnGH.c 4076 2005-06-07 16:31:12Z tradke $
 @@*/
...
void CCTK_FCALL cctk_vardataptr_
     (CCTK_POINTER *res,
      const cGH **cctkGH,
      const int *timelevel,
      ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_vardataptri_
     (CCTK_POINTER *res,
      const cGH **cctkGH,
      const int *timelevel,
      const int *vindex);
...
void CCTK_FCALL cctk_groupbboxvn_
                           (int *ierr,
                            ...
                            int *bbox,
                            ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_activetimelevelsvi_
                           (int *num, const cGH **cctkGH, const int *var);
void CCTK_FCALL cctk_activetimelevelsvn_
                           (int *num, const cGH **cctkGH, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_activetimelevelsgi_
                           (int *num, const cGH **cctkGH, const int *var);
void CCTK_FCALL cctk_activetimelevelsgn_
                           (int *num, const cGH **cctkGH, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_activetimelevels_
                           (int *num, const cGH **cctkGH, ONE_FORTSTRING_ARG);
