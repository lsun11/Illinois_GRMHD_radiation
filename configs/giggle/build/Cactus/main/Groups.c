/*@@
   ...
   @enddesc
   @version   $Id: Groups.c 4476 2008-04-07 02:41:08Z schnetter $
 @@*/
...
void CCTK_FCALL cctk_groupname_
                           (int *nchars, int *var, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_groupnamefromvari_
                           (int *nchars, int *var, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_groupscopenumber_
                           (int *number, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_grouptagstable_
                           (int *table, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_grouptagstablei_
                           (int *table, int *group);
void CCTK_FCALL cctk_grouptypefromvari_
                           (int *type, const int *var);
void CCTK_FCALL cctk_grouptypei_
                           (int *type, const int *group);
void CCTK_FCALL cctk_grouptypenumber_
                           (int *number, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_impfromvari_
                           (int *nchars, int *var, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_maxdim_
                           (int *dim);
void CCTK_FCALL cctk_maxgfdim_
                           (int *dim);
void CCTK_FCALL cctk_maxtimelevels_
                           (int *num, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_maxtimelevelsgi_
                           (int *num, const int *group);
void CCTK_FCALL cctk_maxtimelevelsgn_
                           (int *num, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_maxtimelevelsvi_
                           (int *num, const int *var);
void CCTK_FCALL cctk_maxtimelevelsvn_
                           (int *num, ONE_FORTSTRING_ARG);
...
void CCTK_FCALL cctk_numvarsingroup_
                           (int *num, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_numvarsingroupi_
...
void CCTK_FCALL cctk_varindex_
                           (int *vindex, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_varname_
                           (int *nchars, int *var, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_vartypei_
                           (int *type, const int *var);
void CCTK_FCALL cctk_vartypename_
                           (int *nchars, int *var, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_vartypenumber_
                           (int *number, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_vartypesize_
                           (int *size, int *vtype);
...
void CCTK_FCALL cctk_numtimelevelsfromvar_
                           (int *num, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_numtimelevelsi_
                           (int *num, const int *var);
void CCTK_FCALL cctk_numtimelevels_
                           (int *num, ONE_FORTSTRING_ARG);
...
void CCTK_FCALL cctk_groupnamefromvari_ (int *nchars, int *var, ONE_FORTSTRING_ARG)
{
...
void CCTK_FCALL cctk_impfromvari_ (int *nchars, int *var, ONE_FORTSTRING_ARG)
{
...
void CCTK_FCALL cctk_fullname_ (int *nchars, int *var, ONE_FORTSTRING_ARG)
{
...
void CCTK_FCALL cctk_vartypename_ (int *nchars, int *var, ONE_FORTSTRING_ARG)
{
...
void CCTK_FCALL cctk_varname_ (int *nchars, int *var, ONE_FORTSTRING_ARG)
{
...
void CCTK_FCALL cctk_groupname_ (int *nchars, int *var, ONE_FORTSTRING_ARG)
{
ONE_FORTSTRING_PTR (groupnameptr)
  ONE_FORTSTRING_LEN (groupnamelen)
  char *groupname;
...
void CCTK_FCALL cctk_grouptagstable_ (int *table, ONE_FORTSTRING_ARG)
{
...
void CCTK_FCALL cctk_grouptagstablei_ (int *table, int *group)
{
...
void CCTK_FCALL cctk_numvarsingroupi_ (int *numvars, int *group)
{
...
void CCTK_FCALL cctk_vartypesize_ (int *size, int *vtype)
{
