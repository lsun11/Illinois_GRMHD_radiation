 /*@@
   ...
   @enddesc
   @version   $Id: Reduction.c 4204 2005-12-12 16:34:41Z yye00 $
 @@*/
...
void CCTK_FCALL cctk_localarrayreductionhandle_
     (int *handle, ONE_FORTSTRING_ARG);
void CCTK_FCALL cctk_reducelocalarrays_
     (int *fortran_return,
...
void CCTK_FCALL cctk_reducegridarrays_
     (int *fortranreturn,
      const cGH **GH,
      int *dest_proc,
...
void CCTK_FCALL cctk_reducearraysglobally_
     (int *fortranreturn,
      const cGH **GH,
      int *dest_proc,
      int *local_reduce_handle,
...
void CCTK_FCALL cctk_localarrayreductionhandle_(int *handle, ONE_FORTSTRING_ARG)
{
ONE_FORTSTRING_CREATE(reduction)
...
void CCTK_FCALL cctk_numlocalarrayreduceoperators_(int *fortranreturn);
void CCTK_FCALL cctk_numlocalarrayreduceoperators_(int *fortranreturn)
{
