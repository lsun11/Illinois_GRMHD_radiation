...
!----------------------------------------------------------------------------------
subroutine movingbox_update_center_part3(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_&
  ...
  &k_convfac,cctk_nghostzones,cctk_iteration,cctkGH, X0tmp_gfs,X1tmp_gfs,X2tmp_gfs,find_max_phi,max_phi,temp0,tempx,tempy,xc_prev,y&
  &c_prev,zc_prev, X0BSSN_AH,X0BSSN_aux_private,X0BSSN_aux_restrict2,X0BSSN_diag_restrict,X0BSSN_gupij,X0BSSN_matter,X0BSSN_refbd,X&
  ...
  &r,v02_radl,v02_radr,v02l,v02r,vvec,vx,vxl,vxr,vy,vyl,vyr,vz,vzl,vzr,w,zeta_rad,zeta_rad_nue,zeta_rad_nux, X0coordinates,X0radii,&
  &X0sf_radius,X1coordinates,X1sf_radius,X2coordinates,active_length,num_levels_length,positions_length,radii_length,sf_active_leng&
  &th,sf_coordinate_descriptors_length,sf_info_length,sf_maxreflevel_length,sf_minreflevel_length,sf_origin_length,sf_radius_length&
  &,sf_shape_descriptors_length,sf_valid_length,active,coarse_dx,coarse_dy,coarse_dz,num_levels,position_x,position_y,position_z,r,&
  &radius,sf_active,sf_area,sf_centroid_x,sf_centroid_y,sf_centroid_z,sf_delta_phi,sf_delta_theta,sf_max_radius,sf_max_x,sf_max_y,s&
  &f_max_z,sf_maxreflevel,sf_mean_radius,sf_min_radius,sf_min_x,sf_min_y,sf_min_z,sf_minreflevel,sf_nghostsphi,sf_nghoststheta,sf_n&
  &phi,sf_ntheta,sf_origin_phi,sf_origin_theta,sf_origin_x,sf_origin_y,sf_origin_z,sf_quadrupole_xx,sf_quadrupole_xy,sf_quadrupole_&
  &xz,sf_quadrupole_yy,sf_quadrupole_yz,sf_quadrupole_zz,sf_radius,sf_valid,x,y,z)
  implicit none
  INTEGER cctk_dim
  ...
  INTEGER X1tmp_gfs
  INTEGER X2tmp_gfs
  INTEGER*4 find_max_phi
  REAL*8 max_phi
  REAL*8 temp0(X0tmp_gfs,X1tmp_gfs,X2tmp_gfs)
  REAL*8 tempx(X0tmp_gfs,X1tmp_gfs,X2tmp_gfs)
  REAL*8 tempy(X0tmp_gfs,X1tmp_gfs,X2tmp_gfs)
  REAL*8 xc_prev
  REAL*8 yc_prev
  REAL*8 zc_prev
  INTEGER X0BSSN_AH
  ...
  REAL*8  CCTKH8(101)
  REAL*8  CCTKH9(101)
  REAL*8  initial_guess__coord_ellipsoid__x_center(101)
  REAL*8  initial_guess__coord_ellipsoid__x_radius(101)
  REAL*8  initial_guess__coord_ellipsoid__y_center(101)
  REAL*8  initial_guess__coord_ellipsoid__y_radius(101)
  REAL*8  initial_guess__coord_ellipsoid__z_center(101)
  REAL*8  initial_guess__coord_ellipsoid__z_radius(101)
  REAL*8  CCTKH10(101)
  REAL*8  CCTKH11(101)
  REAL*8  CCTKH12(101)
  REAL*8  CCTKH13(101)
  ...
  REAL*8  origin_y(101)
  REAL*8  origin_z(101)
  integer*8  CCTKH14(101)
  integer*8  CCTKH15(101)
  INTEGER*4 CCTKH16
  INTEGER*4 CCTKH17
  INTEGER*4 CCTKH18(101)
  INTEGER*4 CCTKH19
  COMMON /AHFINDERDIRECTrest/CCTKH0,CCTKH1,CCTKH2,CCTKH3,CCTKH4,CCTKH5,CCTKH6,CCTKH7,CCTKH8,CCTKH9,initial_guess__coord_ellipsoid__&
  &x_center,initial_guess__coord_ellipsoid__x_radius,initial_guess__coord_ellipsoid__y_center,initial_guess__coord_ellipsoid__y_rad&
  &ius,initial_guess__coord_ellipsoid__z_center,initial_guess__coord_ellipsoid__z_radius,CCTKH10,CCTKH11,CCTKH12,CCTKH13,origin_x,o&
  &rigin_y,origin_z,CCTKH14,CCTKH15,CCTKH16,CCTKH17,CCTKH18,CCTKH19
  INTEGER*4 CCTKH20
  INTEGER*4 CCTKH21
  INTEGER*4 CCTKH22
  INTEGER*4 CCTKH23
  ...
  INTEGER*4 CCTKH77
  INTEGER*4 CCTKH78
  COMMON /IOrest/CCTKH29,CCTKH43,CCTKH51,CCTKH53,CCTKH55,CCTKH57,CCTKH59,CCTKH61,CCTKH63,CCTKH65,CCTKH67,CCTKH26,CCTKH27,CCTKH30,CC&
  &TKH33,CCTKH34,CCTKH35,CCTKH38,CCTKH39,CCTKH44,CCTKH45,CCTKH47,CCTKH69,CCTKH71,CCTKH73,CCTKH75,CCTKH76,CCTKH79,CCTKH24,CCTKH25,CC&
  &TKH28,CCTKH31,CCTKH32,CCTKH36,CCTKH37,CCTKH40,CCTKH41,CCTKH42,out_every,CCTKH46,CCTKH48,CCTKH49,CCTKH50,CCTKH52,CCTKH54,CCTKH56,&
  &CCTKH58,CCTKH60,CCTKH62,CCTKH64,CCTKH66,CCTKH68,CCTKH70,CCTKH72,CCTKH74,CCTKH77,CCTKH78
  REAL*8  CCTKH82(42)
  integer*8  CCTKH81(42)
  INTEGER*4 CCTKH80(42)
  INTEGER*4 CCTKH83
  INTEGER*4 CCTKH84
  INTEGER*4 CCTKH85(42)
  INTEGER*4 CCTKH86(42)
  INTEGER*4 CCTKH87(42)
  INTEGER*4 CCTKH88
  INTEGER*4 CCTKH89(42)
  INTEGER*4 CCTKH90(42)
  INTEGER*4 CCTKH91(42)
  INTEGER*4 CCTKH92(42)
  INTEGER*4 CCTKH93
  COMMON /SPHERICALSURFACErest/CCTKH82,CCTKH81,CCTKH80,CCTKH83,CCTKH84,CCTKH85,CCTKH86,CCTKH87,CCTKH88,CCTKH89,CCTKH90,CCTKH91,CCTK&
  &H92,CCTKH93
...
!
  if (mod(cctk_iteration,out_every)==0 .and. cctk_iteration .gt. 0) then
     if (find_max_phi==1) then
        ...
        call CCTK_Reduce(ierr,cctkGH, -1, handle, 1, 107, num_max, 1, vindex)
        call CCTK_VarIndex(vindex,"movingbox_for_boosted_bh::tempx")
        call CCTK_Reduce(ierr,cctkGH, -1, handle, 1, 107, xc, 1, vindex)
        call CCTK_VarIndex(vindex,"movingbox_for_boosted_bh::tempy")
        call CCTK_Reduce(ierr,cctkGH, -1, handle, 1, 107, yc, 1, vindex)
