...
!----------------------------------------------------------------------------------
subroutine setup_movingbox_center(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_t&
  ...
  &ac,cctk_nghostzones,cctk_iteration,cctkGH, X0tmp_gfs,X1tmp_gfs,X2tmp_gfs,find_max_phi,max_phi,temp0,tempx,tempy,xc_prev,yc_prev,&
  &zc_prev, X0BSSN_AH,X0BSSN_aux_private,X0BSSN_aux_restrict2,X0BSSN_diag_restrict,X0BSSN_gupij,X0BSSN_matter,X0BSSN_refbd,X0BSSN_r&
  ...
  &adl,v02_radr,v02l,v02r,vvec,vx,vxl,vxr,vy,vyl,vyr,vz,vzl,vzr,w,zeta_rad,zeta_rad_nue,zeta_rad_nux, X0coordinates,X0radii,X0sf_ra&
  &dius,X1coordinates,X1sf_radius,X2coordinates,active_length,num_levels_length,positions_length,radii_length,sf_active_length,sf_c&
  &oordinate_descriptors_length,sf_info_length,sf_maxreflevel_length,sf_minreflevel_length,sf_origin_length,sf_radius_length,sf_sha&
  &pe_descriptors_length,sf_valid_length,active,coarse_dx,coarse_dy,coarse_dz,num_levels,position_x,position_y,position_z,r,radius,&
  ...
  &uadrupole_yy,sf_quadrupole_yz,sf_quadrupole_zz,sf_radius,sf_valid,x,y,z)
  implicit none
  INTEGER cctk_dim
