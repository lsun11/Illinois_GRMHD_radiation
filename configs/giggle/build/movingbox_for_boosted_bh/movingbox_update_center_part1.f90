...
!----------------------------------------------------------------------------------
subroutine movingbox_update_center_part1(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_&
...
!
  ...
  if (mod(cctk_iteration,out_every)==0 .and. cctk_iteration .gt. 0) then
     ...
     if (find_max_phi == 1) then
        ...
        call CCTK_Reduce (ierr,cctkGH, -1,handle, 1, 107,max_phi,1,index)
     end if
  end if
