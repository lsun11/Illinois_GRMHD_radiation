...
#pragma omp parallel for
    for (int k=0; k<regkext; ++k) {
	  ...
	  // following is based on: restrict_3d_cc_rf2.cc, a cell-centered grid
          //dst [DSTIND3(i, j, k)] =
          //  + f1*f1 * src [SRCIND3(2*i  , 2*j  , 2*k  )]
          //  + f2*f1 * src [SRCIND3(2*i  , 2*j+1, 2*k  )]
          //  + f1*f2 * src [SRCIND3(2*i  , 2*j  , 2*k+1)]
          //  + f2*f2 * src [SRCIND3(2*i  , 2*j+1, 2*k+1)];

	  //dst[DSTIND3(i, j, k)] = 0.0;
	  ...
	  /*
	    dst [DSTIND3(i, j, k)] =
	    f0*f0 * src [SRCIND3(2*i  , 2*j-1, 2*k-1)]
	    + f0*f1 * src [SRCIND3(2*i  , 2*j-1, 2*k  )]
	    + f0*f2 * src [SRCIND3(2*i  , 2*j-1, 2*k+1)]
	    + f0*f3 * src [SRCIND3(2*i  , 2*j-1, 2*k+2)]
	    + f1*f0 * src [SRCIND3(2*i  , 2*j  , 2*k-1)]
	    + f1*f1 * src [SRCIND3(2*i  , 2*j  , 2*k  )]
	    + f1*f2 * src [SRCIND3(2*i  , 2*j  , 2*k+1)]
	    + f1*f3 * src [SRCIND3(2*i  , 2*j  , 2*k+2)]
	    + f2*f0 * src [SRCIND3(2*i  , 2*j+1, 2*k-1)] 
	    + f2*f1 * src [SRCIND3(2*i  , 2*j+1, 2*k  )]
	    + f2*f2 * src [SRCIND3(2*i  , 2*j+1, 2*k+1)]
	    + f2*f3 * src [SRCIND3(2*i  , 2*j+1, 2*k+2)]
	    + f3*f0 * src [SRCIND3(2*i  , 2*j+2, 2*k-1)] 
	    + f3*f1 * src [SRCIND3(2*i  , 2*j+2, 2*k  )]
	    + f3*f2 * src [SRCIND3(2*i  , 2*j+2, 2*k+1)]
	    + f3*f3 * src [SRCIND3(2*i  , 2*j+2, 2*k+2)];
	  */
	  ...
	  */
	  ...
	  //if (i==5 && j==5 && k==0) {
	  //  printf("dst: %f\n",dst [DSTIND3(i, j, k)]);
	  //  printf("%f\n",src [SRCIND3(2*i  , 2*j-1, 2*k-1)]);
	  //  printf("%f\n",src [SRCIND3(2*i  , 2*j-1, 2*k)]);
	  //  printf("%f\n",src [SRCIND3(2*i  , 2*j-1, 2*k+1)]);
	  //  printf("%f\n",src [SRCIND3(2*i  , 2*j, 2*k-1)]);
	  //  printf("%f\n",src [SRCIND3(2*i  , 2*j, 2*k)]);
	  //  printf("%f\n",src [SRCIND3(2*i  , 2*j, 2*k+1)]);
	  //  printf("%f\n",src [SRCIND3(2*i  , 2*j+1, 2*k-1)]);
	  //  printf("%f\n",src [SRCIND3(2*i  , 2*j+1, 2*k)]);
	  //  printf("%f\n",src [SRCIND3(2*i  , 2*j+1, 2*k+1)]);
