...
extern "C"
void
CCTK_FCALL prolongate_3d_real8_eno_
...
extern "C"
void
CCTK_FCALL prolongate_3d_real8_weno_
  (const CCTK_REAL8* src,
   const int& srciext, const int& srcjext, const int& srckext,
   CCTK_REAL8* dst,
   const int& dstiext, const int& dstjext, const int& dstkext,
                     ...
                     int const order_space)
{
  ...
  case op_FAKE: {
    static Timer timer ("prolongate_FAKE");
    timer.start ();
    call_operator<T> (& prolongate_3d_FAKE,
		      static_cast <T const *> (src->storage()),
		      src->shape(),
		      static_cast <T *> (this->storage()),
		      this->shape(),
  ...
  case op_STAGGER101: {
    ...
    timer.start ();
    call_operator<T> (& prolongate_3d_stagger101,
		      static_cast <T const *> (src->storage()),
		      src->shape(),
		      static_cast <T *> (this->storage()),
		      this->shape(),
  ...
  case op_STAGGER110: {
    ...
    timer.start ();
    call_operator<T> (& prolongate_3d_stagger110,
		      static_cast <T const *> (src->storage()),
		      src->shape(),
		      static_cast <T *> (this->storage()),
		      this->shape(),
  ...
  case op_STAGGER111: {
    ...
    timer.start ();
    call_operator<T> (& prolongate_3d_stagger111,
		      static_cast <T const *> (src->storage()),
		      src->shape(),
		      static_cast <T *> (this->storage()),
		      this->shape(),
                   ...
                   int const /*order_space*/)
{
  ...
  case op_FAKE:
    restrict_3d_FAKE (static_cast <T const *> (src->storage()),
		      src->shape(),
		      static_cast <T *> (this->storage()),
		      this->shape(),
		      src->extent(),
