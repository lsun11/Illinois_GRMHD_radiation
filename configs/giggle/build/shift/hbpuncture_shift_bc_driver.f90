...
!----------------------------------------------------------------------------------
subroutine hbpuncture_shift_bc_driver(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_del&
  ...
  if(CCTK_ITERATION.gt.0 .and. levelnumber.eq.1.D0) then
     ...
     if(Symmetry == AXISYM) then
        ...
        !(needed since BndCartoon2D can only(?) be called inside a (cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_fr
