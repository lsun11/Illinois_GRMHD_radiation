!-------------------------------------------------------
! Driver for hyperbolic shift BCs (Spatial_Gauge == 1)
!-------------------------------------------------------
subroutine hyperbolic_shift_bc_driver(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_del&
  ...
  &rad_nux, X0coordinates,X1coordinates,X2coordinates,coarse_dx,coarse_dy,coarse_dz,r,x,y,z)
  implicit none
  INTEGER cctk_dim
  ...
  !  call interp_center(cctkGH,cctk_nghostzones,phi_p,cctk_lsh,cctk_gsh,dX,dY,dZ,Xlocal1d,Ylocal1d,Zlocal1d,Xglobal,Yglobal,Zglobal,
  !FIXME: Interpolation in Carpet can only be performed in a GLOBAL context in the schedule.ccl file.
  !  To fix this, youll need to call the interpolation routine from a GLOBAL context (this function is called
...
!  call subtract_radial2(ext,X,Y,Z,PhysicalRadius,shiftx,shifty,shiftz,psi6c,hyper_psi6_init,hyper_Rscale);
  if(Symmetry == AXISYM) then
     ...
     !(needed since BndCartoon2D can only(?) be called inside a (cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,
