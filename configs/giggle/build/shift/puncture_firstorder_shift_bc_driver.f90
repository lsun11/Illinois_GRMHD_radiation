!----------------------------------------------------------------------
! Driver for first-order Gamma-driving shift BCs (Spatial_Gauge == 6)
!----------------------------------------------------------------------
subroutine puncture_firstorder_shift_bc_driver(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox&
  ...
  interface
     subroutine hbpuncture_shift_bc(ext,fake_ext,dT,dx,dy,dz, &
          ...
          have_global_bdry_min,have_global_bdry_max,use_trans_fish_phys_new,fisheye_enable)
...
end subroutine puncture_firstorder_shift_bc_driver
