...
!--------------------------------------------------------
subroutine disk_powerlaw_compute_rho_b_atm(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cct&
  ...
  &ctk_convfac,cctk_nghostzones,cctk_iteration,cctkGH, X0disk_powerlaw_last_data,ah1_radii_last_disk_powerlaw,ah2_radii_last_disk_p&
  &owerlaw,ah3_radii_last_disk_powerlaw,surf1_radii_last_disk_powerlaw,surf2_radii_last_disk_powerlaw,surf3_radii_last_disk_powerla&
  &w,surf4_radii_last_disk_powerlaw,t_last_disk_powerlaw,xh1_last_disk_powerlaw,xh2_last_disk_powerlaw,xh3_last_disk_powerlaw,yh1_l&
  &ast_disk_powerlaw,yh2_last_disk_powerlaw,yh3_last_disk_powerlaw,zh1_last_disk_powerlaw,zh2_last_disk_powerlaw,zh3_last_disk_powe&
  &rlaw, X0BSSN_AH,X0BSSN_aux_private,X0BSSN_aux_restrict2,X0BSSN_diag_restrict,X0BSSN_gupij,X0BSSN_matter,X0BSSN_refbd,X0BSSN_rhs,&
  ...
  if (handle .gt. 0) then
     ...
     call CCTK_Warn(1,31,"disk_powerlaw_compute_rho_b_atm.F90","disk_powerlaw","TestReduce: Invalid reduction operator")
  end if
