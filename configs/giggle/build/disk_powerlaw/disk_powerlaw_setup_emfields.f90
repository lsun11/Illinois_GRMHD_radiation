...
!--------------------------------------------------------
subroutine disk_powerlaw_setup_emfields(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_d&
  ...
  &_convfac,cctk_nghostzones,cctk_iteration,cctkGH, X0disk_powerlaw_last_data,ah1_radii_last_disk_powerlaw,ah2_radii_last_disk_powe&
  &rlaw,ah3_radii_last_disk_powerlaw,surf1_radii_last_disk_powerlaw,surf2_radii_last_disk_powerlaw,surf3_radii_last_disk_powerlaw,s&
  &urf4_radii_last_disk_powerlaw,t_last_disk_powerlaw,xh1_last_disk_powerlaw,xh2_last_disk_powerlaw,xh3_last_disk_powerlaw,yh1_last&
  &_disk_powerlaw,yh2_last_disk_powerlaw,yh3_last_disk_powerlaw,zh1_last_disk_powerlaw,zh2_last_disk_powerlaw,zh3_last_disk_powerla&
  &w, X0BSSN_AH,X0BSSN_aux_private,X0BSSN_aux_restrict2,X0BSSN_diag_restrict,X0BSSN_gupij,X0BSSN_matter,X0BSSN_refbd,X0BSSN_rhs,X0B&
  ...
  if(em_field_type == 0 .or. em_field_type == 2) then
     ...
     !the value 1.0 is arbitrary, it isnt used
     call setup_poloidal_emfields(ext,1.0,disk_powerlaw_P_max,p_c,betam1,X,Y,Z,PhysicalRadius, &
     ...
     call initial_toroidal_emfields(ext,disk_powerlaw_P_max,p_c,betam1,X,Y,Z, &
          phi,lapm1, shiftx,shifty,shiftz, &
          gxx,gxy,gxz,gyy,gyz,gzz, &
          rho_b,P,Bx,By,Bz, &
          st_x,st_y,st_z,mhd_st_x,mhd_st_y,mhd_st_z, &
...
end subroutine disk_powerlaw_setup_emfields
