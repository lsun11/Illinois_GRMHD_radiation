...
!------------------------------------
subroutine disk_powerlaw_diagnostics(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delt&
  ...
  &nvfac,cctk_nghostzones,cctk_iteration,cctkGH, X0disk_powerlaw_last_data,ah1_radii_last_disk_powerlaw,ah2_radii_last_disk_powerla&
  &w,ah3_radii_last_disk_powerlaw,surf1_radii_last_disk_powerlaw,surf2_radii_last_disk_powerlaw,surf3_radii_last_disk_powerlaw,surf&
  &4_radii_last_disk_powerlaw,t_last_disk_powerlaw,xh1_last_disk_powerlaw,xh2_last_disk_powerlaw,xh3_last_disk_powerlaw,yh1_last_di&
  &sk_powerlaw,yh2_last_disk_powerlaw,yh3_last_disk_powerlaw,zh1_last_disk_powerlaw,zh2_last_disk_powerlaw,zh3_last_disk_powerlaw, &
  ...
  &adr,v02l,v02r,vvec,vx,vxl,vxr,vy,vyl,vyr,vz,vzl,vzr,w,zeta_rad,zeta_rad_nue,zeta_rad_nux, X0coordinates,X1coordinates,X2coordina&
  &tes,coarse_dx,coarse_dy,coarse_dz,r,x,y,z)
  implicit none
  INTEGER cctk_dim
...
!     export_data(7) = em_J_between_VolInt*SymmFactor
     ...
     if(CCTK_MyProc(CCTKGH)==0) call output_data_to_file(filename,num_cols,data_headers,export_data,header_flag)
     !--------------------------------------------------------------------------------
     if((MOD(cctk_iteration,16*out_every)==0) .and. (1==0)) then
        !call surface_dens_1d(cctkGH,CCTK_TIME,binary_orb_freq,surfxnum,surfphinum,surfznum,surfzmax,surfxmin,surfxmax,Symmetry,CCTK
