...
!--------------------------------------------------------
subroutine disk_powerlaw_recompute_primitives(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,&
  ...
  &l,cctk_convfac,cctk_nghostzones,cctk_iteration,cctkGH, X0disk_powerlaw_last_data,ah1_radii_last_disk_powerlaw,ah2_radii_last_dis&
  &k_powerlaw,ah3_radii_last_disk_powerlaw,surf1_radii_last_disk_powerlaw,surf2_radii_last_disk_powerlaw,surf3_radii_last_disk_powe&
  &rlaw,surf4_radii_last_disk_powerlaw,t_last_disk_powerlaw,xh1_last_disk_powerlaw,xh2_last_disk_powerlaw,xh3_last_disk_powerlaw,yh&
  &1_last_disk_powerlaw,yh2_last_disk_powerlaw,yh3_last_disk_powerlaw,zh1_last_disk_powerlaw,zh2_last_disk_powerlaw,zh3_last_disk_p&
  &owerlaw, X0BSSN_AH,X0BSSN_aux_private,X0BSSN_aux_restrict2,X0BSSN_diag_restrict,X0BSSN_gupij,X0BSSN_matter,X0BSSN_refbd,X0BSSN_r&
  ...
  if (enable_primitives_disk == 0) then
     ...
     call CCTK_ReduceLocalScalar(ierr,cctkGH,-1,handle,NFont_L,NFont,107)
!!$        !TODO: remove temp1 (unused) parameter.
...
!!$
!!$        call CCTK_ReductionHandle(handle,sum)
!!$        call CCTK_ReduceLocalScalar(ierr,cctkGH,-1,handle,NFont,NFont_L,107)
