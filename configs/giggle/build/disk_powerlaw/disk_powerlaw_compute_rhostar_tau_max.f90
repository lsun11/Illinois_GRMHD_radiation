...
!--------------------------------------------------------
subroutine disk_powerlaw_compute_rhostar_tau_max(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bb&
  ...
  &evel,cctk_convfac,cctk_nghostzones,cctk_iteration,cctkGH, X0disk_powerlaw_last_data,ah1_radii_last_disk_powerlaw,ah2_radii_last_&
  &disk_powerlaw,ah3_radii_last_disk_powerlaw,surf1_radii_last_disk_powerlaw,surf2_radii_last_disk_powerlaw,surf3_radii_last_disk_p&
  &owerlaw,surf4_radii_last_disk_powerlaw,t_last_disk_powerlaw,xh1_last_disk_powerlaw,xh2_last_disk_powerlaw,xh3_last_disk_powerlaw&
  &,yh1_last_disk_powerlaw,yh2_last_disk_powerlaw,yh3_last_disk_powerlaw,zh1_last_disk_powerlaw,zh2_last_disk_powerlaw,zh3_last_dis&
  &k_powerlaw, X0BSSN_AH,X0BSSN_aux_private,X0BSSN_aux_restrict2,X0BSSN_diag_restrict,X0BSSN_gupij,X0BSSN_matter,X0BSSN_refbd,X0BSS&
  ...
  integer*8 cctkGH
  INTEGER X0disk_powerlaw_last_data
  REAL*8 ah1_radii_last_disk_powerlaw(X0disk_powerlaw_last_data)
  REAL*8 ah2_radii_last_disk_powerlaw(X0disk_powerlaw_last_data)
  REAL*8 ah3_radii_last_disk_powerlaw(X0disk_powerlaw_last_data)
  REAL*8 surf1_radii_last_disk_powerlaw(X0disk_powerlaw_last_data)
  REAL*8 surf2_radii_last_disk_powerlaw(X0disk_powerlaw_last_data)
  REAL*8 surf3_radii_last_disk_powerlaw(X0disk_powerlaw_last_data)
  REAL*8 surf4_radii_last_disk_powerlaw(X0disk_powerlaw_last_data)
  REAL*8 t_last_disk_powerlaw
  REAL*8 xh1_last_disk_powerlaw
  REAL*8 xh2_last_disk_powerlaw
  REAL*8 xh3_last_disk_powerlaw
  REAL*8 yh1_last_disk_powerlaw
  REAL*8 yh2_last_disk_powerlaw
  REAL*8 yh3_last_disk_powerlaw
  REAL*8 zh1_last_disk_powerlaw
  REAL*8 zh2_last_disk_powerlaw
  REAL*8 zh3_last_disk_powerlaw
  INTEGER X0BSSN_AH
  ...
  REAL*8  bbh_rhosurf4
  REAL*8  betam1
  REAL*8  disk_powerlaw_P_max
  REAL*8  disk_powerlaw_rho_star_max
  REAL*8  disk_powerlaw_tau_max
  REAL*8  ell_inner
  REAL*8  p_c
  REAL*8  q
  REAL*8  rho_cut
  REAL*8  rho_cut_o_rho_max
  REAL*8  sam_disk
  REAL*8  surfxmax
  REAL*8  surfxmin
  REAL*8  surfzmax
  INTEGER*4 arithrhosurf
  INTEGER*4 em_field_type
  INTEGER*4 metric_type
  INTEGER*4 nsurfrho
  INTEGER*4 ntot_disk_powerlaw
  INTEGER*4 surfphinum
  INTEGER*4 surfxnum
  INTEGER*4 surfznum
  COMMON /disk_powerlawpriv/A_const,BigMass,RoM_inner,bbh_r_const1,bbh_r_const2,bbh_r_const3,bbh_r_const4,bbh_rhosurf1,bbh_rhosurf2&
  &,bbh_rhosurf3,bbh_rhosurf4,betam1,disk_powerlaw_P_max,disk_powerlaw_rho_star_max,disk_powerlaw_tau_max,ell_inner,p_c,q,rho_cut,r&
  &ho_cut_o_rho_max,sam_disk,surfxmax,surfxmin,surfzmax,arithrhosurf,em_field_type,metric_type,nsurfrho,ntot_disk_powerlaw,surfphin&
  &um,surfxnum,surfznum
  REAL*8  CCTKH5
  REAL*8  CCTKH6
  REAL*8  CCTKH7
  REAL*8  CCTKH8
  ...
  INTEGER*4 CCTKH17
  INTEGER*4 CCTKH19
  COMMON /BSSNrest/CCTKH5,CCTKH6,CCTKH7,CCTKH8,binary_orb_freq,CCTKH10,CCTKH11,CCTKH12,CCTKH13,CCTKH14,CCTKH15,rah1_initial,rah2_in&
  &itial,CCTKH16,xbh1_initial,xbh2_initial,CCTKH18,CCTKH0,CCTKH1,CCTKH2,CCTKH3,CCTKH4,CCTKH9,enable_lower_order_at_boundaries,CCTKH&
  &17,CCTKH19
  REAL*8  CCTKH20
  REAL*8  CCTKH21
  REAL*8  CCTKH27
  ...
  INTEGER*4 CCTKH26
  INTEGER*4 CCTKH28
  COMMON /DIAGNOSTICS_MHDrest/CCTKH20,CCTKH21,CCTKH27,inner_lum_rad_ratio,lum_outer_rad,CCTKH29,CCTKH30,CCTKH31,CCTKH32,CCTKH33,CCT&
  &KH34,rhosurf_rmax,rhosurf_rmin,CCTKH35,N_rad_ray,CCTKH22,CCTKH23,CCTKH24,CCTKH25,CCTKH26,CCTKH28
  REAL*8  CCTKH36
  REAL*8  CCTKH39
  REAL*8  ddrbddr
  REAL*8  CCTKH40
  ...
  COMMON /DIAGNOSTICS_VACUUMrest/CCTKH36,CCTKH39,ddrbddr,CCTKH40,drbdr,CCTKH44,rbr,rsurf2,surf_radius,CCTKH37,N_phi,N_theta,CCTKH38&
  &,arithsurf,CCTKH41,CCTKH42,CCTKH43,nsurf,CCTKH45,CCTKH46,CCTKH47,CCTKH48,scaledsurf,sym_factor
  REAL*8  CCTKH49
  REAL*8  CCTKH50
  REAL*8  CCTKH51
  REAL*8  CCTKH52
  ...
  INTEGER*4 CCTKH59
  INTEGER*4 CCTKH60
  COMMON /GRIDrest/CCTKH49,CCTKH50,CCTKH51,CCTKH52,CCTKH62,CCTKH63,CCTKH64,CCTKH65,CCTKH66,CCTKH67,CCTKH68,CCTKH69,bitant_plane,dom&
  &ain,CCTKH53,CCTKH54,CCTKH61,CCTKH55,CCTKH56,CCTKH57,CCTKH58,CCTKH59,CCTKH60
  REAL*8  CCTKH70
  REAL*8  CCTKH71
  REAL*8  phi_GW
  REAL*8  radius_GW
  ...
  INTEGER*4 CCTKH126
  INTEGER*4 CCTKH127
  COMMON /IOrest/CCTKH78,CCTKH92,CCTKH100,CCTKH102,CCTKH104,CCTKH106,CCTKH108,CCTKH110,CCTKH112,CCTKH114,CCTKH116,CCTKH75,CCTKH76,C&
  &CTKH79,CCTKH82,CCTKH83,CCTKH84,CCTKH87,CCTKH88,CCTKH93,CCTKH94,CCTKH96,CCTKH118,CCTKH120,CCTKH122,CCTKH124,CCTKH125,CCTKH128,CCT&
  &KH73,CCTKH74,CCTKH77,CCTKH80,CCTKH81,CCTKH85,CCTKH86,CCTKH89,CCTKH90,CCTKH91,out_every,CCTKH95,CCTKH97,CCTKH98,CCTKH99,CCTKH101,&
  &CCTKH103,CCTKH105,CCTKH107,CCTKH109,CCTKH111,CCTKH113,CCTKH115,CCTKH117,CCTKH119,CCTKH121,CCTKH123,CCTKH126,CCTKH127
  REAL*8  CCTKH131
  REAL*8  CCTKH132
  REAL*8  K_poly
  REAL*8  CCTKH135
  ...
  INTEGER*4 CCTKH188
  INTEGER*4 CCTKH189
  COMMON /MHD_EVOLVErest/CCTKH131,CCTKH132,K_poly,CCTKH135,CCTKH137,P_fact,CCTKH138,CCTKH139,Sym_Bz,CCTKH141,CCTKH145,CCTKH146,CCTK&
  &H149,CCTKH154,CCTKH155,CCTKH157,gamma_th,CCTKH161,CCTKH163,CCTKH164,CCTKH165,CCTKH166,CCTKH168,pfloor,CCTKH171,CCTKH172,CCTKH173&
  &,CCTKH174,CCTKH175,CCTKH177,CCTKH178,CCTKH182,CCTKH183,rho_b_atm,rho_b_max,rho_fact,CCTKH186,sdots_o_rhot,CCTKH187,tau_atm,tau_f&
  &act,CCTKH129,CCTKH130,CCTKH133,CCTKH134,CCTKH136,CCTKH140,CCTKH142,CCTKH143,CCTKH144,CCTKH147,constrained_transport_scheme,CCTKH&
  &148,em_evolve_enable,CCTKH150,enable_HARM_energyvariable,CCTKH151,CCTKH152,enable_primitives_disk,enable_shocktest_primitive_mod&
  &e,CCTKH153,eps_flag,CCTKH156,force_font_fix_fail,CCTKH158,CCTKH159,CCTKH160,CCTKH162,CCTKH167,neos,CCTKH169,CCTKH170,primitives_&
  &solver,CCTKH176,CCTKH179,CCTKH180,CCTKH181,CCTKH184,CCTKH185,tau_stildefix_enable,use_HARM_primitives,CCTKH188,CCTKH189
  ...
  if (handle .gt. 0) then
     ...
     call CCTK_Warn(1,38,"disk_powerlaw_compute_rhostar_tau_max.F90","disk_powerlaw","TestReduce: Invalid reduction operator")
  end if
  disk_powerlaw_tau_max = reduction_value
  tau_atm = tau_fact * disk_powerlaw_tau_max
  ...
  if (handle .gt. 0) then
     ...
     call CCTK_Warn(1,51,"disk_powerlaw_compute_rhostar_tau_max.F90","disk_powerlaw","TestReduce: Invalid reduction operator")
  end if
  disk_powerlaw_rho_star_max = reduction_value
end subroutine disk_powerlaw_compute_rhostar_tau_max
