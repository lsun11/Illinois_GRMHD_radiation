/*@@
  ...
  @version   $Id: Handles.c,v 1.4 2004/06/21 09:22:22 tradke Exp $
  @enddesc
@@*/
...
static const char *const rcsid = "$Header: /cactusdevcvs/CactusBase/SymBase/src/Handles.c,v 1.4 2004/06/21 09:22:22 tradke Exp $";
