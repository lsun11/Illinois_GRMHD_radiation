      subroutine WaveToyMoL_InitSymBound (cctk_dim,cctk_gsh,cctk_lsh,cct
     ...
     &,CCTKH12,CCTKH13
      ...
      if (ierr.ne.0) call CCTK_Warn(0,18,"initsymbound.F77","WaveToyMoL"
     &, "internal error")
      call SetCartSymVN (ierr, cctkGH, sym, "WaveToyMoL::psi")
      if (ierr.ne.0) call CCTK_Warn(0,20,"initsymbound.F77","WaveToyMoL"
     &, "internal error")
      call SetCartSymVN (ierr, cctkGH, sym, "WaveToyMoL::error")
      if (ierr.ne.0) call CCTK_Warn(0,22,"initsymbound.F77","WaveToyMoL"
     &, "internal error")
      end
