...
!-------------------------------------------------------------------
subroutine cylindrical2d_initialdata_global(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cc&
  ...
  if (handle .gt. 0) then
     ...
     call CCTK_Warn(1,45,"initialdata_global.F90","cylindrical2d","TestReduce: Invalid reduction operator")
  end if
  ...
  if (handle .gt. 0) then
     ...
     call CCTK_Warn(1,59,"initialdata_global.F90","cylindrical2d","TestReduce: Invalid reduction operator")
  end if
  ...
  if (handle .gt. 0) then
     ...
     call CCTK_Warn(1,73,"initialdata_global.F90","cylindrical2d","TestReduce: Invalid reduction operator")
  end if
  ...
  if (handle .gt. 0) then
     ...
     call CCTK_Warn(1,86,"initialdata_global.F90","cylindrical2d","TestReduce: Invalid reduction operator")
  end if
  rhos_max = reduction_value
  write(*,*) "GLOBAL INITIALDATA FINISHED!"
end subroutine cylindrical2d_initialdata_global
