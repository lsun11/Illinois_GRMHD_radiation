...
!-----------------------------------------------------------------------------
subroutine bhns_diagnostics_global0(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta&
  ...
  if(MOD(cctk_iteration,out_every)==0) then
     ...
     call CCTK_Reduce (ierr,cctkGH, -1,handle, 1, 107,bhns_max_b2,1,vindex)
     call CCTK_ReductionHandle(handle,"maximum")
     call CCTK_VarIndex (vindex, "mhd_evolve::rho_b")
     call CCTK_Reduce (ierr,cctkGH, -1,handle, 1, 107,bhns_max_rho_b,1,vindex)
  end if
