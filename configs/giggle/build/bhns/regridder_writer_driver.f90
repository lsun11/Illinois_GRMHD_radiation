subroutine bhns_regridder_writer_driver(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_d&
...
!  if(CCTK_ITERATION==bhns_regrid_output_enable_iter .and. CCTK_MyProc(CCTKGH)==0) then
  write(*,*) "Start bhns_regridder_writer_driver", CCTK_ITERATION, bhns_regrid_output_enable_iter
