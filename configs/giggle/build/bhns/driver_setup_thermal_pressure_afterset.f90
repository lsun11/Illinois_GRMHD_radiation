subroutine BHNS_setup_thermal_pressure_afterset(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbo&
...
end subroutine BHNS_setup_thermal_pressure_afterset
