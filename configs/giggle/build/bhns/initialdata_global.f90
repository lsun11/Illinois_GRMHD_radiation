subroutine bhns_initialdata_global(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_&
  ...
  if (handle .gt. 0) then
     ...
     call CCTK_Warn(1,36,"initialdata_global.F90","bhns","TestReduce: Invalid reduction operator")
  end if
  rho_max = reduction_value
  write(6,*)  "SSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS"
  if(rho_max==0.D0) stop
  if(rho_b_atm.gt.0.D0) rho_b_atm = rho_fact*rho_max
  write(*,*) "RHO_MAX, rho_b_atm: ",rho_max,rho_b_atm
