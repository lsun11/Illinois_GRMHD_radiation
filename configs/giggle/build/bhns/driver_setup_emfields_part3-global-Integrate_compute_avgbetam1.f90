...
!--------------------------------------------------
subroutine Integrate_vol_integrand_bhns_emfields_compute_avgbetam1(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_fr&
  ...
  if(CCTK_ITERATION .eq. ITERATION_TO_INSERT_MAGNETIC_FIELDS .or. CCTK_ITERATION .eq. 0) then
     ...
     call CCTK_Reduce(ierr,cctkGH, -1, handle, 1, 107, VolIntegral, 1, vindex)
     ...
     write(*,*) "BHNS: [Integral P over proper volume]",bhns_pV,d3x
