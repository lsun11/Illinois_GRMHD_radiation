...
!--------------------------------------------------------
subroutine magnetar_setup_Aijs_Gammais_bhns(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cc&
  ...
  !we use all the _bcks and _fwds as temporary storage, as well as Pl.
...
subroutine check_for_nans_bhns(ext,lapse,shiftx,shifty,shiftz,gxx,gxy,gxz,gyy,gyz,gzz,Axx,Axy,Axz,Ayy,Ayz,Azz,rhob,ux,uy,uz)
  ...
  integer, dimension(3)                    :: ext
  INTEGER :: i,j,k
  real*8, dimension(ext(1),ext(2),ext(3))  :: gxx,gxy,gxz,gyy,gyz,gzz,Axx,Axy,Axz,Ayy,Ayz,Azz,lapse,shiftx,shifty,shiftz,rhob,ux,uy&
  &,uz
  do k=1,ext(3)
     do j=1,ext(2)
        do i=1,ext(1)
