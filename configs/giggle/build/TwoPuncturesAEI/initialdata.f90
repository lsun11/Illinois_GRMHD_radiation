subroutine TwoPuncturesAEI_initialdata(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_de&
...
!  call CCTK_SyncGroup(dummy,cctkGH,BSSN::BSSN_vars)
  ...
  if(fisheye_enable .eq. 1) then
    write(*,*) 'Fisheye not supported in TwoPuncturesAEI! Bye...'
    stop
  end if
  ...
  call CartSymGN(dummy,cctkGH,'BSSN::BSSN_vars')
  !  call CCTK_SyncGroup(dummy,cctkGH,BSSN::BSSN_vars) 
end subroutine TwoPuncturesAEI_initialdata
