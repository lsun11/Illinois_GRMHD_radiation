...
!------------------------------------
subroutine TwoPuncturesAEI_diagnostics(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_de&
  ...
  &convfac,cctk_nghostzones,cctk_iteration,cctkGH, X0puncture_u,X1puncture_u,X2puncture_u,mm,mp,puncture_u, X0BSSN_AH,X0BSSN_aux_pr&
  ...
  &xl,vxr,vy,vyl,vyr,vz,vzl,vzr,w,zeta_rad,zeta_rad_nue,zeta_rad_nux, X0coordinates,X1coordinates,X2coordinates,coarse_dx,coarse_dy&
  &,coarse_dz,conformal_state,r,x,y,z)
  implicit none
  INTEGER cctk_dim
  ...
  integer*8 cctkGH
  INTEGER X0puncture_u
  INTEGER X1puncture_u
  INTEGER X2puncture_u
  REAL*8 mm
  REAL*8 mp
  REAL*8 puncture_u(X0puncture_u,X1puncture_u,X2puncture_u)
  INTEGER X0BSSN_AH
  ...
  REAL*8  Newton_tol
  REAL*8  TP_Extend_Radius
  REAL*8  TP_Tiny
  REAL*8  TP_epsilon
  REAL*8  adm_tol
  REAL*8  center_offset(3)
  REAL*8  initial_lapse_psi_exponent
  REAL*8  moncrief_radius_GW(100)
  REAL*8  par_P_minus(3)
  REAL*8  par_P_plus(3)
  REAL*8  par_S_minus(3)
  REAL*8  par_S_plus(3)
  REAL*8  par_b
  REAL*8  par_m_minus
  REAL*8  par_m_plus
  REAL*8  target_M_minus
  REAL*8  target_M_plus
  integer*8  grid_setup_method
  integer*8  initial_lapse
  INTEGER*4 Newton_maxit
  INTEGER*4 do_initial_debug_output
  INTEGER*4 do_residuum_debug_output
  INTEGER*4 give_bare_mass
  INTEGER*4 keep_u_around
  INTEGER*4 moncrief_gw_num_radii
  INTEGER*4 multiply_old_lapse
  INTEGER*4 npoints_A
  INTEGER*4 npoints_B
  INTEGER*4 npoints_phi
  INTEGER*4 rescale_sources
  INTEGER*4 schedule_in_ADMBase_InitialData
  INTEGER*4 solve_momentum_constraint
  INTEGER*4 swap_xz
  INTEGER*4 use_external_initial_guess
  INTEGER*4 use_sources
  INTEGER*4 verbose
  COMMON /TwoPuncturesAEIpriv/Newton_tol,TP_Extend_Radius,TP_Tiny,TP_epsilon,adm_tol,center_offset,initial_lapse_psi_exponent,moncr&
  &ief_radius_GW,par_P_minus,par_P_plus,par_S_minus,par_S_plus,par_b,par_m_minus,par_m_plus,target_M_minus,target_M_plus,grid_setup&
  &_method,initial_lapse,Newton_maxit,do_initial_debug_output,do_residuum_debug_output,give_bare_mass,keep_u_around,moncrief_gw_num&
  &_radii,multiply_old_lapse,npoints_A,npoints_B,npoints_phi,rescale_sources,schedule_in_ADMBase_InitialData,solve_momentum_constra&
  &int,swap_xz,use_external_initial_guess,use_sources,verbose
  REAL*8  CCTKH0
  REAL*8  CCTKH5
  REAL*8  ddrbddr
  REAL*8  CCTKH6
