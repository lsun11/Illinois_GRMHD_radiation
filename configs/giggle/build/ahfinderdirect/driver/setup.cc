...
// $Header: /numrelcvs/AEIThorns/AHFinderDirect/src/driver/setup.cc,v 1.65.2.19 2007/12/01 01:09:19 bela Exp $
//
...
cgi.g_dd_11_varindex = Cactus_gridfn_varindex("bssn::gxx");
cgi.g_dd_12_varindex = Cactus_gridfn_varindex("bssn::gxy");
cgi.g_dd_13_varindex = Cactus_gridfn_varindex("bssn::gxz");
cgi.g_dd_22_varindex = Cactus_gridfn_varindex("bssn::gyy");
cgi.g_dd_23_varindex = Cactus_gridfn_varindex("bssn::gyz");
cgi.g_dd_33_varindex = Cactus_gridfn_varindex("bssn::gzz");
cgi.K_dd_11_varindex = Cactus_gridfn_varindex("bssn::kxx");
cgi.K_dd_12_varindex = Cactus_gridfn_varindex("bssn::kxy");
cgi.K_dd_13_varindex = Cactus_gridfn_varindex("bssn::kxz");
cgi.K_dd_22_varindex = Cactus_gridfn_varindex("bssn::kyy");
cgi.K_dd_23_varindex = Cactus_gridfn_varindex("bssn::kyz");
cgi.K_dd_33_varindex = Cactus_gridfn_varindex("bssn::kzz");
cgi.psi_varindex     = Cactus_gridfn_varindex("bssn::psi");
