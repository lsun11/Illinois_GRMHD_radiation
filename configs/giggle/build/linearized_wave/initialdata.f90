...
!
!-----------------------------------------------------------------------------
subroutine lin_wave_initialdata(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_tim&
...
!  
  ...
  call linwave_Convert(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_delta_time,cctk_ti&
  &me,cctk_delta_space,cctk_origin_space,cctk_levfac,cctk_levoff,cctk_levoffdenom,cctk_timefac,cctk_convlevel,cctk_convfac,cctk_ngh&
  &ostzones,cctk_iteration,cctkGH, X0linearized_wave_analytic,X1linearized_wave_analytic,X2linearized_wave_analytic,Kxx_analy,Kxy_a&
  &naly,Kxz_analy,Kyy_analy,Kyz_analy,Kzz_analy,gxx_analy,gxy_analy,gxz_analy,gyy_analy,gyz_analy,gzz_analy, X0BSSN_AH,X0BSSN_aux_p&
  ...
  &vxl,vxr,vy,vyl,vyr,vz,vzl,vzr,w,zeta_rad,zeta_rad_nue,zeta_rad_nux, X0coordinates,X0radii,X1coordinates,X2coordinates,active_len&
  &gth,num_levels_length,positions_length,radii_length,active,coarse_dx,coarse_dy,coarse_dz,num_levels,position_x,position_y,positi&
  &on_z,r,radius,x,y,z)
  Psi = exp(phi)
