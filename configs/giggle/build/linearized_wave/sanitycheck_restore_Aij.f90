...
!
!-----------------------------------------------------------------------------
subroutine lw_sanitycheck_restore_Aij(cctk_dim,cctk_gsh,cctk_lsh,cctk_lbnd,cctk_ubnd,cctk_lssh,cctk_from,cctk_to,cctk_bbox,cctk_del&
  ...
  &onvfac,cctk_nghostzones,cctk_iteration,cctkGH, X0linearized_wave_analytic,X1linearized_wave_analytic,X2linearized_wave_analytic,&
  &Kxx_analy,Kxy_analy,Kxz_analy,Kyy_analy,Kyz_analy,Kzz_analy,gxx_analy,gxy_analy,gxz_analy,gyy_analy,gyz_analy,gzz_analy, X0BSSN_&
  ...
  &l,v02r,vvec,vx,vxl,vxr,vy,vyl,vyr,vz,vzl,vzr,w,zeta_rad,zeta_rad_nue,zeta_rad_nux, X0coordinates,X0radii,X1coordinates,X2coordin&
  &ates,active_length,num_levels_length,positions_length,radii_length,active,coarse_dx,coarse_dy,coarse_dz,num_levels,position_x,po&
  &sition_y,position_z,r,radius,x,y,z)
  implicit none
  INTEGER cctk_dim
...
end subroutine lw_sanitycheck_restore_Aij
