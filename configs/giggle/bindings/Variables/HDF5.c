/*@@
   ...
   @desc
            Creates the CCTK variables for thorn HDF5
   @enddesc
 @@*/


#define THORN_IS_HDF5 1
...
static int CCTKi_BindingsFortranWrapperHDF5(void *_GH, void *fpointer);
...
static int CCTKi_BindingsFortranWrapperHDF5(void *_GH, void *fpointer)
{
  ...
  function = (void (*) (HDF5_C2F_PROTO)) fpointer;
  function (PASS_HDF5_C2F (GH));
...
int CactusBindingsVariables_HDF5_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("HDF5", CCTKi_BindingsFortranWrapperHDF5);
