/*@@
   ...
   @desc
            Creates the CCTK variables for thorn LocalInterp
   @enddesc
 @@*/


#define THORN_IS_LocalInterp 1
...
static int CCTKi_BindingsFortranWrapperLocalInterp(void *_GH, void *fpointer);
...
#endif
  void (*function)(LOCALINTERP_C2F_PROTO);
  DECLARE_LOCALINTERP_C2F
  INITIALISE_LOCALINTERP_C2F
  (void) (_cctk_zero + 0);
#ifndef CCTK_DEBUG
  (void) (_cctk_dummy_var + 0);
#endif

  function = (void (*) (LOCALINTERP_C2F_PROTO)) fpointer;
  function (PASS_LOCALINTERP_C2F (GH));
...
int CactusBindingsVariables_LocalInterp_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("LocalInterp", CCTKi_BindingsFortranWrapperLocalInterp);
