/*@@
   ...
   @desc
            Creates the CCTK variables for thorn IDWaveMoL
   @enddesc
 @@*/


#define THORN_IS_IDWaveMoL 1
...
static int CCTKi_BindingsFortranWrapperIDWaveMoL(void *_GH, void *fpointer);
...
#endif
  void (*function)(IDWAVEMOL_C2F_PROTO);
  DECLARE_IDWAVEMOL_C2F
  INITIALISE_IDWAVEMOL_C2F
  (void) (_cctk_zero + 0);
#ifndef CCTK_DEBUG
  (void) (_cctk_dummy_var + 0);
#endif

  function = (void (*) (IDWAVEMOL_C2F_PROTO)) fpointer;
  function (PASS_IDWAVEMOL_C2F (GH));
...
int CactusBindingsVariables_IDWaveMoL_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("IDWaveMoL", CCTKi_BindingsFortranWrapperIDWaveMoL);
