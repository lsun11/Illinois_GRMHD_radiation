/*@@
   ...
   @desc
            Creates the CCTK variables for thorn jobsuicide
   @enddesc
 @@*/


#define THORN_IS_jobsuicide 1
...
static int CCTKi_BindingsFortranWrapperjobsuicide(void *_GH, void *fpointer);
...
#endif
  void (*function)(JOBSUICIDE_C2F_PROTO);
  DECLARE_JOBSUICIDE_C2F
  INITIALISE_JOBSUICIDE_C2F
  (void) (_cctk_zero + 0);
#ifndef CCTK_DEBUG
  (void) (_cctk_dummy_var + 0);
#endif

  function = (void (*) (JOBSUICIDE_C2F_PROTO)) fpointer;
  function (PASS_JOBSUICIDE_C2F (GH));
...
int CactusBindingsVariables_jobsuicide_Initialise(void)
{
  ...
  if (CCTKi_CreateGroup ("TIMESCALAR", "JOBSUICIDE", "JOBSUICIDE",
                         "SCALAR", "REAL", "PRIVATE",
                         0, 1,
                         "NONE", "CONSTANT",
                         "", "",
  ...
  CCTKi_RegisterFortranWrapper("jobsuicide", CCTKi_BindingsFortranWrapperjobsuicide);
