/*@@
   ...
   @desc
            Creates the CCTK variables for thorn bbhlorene
   @enddesc
 @@*/


#define THORN_IS_bbhlorene 1
...
static int CCTKi_BindingsFortranWrapperbbhlorene(void *_GH, void *fpointer);
...
#endif
  void (*function)(BBHLORENE_C2F_PROTO);
  DECLARE_BBHLORENE_C2F
  INITIALISE_BBHLORENE_C2F
  (void) (_cctk_zero + 0);
#ifndef CCTK_DEBUG
  (void) (_cctk_dummy_var + 0);
#endif

  function = (void (*) (BBHLORENE_C2F_PROTO)) fpointer;
  function (PASS_BBHLORENE_C2F (GH));
...
int CactusBindingsVariables_bbhlorene_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("bbhlorene", CCTKi_BindingsFortranWrapperbbhlorene);
