/*@@
   ...
   @desc
            Creates the CCTK variables for thorn CarpetRegrid
   @enddesc
 @@*/


#define THORN_IS_CarpetRegrid 1
...
static int CCTKi_BindingsFortranWrapperCarpetRegrid(void *_GH, void *fpointer);
...
#endif
  void (*function)(CARPETREGRID_C2F_PROTO);
  DECLARE_CARPETREGRID_C2F
  INITIALISE_CARPETREGRID_C2F
  (void) (_cctk_zero + 0);
#ifndef CCTK_DEBUG
  (void) (_cctk_dummy_var + 0);
#endif

  function = (void (*) (CARPETREGRID_C2F_PROTO)) fpointer;
  function (PASS_CARPETREGRID_C2F (GH));
...
int CactusBindingsVariables_CarpetRegrid_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("CarpetRegrid", CCTKi_BindingsFortranWrapperCarpetRegrid);
