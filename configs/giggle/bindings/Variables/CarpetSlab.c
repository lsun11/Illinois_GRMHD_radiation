/*@@
   ...
   @desc
            Creates the CCTK variables for thorn CarpetSlab
   @enddesc
 @@*/


#define THORN_IS_CarpetSlab 1
...
static int CCTKi_BindingsFortranWrapperCarpetSlab(void *_GH, void *fpointer);
...
#endif
  void (*function)(CARPETSLAB_C2F_PROTO);
  DECLARE_CARPETSLAB_C2F
  INITIALISE_CARPETSLAB_C2F
  (void) (_cctk_zero + 0);
#ifndef CCTK_DEBUG
  (void) (_cctk_dummy_var + 0);
#endif

  function = (void (*) (CARPETSLAB_C2F_PROTO)) fpointer;
  function (PASS_CARPETSLAB_C2F (GH));
...
int CactusBindingsVariables_CarpetSlab_Initialise(void)
{
  ...
  CCTKi_RegisterFortranWrapper("CarpetSlab", CCTKi_BindingsFortranWrapperCarpetSlab);
