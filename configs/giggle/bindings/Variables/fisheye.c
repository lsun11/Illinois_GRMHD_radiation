/*@@
   ...
   @desc
            Creates the CCTK variables for thorn fisheye
   @enddesc
 @@*/


#define THORN_IS_fisheye 1
...
static int CCTKi_BindingsFortranWrapperfisheye(void *_GH, void *fpointer);
...
#endif
  void (*function)(FISHEYE_C2F_PROTO);
  DECLARE_FISHEYE_C2F
  INITIALISE_FISHEYE_C2F
  (void) (_cctk_zero + 0);
#ifndef CCTK_DEBUG
  (void) (_cctk_dummy_var + 0);
#endif

  function = (void (*) (FISHEYE_C2F_PROTO)) fpointer;
  function (PASS_FISHEYE_C2F (GH));
...
int CactusBindingsVariables_fisheye_Initialise(void)
{
  ...
  if (CCTKi_CreateGroup ("FISHEYE_VARS", "FISHEYE", "FISHEYE",
                         "GF", "REAL", "PROTECTED",
                         3, 1,
                         "NONE", "DEFAULT",
                         "", "",
                         ...
                         "RadiusDerivative2") == 1)
  {
    warn_mixeddim_gfs = "fisheye_vars";
    warn_mixeddim = 3;
  }
  ...
  CCTKi_RegisterFortranWrapper("fisheye", CCTKi_BindingsFortranWrapperfisheye);
