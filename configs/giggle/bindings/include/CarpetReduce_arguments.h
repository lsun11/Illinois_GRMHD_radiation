...
INTEGER X1weight&&\
INTEGER X2weight&&\
CCTK_REAL weight(X0weight,X1weight,X2weight)&&\


#define CARPETREDUCE_PRIVATE_FARGUMENTS \
X0weight,X1weight,X2weight,weight

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_CARPETREDUCE_PRIVATE_CARGUMENTS \
CCTK_REAL * CCTK_RESTRICT weight = (cctki_dummy_int = &weight - &weight, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "CARPETREDUCE", "weight"));
...
PASS_GROUPSIZE(weight, 0),\
PASS_GROUPSIZE(weight, 1),\
PASS_GROUPSIZE(weight, 2),\
...
#ifdef FCODE
#define CARPETREDUCE_FARGUMENTS _CCTK_FARGUMENTS, CARPETREDUCE_PRIVATE_FARGUMENTS, CARPETREDUCE_PROTECTED_FARGUMENTS

#define DECLARE_CARPETREDUCE_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_CARPETREDUCE_PRIVATE_FARGUMENTS DECLARE_CARPETREDUCE_PROTECTED_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_CARPETREDUCE_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_CARPETREDUCE_PRIVATE_CARGUMENTS DECLARE_CARPETREDUCE_PROTECTED_CARGUMENTS

#define CARPETREDUCE_C2F_PROTO _CCTK_C2F_PROTO, CARPETREDUCE_PRIVATE_C2F_PROTO, CARPETREDUCE_PROTECTED_C2F_PROTO

#define PASS_CARPETREDUCE_C2F(GH) _PASS_CCTK_C2F(GH), PASS_CARPETREDUCE_PRIVATE_C2F(GH), PASS_CARPETREDUCE_PROTECTED_C2F(GH)

#define DECLARE_CARPETREDUCE_C2F _DECLARE_CCTK_C2F DECLARE_CARPETREDUCE_PRIVATE_C2F DECLARE_CARPETREDUCE_PROTECTED_C2F

#define INITIALISE_CARPETREDUCE_C2F _INITIALISE_CCTK_C2F INITIALISE_CARPETREDUCE_PRIVATE_C2F INITIALISE_CARPETREDUCE_PROTECTED_C2F
