/*@@
   @header  shock_mhd_CParameters.h
   @author  Automatically generated by CreateParameterBindings.pl
   @desc
            Declares parameters of thorn shock_mhd
   @enddesc
 @@*/


#ifndef _SHOCK_MHD_PARAMETERS_H_
#define _SHOCK_MHD_PARAMETERS_H_ 1

#include "ParameterCGlobal.h"
#include "ParameterCPrivateSHOCK_MHD.h"
...
#define DECLARE_CCTK_PARAMETERS \
  ...
  DECLARE_PRIVATE_SHOCK_MHD_STRUCT_PARAMS \
...
#endif  /* _SHOCK_MHD_PARAMETERS_H_ */
