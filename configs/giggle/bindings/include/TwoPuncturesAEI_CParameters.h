/*@@
   @header  TwoPuncturesAEI_CParameters.h
   @author  Automatically generated by CreateParameterBindings.pl
   @desc
            Declares parameters of thorn TwoPuncturesAEI
   @enddesc
 @@*/


#ifndef _TWOPUNCTURESAEI_PARAMETERS_H_
#define _TWOPUNCTURESAEI_PARAMETERS_H_ 1

#include "ParameterCGlobal.h"
#include "ParameterCPrivateTWOPUNCTURESAEI.h"
...
#define DECLARE_CCTK_PARAMETERS \
  ...
  DECLARE_PRIVATE_TWOPUNCTURESAEI_STRUCT_PARAMS \
...
#endif  /* _TWOPUNCTURESAEI_PARAMETERS_H_ */
