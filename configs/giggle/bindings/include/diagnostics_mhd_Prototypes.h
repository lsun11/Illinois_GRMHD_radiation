/*@@
   @header  diagnostics_mhd_Prototypes.h
...
#ifndef _DIAGNOSTICS_MHD_PROTOTYPES_H_
#define _DIAGNOSTICS_MHD_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_DIAGNOSTICS_MHD_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
