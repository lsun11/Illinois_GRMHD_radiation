/*@@
   @header  CarpetSlab_Prototypes.h
...
#ifndef _CARPETSLAB_PROTOTYPES_H_
#define _CARPETSLAB_PROTOTYPES_H_  1
...
CCTK_INT CarpetSlab_FreeMapping(const CCTK_INT mapping_handle);
...
CCTK_INT CarpetSlab_Get(const CCTK_POINTER_TO_CONST cctkGH ,
 const CCTK_INT mapping_handle ,
 const CCTK_INT proc ,
 const CCTK_INT vindex ,
 const CCTK_INT timelevel ,
...
CCTK_INT Hyperslab_GetList(const CCTK_POINTER_TO_CONST cctkGH ,
 ...
 const CCTK_POINTER* hdata ,
 CCTK_INT* retvals);
CCTK_INT CarpetSlab_GetList(const CCTK_POINTER_TO_CONST cctkGH ,
 const CCTK_INT mapping_handle ,
 const CCTK_INT num_arrays ,
 const CCTK_INT* procs ,
 const CCTK_INT* vindices ,
...
CCTK_INT Hyperslab_GlobalMappingByIndex(const CCTK_POINTER_TO_CONST cctkGH ,
 ...
 CCTK_INT* hsize);
CCTK_INT CarpetSlab_GlobalMappingByIndex(const CCTK_POINTER_TO_CONST cctkGH ,
 const CCTK_INT vindex ,
 const CCTK_INT hdim ,
 const CCTK_INT* direction ,
 const CCTK_INT* origin ,
...
CCTK_INT CarpetSlab_LocalMappingByIndex(const CCTK_POINTER_TO_CONST cctkGH ,
 const CCTK_INT vindex ,
 const CCTK_INT hdim ,
 const CCTK_INT* direction ,
 const CCTK_INT* origin ,
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_CARPETSLAB_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
