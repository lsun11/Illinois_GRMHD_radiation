/*@@
   @header  bssn_arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn bssn
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_BSSN_PRIVATE_FARGUMENTS \
CCTK_REAL adm_mass&&\
CCTK_REAL ddrbddr_adm&&\
CCTK_REAL drbdr_adm&&\
CCTK_REAL radius_adm&&\
CCTK_REAL rbr_adm&&\


#define BSSN_PRIVATE_FARGUMENTS \
adm_mass,ddrbddr_adm,drbdr_adm,radius_adm,rbr_adm

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_BSSN_PRIVATE_CARGUMENTS \
CCTK_REAL * CCTK_RESTRICT adm_mass = (cctki_dummy_int = &adm_mass - &adm_mass, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BSSN", "adm_mass")); \
CCTK_REAL * CCTK_RESTRICT ddrbddr_adm = (cctki_dummy_int = &ddrbddr_adm - &ddrbddr_adm, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BSSN", "ddrbddr_adm")); \
CCTK_REAL * CCTK_RESTRICT drbdr_adm = (cctki_dummy_int = &drbdr_adm - &drbdr_adm, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BSSN", "drbdr_adm")); \
CCTK_REAL * CCTK_RESTRICT radius_adm = (cctki_dummy_int = &radius_adm - &radius_adm, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BSSN", "radius_adm")); \
CCTK_REAL * CCTK_RESTRICT rbr_adm = (cctki_dummy_int = &rbr_adm - &rbr_adm, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BSSN", "rbr_adm"));

#define DECLARE_BSSN_PRIVATE_C2F \
static int CCTKARGNUM_adm_mass = -1; \
static int CCTKGROUPNUM_BSSN_adm_mass = -1; \
static int CCTKARGNUM_ddrbddr_adm = -1; \
static int CCTKARGNUM_drbdr_adm = -1; \
static int CCTKARGNUM_radius_adm = -1; \
static int CCTKARGNUM_rbr_adm = -1;

#define INITIALISE_BSSN_PRIVATE_C2F \
if(CCTKARGNUM_adm_mass == -1) CCTKARGNUM_adm_mass = CCTK_VarIndex("bssn::adm_mass"); \
if(CCTKGROUPNUM_BSSN_adm_mass == -1) CCTKGROUPNUM_BSSN_adm_mass = CCTK_GroupIndex("bssn::BSSN_adm_mass"); \
if(CCTKARGNUM_ddrbddr_adm == -1) CCTKARGNUM_ddrbddr_adm = CCTK_VarIndex("bssn::ddrbddr_adm"); \
if(CCTKARGNUM_drbdr_adm == -1) CCTKARGNUM_drbdr_adm = CCTK_VarIndex("bssn::drbdr_adm"); \
if(CCTKARGNUM_radius_adm == -1) CCTKARGNUM_radius_adm = CCTK_VarIndex("bssn::radius_adm"); \
if(CCTKARGNUM_rbr_adm == -1) CCTKARGNUM_rbr_adm = CCTK_VarIndex("bssn::rbr_adm");

#define BSSN_PRIVATE_C2F_PROTO \
CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *

#define PASS_BSSN_PRIVATE_C2F(GH) \
(CCTK_REAL *)(PASS_REFERENCE(adm_mass, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(ddrbddr_adm, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(drbdr_adm, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(radius_adm, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(rbr_adm, 0))

#endif /* CCODE */

#ifdef FCODE
#define DECLARE_BSSN_PROTECTED_FARGUMENTS \
INTEGER X0BSSN_AH&&\
...
#define BSSN_PROTECTED_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_BSSN_PROTECTED_CARGUMENTS \
...
#define DECLARE_BSSN_PROTECTED_C2F \
...
#define INITIALISE_BSSN_PROTECTED_C2F \
...
#define BSSN_PROTECTED_C2F_PROTO \
...
#define PASS_BSSN_PROTECTED_C2F(GH) \
...
#ifdef FCODE
#define DECLARE_BSSN_PUBLIC_FARGUMENTS \
...
#define DECLARE_BSSN_PUBLIC_C2F \
...
#define INITIALISE_BSSN_PUBLIC_C2F \
...
#ifdef FCODE
#define BSSN_FARGUMENTS _CCTK_FARGUMENTS, BSSN_PRIVATE_FARGUMENTS, BSSN_PROTECTED_FARGUMENTS, BSSN_PUBLIC_FARGUMENTS

#define DECLARE_BSSN_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_BSSN_PRIVATE_FARGUMENTS DECLARE_BSSN_PROTECTED_FARGUMENTS DECLARE_BSSN_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_BSSN_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_BSSN_PRIVATE_CARGUMENTS DECLARE_BSSN_PROTECTED_CARGUMENTS DECLARE_BSSN_PUBLIC_CARGUMENTS

#define BSSN_C2F_PROTO _CCTK_C2F_PROTO, BSSN_PRIVATE_C2F_PROTO, BSSN_PROTECTED_C2F_PROTO, BSSN_PUBLIC_C2F_PROTO

#define PASS_BSSN_C2F(GH) _PASS_CCTK_C2F(GH), PASS_BSSN_PRIVATE_C2F(GH), PASS_BSSN_PROTECTED_C2F(GH), PASS_BSSN_PUBLIC_C2F(GH)

#define DECLARE_BSSN_C2F _DECLARE_CCTK_C2F DECLARE_BSSN_PRIVATE_C2F DECLARE_BSSN_PROTECTED_C2F DECLARE_BSSN_PUBLIC_C2F

#define INITIALISE_BSSN_C2F _INITIALISE_CCTK_C2F INITIALISE_BSSN_PRIVATE_C2F INITIALISE_BSSN_PROTECTED_C2F INITIALISE_BSSN_PUBLIC_C2F

#define BSSN_CARGUMENTS cGH *cctkGH
