...
CCTK_REAL * CCTK_RESTRICT courant_dt = (cctki_dummy_int = &courant_dt - &courant_dt, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "TIME", "courant_dt"));
...
CCTK_REAL * CCTK_RESTRICT courant_min_time = (cctki_dummy_int = &courant_min_time - &courant_min_time, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "TIME", "courant_min_time")); \
CCTK_REAL * CCTK_RESTRICT courant_wave_speed = (cctki_dummy_int = &courant_wave_speed - &courant_wave_speed, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "TIME", "courant_wave_speed"));
