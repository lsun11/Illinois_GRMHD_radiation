...
#ifdef FCODE
#define IOUTIL_FARGUMENTS _CCTK_FARGUMENTS, IOUTIL_PROTECTED_FARGUMENTS

#define DECLARE_IOUTIL_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_IOUTIL_PROTECTED_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_IOUTIL_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_IOUTIL_PROTECTED_CARGUMENTS

#define IOUTIL_C2F_PROTO _CCTK_C2F_PROTO, IOUTIL_PROTECTED_C2F_PROTO

#define PASS_IOUTIL_C2F(GH) _PASS_CCTK_C2F(GH), PASS_IOUTIL_PROTECTED_C2F(GH)

#define DECLARE_IOUTIL_C2F _DECLARE_CCTK_C2F DECLARE_IOUTIL_PROTECTED_C2F

#define INITIALISE_IOUTIL_C2F _INITIALISE_CCTK_C2F INITIALISE_IOUTIL_PROTECTED_C2F
