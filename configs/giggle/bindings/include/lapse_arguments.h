/*@@
   @header  lapse_arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn lapse
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_LAPSE_PRIVATE_FARGUMENTS \
INTEGER X0lapse_vars_temp&&\
INTEGER X1lapse_vars_temp&&\
INTEGER X2lapse_vars_temp&&\
CCTK_REAL trK_init(X0lapse_vars_temp,X1lapse_vars_temp,X2lapse_vars_temp)&&\


#define LAPSE_PRIVATE_FARGUMENTS \
X0lapse_vars_temp,X1lapse_vars_temp,X2lapse_vars_temp,trK_init

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_LAPSE_PRIVATE_CARGUMENTS \
CCTK_REAL * CCTK_RESTRICT trK_init = (cctki_dummy_int = &trK_init - &trK_init, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "LAPSE", "trK_init"));

#define DECLARE_LAPSE_PRIVATE_C2F \
static int CCTKARGNUM_trK_init = -1; \
static int CCTKGROUPNUM_lapse_vars_temp = -1;

#define INITIALISE_LAPSE_PRIVATE_C2F \
if(CCTKARGNUM_trK_init == -1) CCTKARGNUM_trK_init = CCTK_VarIndex("lapse::trK_init"); \
if(CCTKGROUPNUM_lapse_vars_temp == -1) CCTKGROUPNUM_lapse_vars_temp = CCTK_GroupIndex("lapse::lapse_vars_temp");

#define LAPSE_PRIVATE_C2F_PROTO \
const int *,const int *,const int *,CCTK_REAL *

#define PASS_LAPSE_PRIVATE_C2F(GH) \
PASS_GROUPSIZE(lapse_vars_temp, 0),\
PASS_GROUPSIZE(lapse_vars_temp, 1),\
PASS_GROUPSIZE(lapse_vars_temp, 2),\
(CCTK_REAL *)(PASS_REFERENCE(trK_init, 0))

#endif /* CCODE */

#ifdef FCODE
#define DECLARE_LAPSE_PROTECTED_FARGUMENTS \
INTEGER X0BSSN_AH&&\
...
#define LAPSE_PROTECTED_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_LAPSE_PROTECTED_CARGUMENTS \
...
#define DECLARE_LAPSE_PROTECTED_C2F \
...
#define INITIALISE_LAPSE_PROTECTED_C2F \
...
#define LAPSE_PROTECTED_C2F_PROTO \
...
#define PASS_LAPSE_PROTECTED_C2F(GH) \
...
#ifdef FCODE
#define DECLARE_LAPSE_PUBLIC_FARGUMENTS \
...
#define DECLARE_LAPSE_PUBLIC_C2F \
...
#define INITIALISE_LAPSE_PUBLIC_C2F \
...
#ifdef FCODE
#define LAPSE_FARGUMENTS _CCTK_FARGUMENTS, LAPSE_PRIVATE_FARGUMENTS, LAPSE_PROTECTED_FARGUMENTS, LAPSE_PUBLIC_FARGUMENTS

#define DECLARE_LAPSE_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_LAPSE_PRIVATE_FARGUMENTS DECLARE_LAPSE_PROTECTED_FARGUMENTS DECLARE_LAPSE_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_LAPSE_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_LAPSE_PRIVATE_CARGUMENTS DECLARE_LAPSE_PROTECTED_CARGUMENTS DECLARE_LAPSE_PUBLIC_CARGUMENTS

#define LAPSE_C2F_PROTO _CCTK_C2F_PROTO, LAPSE_PRIVATE_C2F_PROTO, LAPSE_PROTECTED_C2F_PROTO, LAPSE_PUBLIC_C2F_PROTO

#define PASS_LAPSE_C2F(GH) _PASS_CCTK_C2F(GH), PASS_LAPSE_PRIVATE_C2F(GH), PASS_LAPSE_PROTECTED_C2F(GH), PASS_LAPSE_PUBLIC_C2F(GH)

#define DECLARE_LAPSE_C2F _DECLARE_CCTK_C2F DECLARE_LAPSE_PRIVATE_C2F DECLARE_LAPSE_PROTECTED_C2F DECLARE_LAPSE_PUBLIC_C2F

#define INITIALISE_LAPSE_C2F _INITIALISE_CCTK_C2F INITIALISE_LAPSE_PRIVATE_C2F INITIALISE_LAPSE_PROTECTED_C2F INITIALISE_LAPSE_PUBLIC_C2F

#define LAPSE_CARGUMENTS cGH *cctkGH
