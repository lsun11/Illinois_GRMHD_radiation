/*@@
   @header  movingbox_arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn movingbox
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_MOVINGBOX_PRIVATE_FARGUMENTS \
INTEGER X0diag_movingbox_gf&&\
INTEGER X1diag_movingbox_gf&&\
INTEGER X2diag_movingbox_gf&&\
CCTK_REAL box_denom(X0diag_movingbox_gf,X1diag_movingbox_gf,X2diag_movingbox_gf)&&\
CCTK_REAL box_x(X0diag_movingbox_gf,X1diag_movingbox_gf,X2diag_movingbox_gf)&&\
CCTK_REAL box_y(X0diag_movingbox_gf,X1diag_movingbox_gf,X2diag_movingbox_gf)&&\
CCTK_REAL box_z(X0diag_movingbox_gf,X1diag_movingbox_gf,X2diag_movingbox_gf)&&\


#define MOVINGBOX_PRIVATE_FARGUMENTS \
X0diag_movingbox_gf,X1diag_movingbox_gf,X2diag_movingbox_gf,box_denom,box_x,box_y,box_z

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_MOVINGBOX_PRIVATE_CARGUMENTS \
CCTK_REAL * CCTK_RESTRICT box_denom = (cctki_dummy_int = &box_denom - &box_denom, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MOVINGBOX", "box_denom")); \
CCTK_REAL * CCTK_RESTRICT box_x = (cctki_dummy_int = &box_x - &box_x, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MOVINGBOX", "box_x")); \
CCTK_REAL * CCTK_RESTRICT box_y = (cctki_dummy_int = &box_y - &box_y, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MOVINGBOX", "box_y")); \
CCTK_REAL * CCTK_RESTRICT box_z = (cctki_dummy_int = &box_z - &box_z, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MOVINGBOX", "box_z"));

#define DECLARE_MOVINGBOX_PRIVATE_C2F \
static int CCTKARGNUM_box_denom = -1; \
static int CCTKGROUPNUM_diag_movingbox_gf = -1; \
static int CCTKARGNUM_box_x = -1; \
static int CCTKARGNUM_box_y = -1; \
static int CCTKARGNUM_box_z = -1;

#define INITIALISE_MOVINGBOX_PRIVATE_C2F \
if(CCTKARGNUM_box_denom == -1) CCTKARGNUM_box_denom = CCTK_VarIndex("movingbox::box_denom"); \
if(CCTKGROUPNUM_diag_movingbox_gf == -1) CCTKGROUPNUM_diag_movingbox_gf = CCTK_GroupIndex("movingbox::diag_movingbox_gf"); \
if(CCTKARGNUM_box_x == -1) CCTKARGNUM_box_x = CCTK_VarIndex("movingbox::box_x"); \
if(CCTKARGNUM_box_y == -1) CCTKARGNUM_box_y = CCTK_VarIndex("movingbox::box_y"); \
if(CCTKARGNUM_box_z == -1) CCTKARGNUM_box_z = CCTK_VarIndex("movingbox::box_z");

#define MOVINGBOX_PRIVATE_C2F_PROTO \
const int *,const int *,const int *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *

#define PASS_MOVINGBOX_PRIVATE_C2F(GH) \
PASS_GROUPSIZE(diag_movingbox_gf, 0),\
PASS_GROUPSIZE(diag_movingbox_gf, 1),\
PASS_GROUPSIZE(diag_movingbox_gf, 2),\
(CCTK_REAL *)(PASS_REFERENCE(box_denom, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(box_x, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(box_y, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(box_z, 0))

#endif /* CCODE */

#ifdef FCODE
#define DECLARE_MOVINGBOX_PROTECTED_FARGUMENTS \
INTEGER X0BSSN_AH&&\
...
#define MOVINGBOX_PROTECTED_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_MOVINGBOX_PROTECTED_CARGUMENTS \
...
#define DECLARE_MOVINGBOX_PROTECTED_C2F \
...
#define INITIALISE_MOVINGBOX_PROTECTED_C2F \
...
#define MOVINGBOX_PROTECTED_C2F_PROTO \
...
#define PASS_MOVINGBOX_PROTECTED_C2F(GH) \
...
#ifdef FCODE
#define DECLARE_MOVINGBOX_PUBLIC_FARGUMENTS \
...
#define MOVINGBOX_PUBLIC_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_MOVINGBOX_PUBLIC_CARGUMENTS \
...
#define DECLARE_MOVINGBOX_PUBLIC_C2F \
...
#define INITIALISE_MOVINGBOX_PUBLIC_C2F \
...
#define MOVINGBOX_PUBLIC_C2F_PROTO \
...
#define PASS_MOVINGBOX_PUBLIC_C2F(GH) \
...
#ifdef FCODE
#define MOVINGBOX_FARGUMENTS _CCTK_FARGUMENTS, MOVINGBOX_PRIVATE_FARGUMENTS, MOVINGBOX_PROTECTED_FARGUMENTS, MOVINGBOX_PUBLIC_FARGUMENTS

#define DECLARE_MOVINGBOX_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_MOVINGBOX_PRIVATE_FARGUMENTS DECLARE_MOVINGBOX_PROTECTED_FARGUMENTS DECLARE_MOVINGBOX_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_MOVINGBOX_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_MOVINGBOX_PRIVATE_CARGUMENTS DECLARE_MOVINGBOX_PROTECTED_CARGUMENTS DECLARE_MOVINGBOX_PUBLIC_CARGUMENTS

#define MOVINGBOX_C2F_PROTO _CCTK_C2F_PROTO, MOVINGBOX_PRIVATE_C2F_PROTO, MOVINGBOX_PROTECTED_C2F_PROTO, MOVINGBOX_PUBLIC_C2F_PROTO

#define PASS_MOVINGBOX_C2F(GH) _PASS_CCTK_C2F(GH), PASS_MOVINGBOX_PRIVATE_C2F(GH), PASS_MOVINGBOX_PROTECTED_C2F(GH), PASS_MOVINGBOX_PUBLIC_C2F(GH)

#define DECLARE_MOVINGBOX_C2F _DECLARE_CCTK_C2F DECLARE_MOVINGBOX_PRIVATE_C2F DECLARE_MOVINGBOX_PROTECTED_C2F DECLARE_MOVINGBOX_PUBLIC_C2F

#define INITIALISE_MOVINGBOX_C2F _INITIALISE_CCTK_C2F INITIALISE_MOVINGBOX_PRIVATE_C2F INITIALISE_MOVINGBOX_PROTECTED_C2F INITIALISE_MOVINGBOX_PUBLIC_C2F

#define MOVINGBOX_CARGUMENTS cGH *cctkGH
