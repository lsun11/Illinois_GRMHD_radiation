/*@@
   @header  magnetar_arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn magnetar
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_MAGNETAR_PRIVATE_FARGUMENTS \
CCTK_REAL RADEQUAT&&\
CCTK_REAL magnetar_max_b2&&\


#define MAGNETAR_PRIVATE_FARGUMENTS \
RADEQUAT,magnetar_max_b2

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_MAGNETAR_PRIVATE_CARGUMENTS \
CCTK_REAL * CCTK_RESTRICT RADEQUAT = (cctki_dummy_int = &RADEQUAT - &RADEQUAT, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MAGNETAR", "RADEQUAT")); \
CCTK_REAL * CCTK_RESTRICT magnetar_max_b2 = (cctki_dummy_int = &magnetar_max_b2 - &magnetar_max_b2, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MAGNETAR", "magnetar_max_b2"));

#define DECLARE_MAGNETAR_PRIVATE_C2F \
static int CCTKARGNUM_RADEQUAT = -1; \
static int CCTKGROUPNUM_scalar2 = -1; \
static int CCTKARGNUM_magnetar_max_b2 = -1;

#define INITIALISE_MAGNETAR_PRIVATE_C2F \
if(CCTKARGNUM_RADEQUAT == -1) CCTKARGNUM_RADEQUAT = CCTK_VarIndex("magnetar::RADEQUAT"); \
if(CCTKGROUPNUM_scalar2 == -1) CCTKGROUPNUM_scalar2 = CCTK_GroupIndex("magnetar::scalar2"); \
if(CCTKARGNUM_magnetar_max_b2 == -1) CCTKARGNUM_magnetar_max_b2 = CCTK_VarIndex("magnetar::magnetar_max_b2");

#define MAGNETAR_PRIVATE_C2F_PROTO \
CCTK_REAL *,CCTK_REAL *

#define PASS_MAGNETAR_PRIVATE_C2F(GH) \
(CCTK_REAL *)(PASS_REFERENCE(RADEQUAT, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(magnetar_max_b2, 0))

#endif /* CCODE */

#ifdef FCODE
#define DECLARE_MAGNETAR_PROTECTED_FARGUMENTS \
INTEGER X0BSSN_AH&&\
...
#define MAGNETAR_PROTECTED_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_MAGNETAR_PROTECTED_CARGUMENTS \
...
#define DECLARE_MAGNETAR_PROTECTED_C2F \
...
#define INITIALISE_MAGNETAR_PROTECTED_C2F \
...
#define MAGNETAR_PROTECTED_C2F_PROTO \
...
#define PASS_MAGNETAR_PROTECTED_C2F(GH) \
...
#ifdef FCODE
#define DECLARE_MAGNETAR_PUBLIC_FARGUMENTS \
...
#define MAGNETAR_PUBLIC_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_MAGNETAR_PUBLIC_CARGUMENTS \
...
#define DECLARE_MAGNETAR_PUBLIC_C2F \
...
#define INITIALISE_MAGNETAR_PUBLIC_C2F \
...
#define MAGNETAR_PUBLIC_C2F_PROTO \
...
#define PASS_MAGNETAR_PUBLIC_C2F(GH) \
...
#ifdef FCODE
#define MAGNETAR_FARGUMENTS _CCTK_FARGUMENTS, MAGNETAR_PRIVATE_FARGUMENTS, MAGNETAR_PROTECTED_FARGUMENTS, MAGNETAR_PUBLIC_FARGUMENTS

#define DECLARE_MAGNETAR_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_MAGNETAR_PRIVATE_FARGUMENTS DECLARE_MAGNETAR_PROTECTED_FARGUMENTS DECLARE_MAGNETAR_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_MAGNETAR_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_MAGNETAR_PRIVATE_CARGUMENTS DECLARE_MAGNETAR_PROTECTED_CARGUMENTS DECLARE_MAGNETAR_PUBLIC_CARGUMENTS

#define MAGNETAR_C2F_PROTO _CCTK_C2F_PROTO, MAGNETAR_PRIVATE_C2F_PROTO, MAGNETAR_PROTECTED_C2F_PROTO, MAGNETAR_PUBLIC_C2F_PROTO

#define PASS_MAGNETAR_C2F(GH) _PASS_CCTK_C2F(GH), PASS_MAGNETAR_PRIVATE_C2F(GH), PASS_MAGNETAR_PROTECTED_C2F(GH), PASS_MAGNETAR_PUBLIC_C2F(GH)

#define DECLARE_MAGNETAR_C2F _DECLARE_CCTK_C2F DECLARE_MAGNETAR_PRIVATE_C2F DECLARE_MAGNETAR_PROTECTED_C2F DECLARE_MAGNETAR_PUBLIC_C2F

#define INITIALISE_MAGNETAR_C2F _INITIALISE_CCTK_C2F INITIALISE_MAGNETAR_PRIVATE_C2F INITIALISE_MAGNETAR_PROTECTED_C2F INITIALISE_MAGNETAR_PUBLIC_C2F

#define MAGNETAR_CARGUMENTS cGH *cctkGH
