/*@@
   @header  shock_mhd_arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn shock_mhd
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_SHOCK_MHD_PRIVATE_FARGUMENTS \
INTEGER X0mhd_shock_private&&\
INTEGER X1mhd_shock_private&&\
INTEGER X2mhd_shock_private&&\
CCTK_REAL shock_rest_mass_integrand(X0mhd_shock_private,X1mhd_shock_private,X2mhd_shock_private)&&\
CCTK_REAL shock_restmass_VolInt&&\


#define SHOCK_MHD_PRIVATE_FARGUMENTS \
X0mhd_shock_private,X1mhd_shock_private,X2mhd_shock_private,shock_rest_mass_integrand,shock_restmass_VolInt

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_SHOCK_MHD_PRIVATE_CARGUMENTS \
CCTK_REAL * CCTK_RESTRICT shock_rest_mass_integrand = (cctki_dummy_int = &shock_rest_mass_integrand - &shock_rest_mass_integrand, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "SHOCK_MHD", "shock_rest_mass_integrand")); \
CCTK_REAL * CCTK_RESTRICT shock_restmass_VolInt = (cctki_dummy_int = &shock_restmass_VolInt - &shock_restmass_VolInt, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "SHOCK_MHD", "shock_restmass_VolInt"));

#define DECLARE_SHOCK_MHD_PRIVATE_C2F \
static int CCTKARGNUM_shock_rest_mass_integrand = -1; \
static int CCTKGROUPNUM_mhd_shock_private = -1; \
static int CCTKARGNUM_shock_restmass_VolInt = -1; \
static int CCTKGROUPNUM_mhd_shock_VolInt = -1;

#define INITIALISE_SHOCK_MHD_PRIVATE_C2F \
if(CCTKARGNUM_shock_rest_mass_integrand == -1) CCTKARGNUM_shock_rest_mass_integrand = CCTK_VarIndex("shock_mhd::shock_rest_mass_integrand"); \
if(CCTKGROUPNUM_mhd_shock_private == -1) CCTKGROUPNUM_mhd_shock_private = CCTK_GroupIndex("shock_mhd::mhd_shock_private"); \
if(CCTKARGNUM_shock_restmass_VolInt == -1) CCTKARGNUM_shock_restmass_VolInt = CCTK_VarIndex("shock_mhd::shock_restmass_VolInt"); \
if(CCTKGROUPNUM_mhd_shock_VolInt == -1) CCTKGROUPNUM_mhd_shock_VolInt = CCTK_GroupIndex("shock_mhd::mhd_shock_VolInt");

#define SHOCK_MHD_PRIVATE_C2F_PROTO \
const int *,const int *,const int *,CCTK_REAL *,CCTK_REAL *

#define PASS_SHOCK_MHD_PRIVATE_C2F(GH) \
PASS_GROUPSIZE(mhd_shock_private, 0),\
PASS_GROUPSIZE(mhd_shock_private, 1),\
PASS_GROUPSIZE(mhd_shock_private, 2),\
(CCTK_REAL *)(PASS_REFERENCE(shock_rest_mass_integrand, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(shock_restmass_VolInt, 0))

#endif /* CCODE */

#ifdef FCODE
#define DECLARE_SHOCK_MHD_PROTECTED_FARGUMENTS \
INTEGER X0BSSN_AH&&\
...
#define SHOCK_MHD_PROTECTED_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_SHOCK_MHD_PROTECTED_CARGUMENTS \
...
#define DECLARE_SHOCK_MHD_PROTECTED_C2F \
...
#define INITIALISE_SHOCK_MHD_PROTECTED_C2F \
...
#define SHOCK_MHD_PROTECTED_C2F_PROTO \
...
#define PASS_SHOCK_MHD_PROTECTED_C2F(GH) \
...
#ifdef FCODE
#define DECLARE_SHOCK_MHD_PUBLIC_FARGUMENTS \
...
#define DECLARE_SHOCK_MHD_PUBLIC_C2F \
...
#define INITIALISE_SHOCK_MHD_PUBLIC_C2F \
...
#ifdef FCODE
#define SHOCK_MHD_FARGUMENTS _CCTK_FARGUMENTS, SHOCK_MHD_PRIVATE_FARGUMENTS, SHOCK_MHD_PROTECTED_FARGUMENTS, SHOCK_MHD_PUBLIC_FARGUMENTS

#define DECLARE_SHOCK_MHD_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_SHOCK_MHD_PRIVATE_FARGUMENTS DECLARE_SHOCK_MHD_PROTECTED_FARGUMENTS DECLARE_SHOCK_MHD_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_SHOCK_MHD_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_SHOCK_MHD_PRIVATE_CARGUMENTS DECLARE_SHOCK_MHD_PROTECTED_CARGUMENTS DECLARE_SHOCK_MHD_PUBLIC_CARGUMENTS

#define SHOCK_MHD_C2F_PROTO _CCTK_C2F_PROTO, SHOCK_MHD_PRIVATE_C2F_PROTO, SHOCK_MHD_PROTECTED_C2F_PROTO, SHOCK_MHD_PUBLIC_C2F_PROTO

#define PASS_SHOCK_MHD_C2F(GH) _PASS_CCTK_C2F(GH), PASS_SHOCK_MHD_PRIVATE_C2F(GH), PASS_SHOCK_MHD_PROTECTED_C2F(GH), PASS_SHOCK_MHD_PUBLIC_C2F(GH)

#define DECLARE_SHOCK_MHD_C2F _DECLARE_CCTK_C2F DECLARE_SHOCK_MHD_PRIVATE_C2F DECLARE_SHOCK_MHD_PROTECTED_C2F DECLARE_SHOCK_MHD_PUBLIC_C2F

#define INITIALISE_SHOCK_MHD_C2F _INITIALISE_CCTK_C2F INITIALISE_SHOCK_MHD_PRIVATE_C2F INITIALISE_SHOCK_MHD_PROTECTED_C2F INITIALISE_SHOCK_MHD_PUBLIC_C2F

#define SHOCK_MHD_CARGUMENTS cGH *cctkGH
