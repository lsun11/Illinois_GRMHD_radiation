/*@@
   @header  disk_powerlaw_Prototypes.h
...
#ifndef _DISK_POWERLAW_PROTOTYPES_H_
#define _DISK_POWERLAW_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_DISK_POWERLAW_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
