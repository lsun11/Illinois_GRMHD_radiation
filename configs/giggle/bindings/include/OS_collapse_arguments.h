/*@@
   @header  OS_collapse_arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn OS_collapse
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_OS_COLLAPSE_PRIVATE_FARGUMENTS \
INTEGER X0analytic&&\
INTEGER X0h17&&\
...
CCTK_REAL coord(X0particle_tracer,X1particle_tracer)&&\
CCTK_REAL coordt(X0particle_tracer,X1particle_tracer)&&\
CCTK_REAL eta(X0pcle_stuff)&&\
CCTK_REAL gxx_pcle(X0pcle_stuff)&&\
CCTK_REAL gxz_pcle(X0pcle_stuff)&&\
CCTK_REAL gzz_pcle(X0pcle_stuff)&&\
CCTK_REAL h17_rhs(X0h17,X1h17,X2h17)&&\
...
CCTK_REAL slope(X0particle_tracer,X1particle_tracer)&&\
CCTK_REAL slopem(X0particle_tracer,X1particle_tracer)&&\
CCTK_REAL slopet(X0particle_tracer,X1particle_tracer)&&\
...
#define OS_COLLAPSE_PRIVATE_FARGUMENTS \
X0analytic,X0h17,X0more_pcle_stuff,X0particle_tracer,X0pcle_stuff,X0v_previous,X1analytic,X1h17,X1more_pcle_stuff,X1particle_tracer,X1v_previous,X2analytic,X2h17,X2v_previous,E_anal,E_rad_gradient,E_rad_pcle,Ec_anal,Ec_pcle,F_anal,F_coeff,F_pcle,Fc_anal,Fc_pcle,P_pcle,Q,areal_radius,coord,coordt,eta,gxx_pcle,gxz_pcle,gzz_pcle,h17_rhs,phi_pcle,pos,rho_b_anal,rho_b_analytic,rho_b_pcle,slope,slopem,slopet,tau_center_OS,u0_p,u0_pcle,vx_p,vy_p,vz_p,z_anal

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_OS_COLLAPSE_PRIVATE_CARGUMENTS \
CCTK_REAL * CCTK_RESTRICT E_anal = (cctki_dummy_int = &E_anal - &E_anal, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "E_anal")); \
CCTK_REAL * CCTK_RESTRICT E_rad_gradient = (cctki_dummy_int = &E_rad_gradient - &E_rad_gradient, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "E_rad_gradient")); \
CCTK_REAL * CCTK_RESTRICT E_rad_pcle = (cctki_dummy_int = &E_rad_pcle - &E_rad_pcle, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "E_rad_pcle")); \
CCTK_REAL * CCTK_RESTRICT Ec_anal = (cctki_dummy_int = &Ec_anal - &Ec_anal, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "Ec_anal")); \
CCTK_REAL * CCTK_RESTRICT Ec_pcle = (cctki_dummy_int = &Ec_pcle - &Ec_pcle, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "Ec_pcle")); \
CCTK_REAL * CCTK_RESTRICT F_anal = (cctki_dummy_int = &F_anal - &F_anal, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "F_anal")); \
CCTK_REAL * CCTK_RESTRICT F_coeff = (cctki_dummy_int = &F_coeff - &F_coeff, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "F_coeff")); \
CCTK_REAL * CCTK_RESTRICT F_pcle = (cctki_dummy_int = &F_pcle - &F_pcle, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "F_pcle")); \
CCTK_REAL * CCTK_RESTRICT Fc_anal = (cctki_dummy_int = &Fc_anal - &Fc_anal, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "Fc_anal")); \
CCTK_REAL * CCTK_RESTRICT Fc_pcle = (cctki_dummy_int = &Fc_pcle - &Fc_pcle, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "Fc_pcle")); \
CCTK_REAL * CCTK_RESTRICT P_pcle = (cctki_dummy_int = &P_pcle - &P_pcle, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "P_pcle")); \
CCTK_REAL * CCTK_RESTRICT Q = (cctki_dummy_int = &Q - &Q, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "Q")); \
CCTK_REAL * CCTK_RESTRICT areal_radius = (cctki_dummy_int = &areal_radius - &areal_radius, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "areal_radius")); \
CCTK_REAL * CCTK_RESTRICT coord = (cctki_dummy_int = &coord - &coord, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "coord")); \
CCTK_REAL * CCTK_RESTRICT coordt = (cctki_dummy_int = &coordt - &coordt, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "coordt")); \
CCTK_REAL * CCTK_RESTRICT eta = (cctki_dummy_int = &eta - &eta, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "eta")); \
CCTK_REAL * CCTK_RESTRICT gxx_pcle = (cctki_dummy_int = &gxx_pcle - &gxx_pcle, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "gxx_pcle")); \
CCTK_REAL * CCTK_RESTRICT gxz_pcle = (cctki_dummy_int = &gxz_pcle - &gxz_pcle, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "gxz_pcle")); \
CCTK_REAL * CCTK_RESTRICT gzz_pcle = (cctki_dummy_int = &gzz_pcle - &gzz_pcle, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "gzz_pcle")); \
CCTK_REAL * CCTK_RESTRICT h17_rhs = (cctki_dummy_int = &h17_rhs - &h17_rhs, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "h17_rhs")); \
CCTK_REAL * CCTK_RESTRICT phi_pcle = (cctki_dummy_int = &phi_pcle - &phi_pcle, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "phi_pcle")); \
CCTK_REAL * CCTK_RESTRICT pos = (cctki_dummy_int = &pos - &pos, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "pos")); \
CCTK_REAL * CCTK_RESTRICT rho_b_anal = (cctki_dummy_int = &rho_b_anal - &rho_b_anal, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "rho_b_anal")); \
CCTK_REAL * CCTK_RESTRICT rho_b_analytic = (cctki_dummy_int = &rho_b_analytic - &rho_b_analytic, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "rho_b_analytic")); \
CCTK_REAL * CCTK_RESTRICT rho_b_pcle = (cctki_dummy_int = &rho_b_pcle - &rho_b_pcle, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "rho_b_pcle")); \
CCTK_REAL * CCTK_RESTRICT slope = (cctki_dummy_int = &slope - &slope, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "slope")); \
CCTK_REAL * CCTK_RESTRICT slopem = (cctki_dummy_int = &slopem - &slopem, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "slopem")); \
CCTK_REAL * CCTK_RESTRICT slopet = (cctki_dummy_int = &slopet - &slopet, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "slopet")); \
CCTK_REAL * CCTK_RESTRICT tau_center_OS = (cctki_dummy_int = &tau_center_OS - &tau_center_OS, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "tau_center_OS")); \
CCTK_REAL * CCTK_RESTRICT u0_p = (cctki_dummy_int = &u0_p - &u0_p, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "u0_p")); \
CCTK_REAL * CCTK_RESTRICT u0_pcle = (cctki_dummy_int = &u0_pcle - &u0_pcle, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "u0_pcle")); \
CCTK_REAL * CCTK_RESTRICT vx_p = (cctki_dummy_int = &vx_p - &vx_p, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "vx_p")); \
CCTK_REAL * CCTK_RESTRICT vy_p = (cctki_dummy_int = &vy_p - &vy_p, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "vy_p")); \
CCTK_REAL * CCTK_RESTRICT vz_p = (cctki_dummy_int = &vz_p - &vz_p, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "vz_p")); \
CCTK_REAL * CCTK_RESTRICT z_anal = (cctki_dummy_int = &z_anal - &z_anal, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_COLLAPSE", "z_anal"));

#define DECLARE_OS_COLLAPSE_PRIVATE_C2F \
...
static int CCTKARGNUM_F_pcle = -1; \
...
static int CCTKGROUPNUM_particle_tracer = -1; \
...
static int CCTKARGNUM_h17_rhs = -1; \
static int CCTKGROUPNUM_h17 = -1; \
...
#define INITIALISE_OS_COLLAPSE_PRIVATE_C2F \
if(CCTKARGNUM_E_anal == -1) CCTKARGNUM_E_anal = CCTK_VarIndex("OS_collapse::E_anal"); \
if(CCTKGROUPNUM_pcle_stuff == -1) CCTKGROUPNUM_pcle_stuff = CCTK_GroupIndex("OS_collapse::pcle_stuff"); \
if(CCTKARGNUM_E_rad_gradient == -1) CCTKARGNUM_E_rad_gradient = CCTK_VarIndex("OS_collapse::E_rad_gradient"); \
if(CCTKARGNUM_E_rad_pcle == -1) CCTKARGNUM_E_rad_pcle = CCTK_VarIndex("OS_collapse::E_rad_pcle"); \
if(CCTKARGNUM_Ec_anal == -1) CCTKARGNUM_Ec_anal = CCTK_VarIndex("OS_collapse::Ec_anal"); \
if(CCTKARGNUM_Ec_pcle == -1) CCTKARGNUM_Ec_pcle = CCTK_VarIndex("OS_collapse::Ec_pcle"); \
if(CCTKARGNUM_F_anal == -1) CCTKARGNUM_F_anal = CCTK_VarIndex("OS_collapse::F_anal"); \
if(CCTKARGNUM_F_coeff == -1) CCTKARGNUM_F_coeff = CCTK_VarIndex("OS_collapse::F_coeff"); \
if(CCTKARGNUM_F_pcle == -1) CCTKARGNUM_F_pcle = CCTK_VarIndex("OS_collapse::F_pcle"); \
if(CCTKARGNUM_Fc_anal == -1) CCTKARGNUM_Fc_anal = CCTK_VarIndex("OS_collapse::Fc_anal"); \
if(CCTKARGNUM_Fc_pcle == -1) CCTKARGNUM_Fc_pcle = CCTK_VarIndex("OS_collapse::Fc_pcle"); \
if(CCTKARGNUM_P_pcle == -1) CCTKARGNUM_P_pcle = CCTK_VarIndex("OS_collapse::P_pcle"); \
if(CCTKARGNUM_Q == -1) CCTKARGNUM_Q = CCTK_VarIndex("OS_collapse::Q"); \
if(CCTKARGNUM_areal_radius == -1) CCTKARGNUM_areal_radius = CCTK_VarIndex("OS_collapse::areal_radius"); \
if(CCTKARGNUM_coord == -1) CCTKARGNUM_coord = CCTK_VarIndex("OS_collapse::coord"); \
if(CCTKGROUPNUM_particle_tracer == -1) CCTKGROUPNUM_particle_tracer = CCTK_GroupIndex("OS_collapse::particle_tracer"); \
if(CCTKARGNUM_coordt == -1) CCTKARGNUM_coordt = CCTK_VarIndex("OS_collapse::coordt"); \
if(CCTKARGNUM_eta == -1) CCTKARGNUM_eta = CCTK_VarIndex("OS_collapse::eta"); \
if(CCTKARGNUM_gxx_pcle == -1) CCTKARGNUM_gxx_pcle = CCTK_VarIndex("OS_collapse::gxx_pcle"); \
if(CCTKARGNUM_gxz_pcle == -1) CCTKARGNUM_gxz_pcle = CCTK_VarIndex("OS_collapse::gxz_pcle"); \
if(CCTKARGNUM_gzz_pcle == -1) CCTKARGNUM_gzz_pcle = CCTK_VarIndex("OS_collapse::gzz_pcle"); \
if(CCTKARGNUM_h17_rhs == -1) CCTKARGNUM_h17_rhs = CCTK_VarIndex("OS_collapse::h17_rhs"); \
if(CCTKGROUPNUM_h17 == -1) CCTKGROUPNUM_h17 = CCTK_GroupIndex("OS_collapse::h17"); \
if(CCTKARGNUM_phi_pcle == -1) CCTKARGNUM_phi_pcle = CCTK_VarIndex("OS_collapse::phi_pcle"); \
if(CCTKARGNUM_pos == -1) CCTKARGNUM_pos = CCTK_VarIndex("OS_collapse::pos"); \
if(CCTKGROUPNUM_more_pcle_stuff == -1) CCTKGROUPNUM_more_pcle_stuff = CCTK_GroupIndex("OS_collapse::more_pcle_stuff"); \
if(CCTKARGNUM_rho_b_anal == -1) CCTKARGNUM_rho_b_anal = CCTK_VarIndex("OS_collapse::rho_b_anal"); \
if(CCTKARGNUM_rho_b_analytic == -1) CCTKARGNUM_rho_b_analytic = CCTK_VarIndex("OS_collapse::rho_b_analytic"); \
if(CCTKGROUPNUM_analytic == -1) CCTKGROUPNUM_analytic = CCTK_GroupIndex("OS_collapse::analytic"); \
if(CCTKARGNUM_rho_b_pcle == -1) CCTKARGNUM_rho_b_pcle = CCTK_VarIndex("OS_collapse::rho_b_pcle"); \
if(CCTKARGNUM_slope == -1) CCTKARGNUM_slope = CCTK_VarIndex("OS_collapse::slope"); \
if(CCTKARGNUM_slopem == -1) CCTKARGNUM_slopem = CCTK_VarIndex("OS_collapse::slopem"); \
if(CCTKARGNUM_slopet == -1) CCTKARGNUM_slopet = CCTK_VarIndex("OS_collapse::slopet"); \
if(CCTKARGNUM_tau_center_OS == -1) CCTKARGNUM_tau_center_OS = CCTK_VarIndex("OS_collapse::tau_center_OS"); \
if(CCTKGROUPNUM_OS_center_diagnostics == -1) CCTKGROUPNUM_OS_center_diagnostics = CCTK_GroupIndex("OS_collapse::OS_center_diagnostics"); \
if(CCTKARGNUM_u0_p == -1) CCTKARGNUM_u0_p = CCTK_VarIndex("OS_collapse::u0_p"); \
if(CCTKGROUPNUM_v_previous == -1) CCTKGROUPNUM_v_previous = CCTK_GroupIndex("OS_collapse::v_previous"); \
if(CCTKARGNUM_u0_pcle == -1) CCTKARGNUM_u0_pcle = CCTK_VarIndex("OS_collapse::u0_pcle"); \
if(CCTKARGNUM_vx_p == -1) CCTKARGNUM_vx_p = CCTK_VarIndex("OS_collapse::vx_p"); \
if(CCTKARGNUM_vy_p == -1) CCTKARGNUM_vy_p = CCTK_VarIndex("OS_collapse::vy_p"); \
if(CCTKARGNUM_vz_p == -1) CCTKARGNUM_vz_p = CCTK_VarIndex("OS_collapse::vz_p"); \
if(CCTKARGNUM_z_anal == -1) CCTKARGNUM_z_anal = CCTK_VarIndex("OS_collapse::z_anal");

#define OS_COLLAPSE_PRIVATE_C2F_PROTO \
const int *,const int *,const int *,const int *,const int *,const int *,const int *,const int *,const int *,const int *,const int *,const int *,const int *,const int *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *

#define PASS_OS_COLLAPSE_PRIVATE_C2F(GH) \
PASS_GROUPSIZE(analytic, 0),\
PASS_GROUPSIZE(h17, 0),\
PASS_GROUPSIZE(more_pcle_stuff, 0),\
PASS_GROUPSIZE(particle_tracer, 0),\
PASS_GROUPSIZE(pcle_stuff, 0),\
PASS_GROUPSIZE(v_previous, 0),\
PASS_GROUPSIZE(analytic, 1),\
PASS_GROUPSIZE(h17, 1),\
PASS_GROUPSIZE(more_pcle_stuff, 1),\
PASS_GROUPSIZE(particle_tracer, 1),\
PASS_GROUPSIZE(v_previous, 1),\
PASS_GROUPSIZE(analytic, 2),\
PASS_GROUPSIZE(h17, 2),\
...
(CCTK_REAL *)(PASS_REFERENCE(F_pcle, 0)),\
...
(CCTK_REAL *)(PASS_REFERENCE(h17_rhs, 0)),\
...
#ifdef FCODE
#define DECLARE_OS_COLLAPSE_PROTECTED_FARGUMENTS \
INTEGER X0BSSN_AH&&\
...
#define OS_COLLAPSE_PROTECTED_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_OS_COLLAPSE_PROTECTED_CARGUMENTS \
...
#define DECLARE_OS_COLLAPSE_PROTECTED_C2F \
...
#define INITIALISE_OS_COLLAPSE_PROTECTED_C2F \
...
#define OS_COLLAPSE_PROTECTED_C2F_PROTO \
...
#define PASS_OS_COLLAPSE_PROTECTED_C2F(GH) \
...
#ifdef FCODE
#define DECLARE_OS_COLLAPSE_PUBLIC_FARGUMENTS \
...
#define OS_COLLAPSE_PUBLIC_FARGUMENTS \
X0coordinates,X1coordinates,X2coordinates,coarse_dx,coarse_dy,coarse_dz,r,x,y,z

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_OS_COLLAPSE_PUBLIC_CARGUMENTS \
...
#define DECLARE_OS_COLLAPSE_PUBLIC_C2F \
...
#define INITIALISE_OS_COLLAPSE_PUBLIC_C2F \
...
#ifdef FCODE
#define OS_COLLAPSE_FARGUMENTS _CCTK_FARGUMENTS, OS_COLLAPSE_PRIVATE_FARGUMENTS, OS_COLLAPSE_PROTECTED_FARGUMENTS, OS_COLLAPSE_PUBLIC_FARGUMENTS

#define DECLARE_OS_COLLAPSE_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_OS_COLLAPSE_PRIVATE_FARGUMENTS DECLARE_OS_COLLAPSE_PROTECTED_FARGUMENTS DECLARE_OS_COLLAPSE_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_OS_COLLAPSE_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_OS_COLLAPSE_PRIVATE_CARGUMENTS DECLARE_OS_COLLAPSE_PROTECTED_CARGUMENTS DECLARE_OS_COLLAPSE_PUBLIC_CARGUMENTS

#define OS_COLLAPSE_C2F_PROTO _CCTK_C2F_PROTO, OS_COLLAPSE_PRIVATE_C2F_PROTO, OS_COLLAPSE_PROTECTED_C2F_PROTO, OS_COLLAPSE_PUBLIC_C2F_PROTO

#define PASS_OS_COLLAPSE_C2F(GH) _PASS_CCTK_C2F(GH), PASS_OS_COLLAPSE_PRIVATE_C2F(GH), PASS_OS_COLLAPSE_PROTECTED_C2F(GH), PASS_OS_COLLAPSE_PUBLIC_C2F(GH)

#define DECLARE_OS_COLLAPSE_C2F _DECLARE_CCTK_C2F DECLARE_OS_COLLAPSE_PRIVATE_C2F DECLARE_OS_COLLAPSE_PROTECTED_C2F DECLARE_OS_COLLAPSE_PUBLIC_C2F

#define INITIALISE_OS_COLLAPSE_C2F _INITIALISE_CCTK_C2F INITIALISE_OS_COLLAPSE_PRIVATE_C2F INITIALISE_OS_COLLAPSE_PROTECTED_C2F INITIALISE_OS_COLLAPSE_PUBLIC_C2F

#define OS_COLLAPSE_CARGUMENTS cGH *cctkGH
