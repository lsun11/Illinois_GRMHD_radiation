/*@@
   @header  mag_bondi_arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn mag_bondi
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_MAG_BONDI_PRIVATE_FARGUMENTS \
INTEGER X0horizon_data_arrays&&\
CCTK_REAL nn_d(X0horizon_data_arrays)&&\
CCTK_REAL nx_d(X0horizon_data_arrays)&&\
CCTK_REAL ny_d(X0horizon_data_arrays)&&\
CCTK_REAL nz_d(X0horizon_data_arrays)&&\
CCTK_REAL xmax_bondi&&\
CCTK_REAL xn_d(X0horizon_data_arrays)&&\
CCTK_REAL yn_d(X0horizon_data_arrays)&&\
CCTK_REAL zmax_bondi&&\
CCTK_REAL zn_d(X0horizon_data_arrays)&&\


#define MAG_BONDI_PRIVATE_FARGUMENTS \
X0horizon_data_arrays,nn_d,nx_d,ny_d,nz_d,xmax_bondi,xn_d,yn_d,zmax_bondi,zn_d

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_MAG_BONDI_PRIVATE_CARGUMENTS \
CCTK_REAL * CCTK_RESTRICT nn_d = (cctki_dummy_int = &nn_d - &nn_d, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MAG_BONDI", "nn_d")); \
CCTK_REAL * CCTK_RESTRICT nx_d = (cctki_dummy_int = &nx_d - &nx_d, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MAG_BONDI", "nx_d")); \
CCTK_REAL * CCTK_RESTRICT ny_d = (cctki_dummy_int = &ny_d - &ny_d, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MAG_BONDI", "ny_d")); \
CCTK_REAL * CCTK_RESTRICT nz_d = (cctki_dummy_int = &nz_d - &nz_d, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MAG_BONDI", "nz_d")); \
CCTK_REAL * CCTK_RESTRICT xmax_bondi = (cctki_dummy_int = &xmax_bondi - &xmax_bondi, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MAG_BONDI", "xmax_bondi")); \
CCTK_REAL * CCTK_RESTRICT xn_d = (cctki_dummy_int = &xn_d - &xn_d, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MAG_BONDI", "xn_d")); \
CCTK_REAL * CCTK_RESTRICT yn_d = (cctki_dummy_int = &yn_d - &yn_d, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MAG_BONDI", "yn_d")); \
CCTK_REAL * CCTK_RESTRICT zmax_bondi = (cctki_dummy_int = &zmax_bondi - &zmax_bondi, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MAG_BONDI", "zmax_bondi")); \
CCTK_REAL * CCTK_RESTRICT zn_d = (cctki_dummy_int = &zn_d - &zn_d, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MAG_BONDI", "zn_d"));

#define DECLARE_MAG_BONDI_PRIVATE_C2F \
static int CCTKARGNUM_nn_d = -1; \
static int CCTKGROUPNUM_horizon_data_arrays = -1; \
static int CCTKARGNUM_nx_d = -1; \
static int CCTKARGNUM_ny_d = -1; \
static int CCTKARGNUM_nz_d = -1; \
static int CCTKARGNUM_xmax_bondi = -1; \
static int CCTKGROUPNUM_aux_var = -1; \
static int CCTKARGNUM_xn_d = -1; \
static int CCTKARGNUM_yn_d = -1; \
static int CCTKARGNUM_zmax_bondi = -1; \
static int CCTKARGNUM_zn_d = -1;

#define INITIALISE_MAG_BONDI_PRIVATE_C2F \
if(CCTKARGNUM_nn_d == -1) CCTKARGNUM_nn_d = CCTK_VarIndex("mag_bondi::nn_d"); \
if(CCTKGROUPNUM_horizon_data_arrays == -1) CCTKGROUPNUM_horizon_data_arrays = CCTK_GroupIndex("mag_bondi::horizon_data_arrays"); \
if(CCTKARGNUM_nx_d == -1) CCTKARGNUM_nx_d = CCTK_VarIndex("mag_bondi::nx_d"); \
if(CCTKARGNUM_ny_d == -1) CCTKARGNUM_ny_d = CCTK_VarIndex("mag_bondi::ny_d"); \
if(CCTKARGNUM_nz_d == -1) CCTKARGNUM_nz_d = CCTK_VarIndex("mag_bondi::nz_d"); \
if(CCTKARGNUM_xmax_bondi == -1) CCTKARGNUM_xmax_bondi = CCTK_VarIndex("mag_bondi::xmax_bondi"); \
if(CCTKGROUPNUM_aux_var == -1) CCTKGROUPNUM_aux_var = CCTK_GroupIndex("mag_bondi::aux_var"); \
if(CCTKARGNUM_xn_d == -1) CCTKARGNUM_xn_d = CCTK_VarIndex("mag_bondi::xn_d"); \
if(CCTKARGNUM_yn_d == -1) CCTKARGNUM_yn_d = CCTK_VarIndex("mag_bondi::yn_d"); \
if(CCTKARGNUM_zmax_bondi == -1) CCTKARGNUM_zmax_bondi = CCTK_VarIndex("mag_bondi::zmax_bondi"); \
if(CCTKARGNUM_zn_d == -1) CCTKARGNUM_zn_d = CCTK_VarIndex("mag_bondi::zn_d");

#define MAG_BONDI_PRIVATE_C2F_PROTO \
const int *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *

#define PASS_MAG_BONDI_PRIVATE_C2F(GH) \
PASS_GROUPSIZE(horizon_data_arrays, 0),\
(CCTK_REAL *)(PASS_REFERENCE(nn_d, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(nx_d, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(ny_d, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(nz_d, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(xmax_bondi, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(xn_d, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(yn_d, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(zmax_bondi, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(zn_d, 0))

#endif /* CCODE */

#ifdef FCODE
#define DECLARE_MAG_BONDI_PROTECTED_FARGUMENTS \
INTEGER X0BSSN_AH&&\
...
#define MAG_BONDI_PROTECTED_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_MAG_BONDI_PROTECTED_CARGUMENTS \
...
#define DECLARE_MAG_BONDI_PROTECTED_C2F \
...
#define INITIALISE_MAG_BONDI_PROTECTED_C2F \
...
#define MAG_BONDI_PROTECTED_C2F_PROTO \
...
#define PASS_MAG_BONDI_PROTECTED_C2F(GH) \
...
#ifdef FCODE
#define DECLARE_MAG_BONDI_PUBLIC_FARGUMENTS \
...
#define MAG_BONDI_PUBLIC_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_MAG_BONDI_PUBLIC_CARGUMENTS \
...
#define DECLARE_MAG_BONDI_PUBLIC_C2F \
...
#define INITIALISE_MAG_BONDI_PUBLIC_C2F \
...
#define MAG_BONDI_PUBLIC_C2F_PROTO \
...
#define PASS_MAG_BONDI_PUBLIC_C2F(GH) \
...
#ifdef FCODE
#define MAG_BONDI_FARGUMENTS _CCTK_FARGUMENTS, MAG_BONDI_PRIVATE_FARGUMENTS, MAG_BONDI_PROTECTED_FARGUMENTS, MAG_BONDI_PUBLIC_FARGUMENTS

#define DECLARE_MAG_BONDI_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_MAG_BONDI_PRIVATE_FARGUMENTS DECLARE_MAG_BONDI_PROTECTED_FARGUMENTS DECLARE_MAG_BONDI_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_MAG_BONDI_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_MAG_BONDI_PRIVATE_CARGUMENTS DECLARE_MAG_BONDI_PROTECTED_CARGUMENTS DECLARE_MAG_BONDI_PUBLIC_CARGUMENTS

#define MAG_BONDI_C2F_PROTO _CCTK_C2F_PROTO, MAG_BONDI_PRIVATE_C2F_PROTO, MAG_BONDI_PROTECTED_C2F_PROTO, MAG_BONDI_PUBLIC_C2F_PROTO

#define PASS_MAG_BONDI_C2F(GH) _PASS_CCTK_C2F(GH), PASS_MAG_BONDI_PRIVATE_C2F(GH), PASS_MAG_BONDI_PROTECTED_C2F(GH), PASS_MAG_BONDI_PUBLIC_C2F(GH)

#define DECLARE_MAG_BONDI_C2F _DECLARE_CCTK_C2F DECLARE_MAG_BONDI_PRIVATE_C2F DECLARE_MAG_BONDI_PROTECTED_C2F DECLARE_MAG_BONDI_PUBLIC_C2F

#define INITIALISE_MAG_BONDI_C2F _INITIALISE_CCTK_C2F INITIALISE_MAG_BONDI_PRIVATE_C2F INITIALISE_MAG_BONDI_PROTECTED_C2F INITIALISE_MAG_BONDI_PUBLIC_C2F

#define MAG_BONDI_CARGUMENTS cGH *cctkGH
