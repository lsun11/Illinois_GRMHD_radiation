/*@@
   @header  mhd_evolve_arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn mhd_evolve
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_MHD_EVOLVE_PRIVATE_FARGUMENTS \
INTEGER X0em_fijs&&\
INTEGER X0em_ftijs&&\
INTEGER X0rad_fijs&&\
...
CCTK_REAL S_radx_flux(X0rad_fijs,X1rad_fijs,X2rad_fijs)&&\
CCTK_REAL S_radx_flux_x(X0rad_fijs_diag,X1rad_fijs_diag,X2rad_fijs_diag)&&\
CCTK_REAL S_radx_flux_xp1(X0rad_fijs_diag,X1rad_fijs_diag,X2rad_fijs_diag)&&\
CCTK_REAL S_radx_nue_flux(X0rad_fijs,X1rad_fijs,X2rad_fijs)&&\
CCTK_REAL S_radx_nux_flux(X0rad_fijs,X1rad_fijs,X2rad_fijs)&&\
CCTK_REAL S_rady_flux(X0rad_fijs,X1rad_fijs,X2rad_fijs)&&\
CCTK_REAL S_rady_nue_flux(X0rad_fijs,X1rad_fijs,X2rad_fijs)&&\
CCTK_REAL S_rady_nux_flux(X0rad_fijs,X1rad_fijs,X2rad_fijs)&&\
CCTK_REAL S_radz_flux(X0rad_fijs,X1rad_fijs,X2rad_fijs)&&\
CCTK_REAL S_radz_nue_flux(X0rad_fijs,X1rad_fijs,X2rad_fijs)&&\
CCTK_REAL S_radz_nux_flux(X0rad_fijs,X1rad_fijs,X2rad_fijs)&&\
CCTK_REAL ftxy(X0em_ftijs,X1em_ftijs,X2em_ftijs)&&\
CCTK_REAL ftxz(X0em_ftijs,X1em_ftijs,X2em_ftijs)&&\
CCTK_REAL ftyx(X0em_ftijs,X1em_ftijs,X2em_ftijs)&&\
CCTK_REAL ftyz(X0em_ftijs,X1em_ftijs,X2em_ftijs)&&\
CCTK_REAL ftzx(X0em_ftijs,X1em_ftijs,X2em_ftijs)&&\
CCTK_REAL ftzy(X0em_ftijs,X1em_ftijs,X2em_ftijs)&&\
CCTK_REAL fxy(X0em_fijs,X1em_fijs,X2em_fijs)&&\
CCTK_REAL fxz(X0em_fijs,X1em_fijs,X2em_fijs)&&\
CCTK_REAL fyx(X0em_fijs,X1em_fijs,X2em_fijs)&&\
CCTK_REAL fyz(X0em_fijs,X1em_fijs,X2em_fijs)&&\
CCTK_REAL fzx(X0em_fijs,X1em_fijs,X2em_fijs)&&\
CCTK_REAL fzy(X0em_fijs,X1em_fijs,X2em_fijs)&&\
CCTK_REAL tau_rad_advect_diag(X0rad_fijs_diag,X1rad_fijs_diag,X2rad_fijs_diag)&&\
CCTK_REAL tau_rad_flux(X0rad_fijs,X1rad_fijs,X2rad_fijs)&&\
CCTK_REAL tau_rad_flux_diag(X0rad_fijs_diag,X1rad_fijs_diag,X2rad_fijs_diag)&&\
CCTK_REAL tau_rad_flux_x(X0rad_fijs_diag,X1rad_fijs_diag,X2rad_fijs_diag)&&\
CCTK_REAL tau_rad_nue_flux(X0rad_fijs,X1rad_fijs,X2rad_fijs)&&\
CCTK_REAL tau_rad_nux_flux(X0rad_fijs,X1rad_fijs,X2rad_fijs)&&\
CCTK_REAL tau_rad_scalar_diag(X0rad_fijs_diag,X1rad_fijs_diag,X2rad_fijs_diag)&&\


#define MHD_EVOLVE_PRIVATE_FARGUMENTS \
X0em_fijs,X0em_ftijs,X0rad_fijs,X0rad_fijs_diag,X1em_fijs,X1em_ftijs,X1rad_fijs,X1rad_fijs_diag,X2em_fijs,X2em_ftijs,X2rad_fijs,X2rad_fijs_diag,S_radx_flux,S_radx_flux_x,S_radx_flux_xp1,S_radx_nue_flux,S_radx_nux_flux,S_rady_flux,S_rady_nue_flux,S_rady_nux_flux,S_radz_flux,S_radz_nue_flux,S_radz_nux_flux,ftxy,ftxz,ftyx,ftyz,ftzx,ftzy,fxy,fxz,fyx,fyz,fzx,fzy,tau_rad_advect_diag,tau_rad_flux,tau_rad_flux_diag,tau_rad_flux_x,tau_rad_nue_flux,tau_rad_nux_flux,tau_rad_scalar_diag

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_MHD_EVOLVE_PRIVATE_CARGUMENTS \
CCTK_REAL * CCTK_RESTRICT S_radx_flux = (cctki_dummy_int = &S_radx_flux - &S_radx_flux, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "S_radx_flux")); \
CCTK_REAL * CCTK_RESTRICT S_radx_flux_x = (cctki_dummy_int = &S_radx_flux_x - &S_radx_flux_x, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "S_radx_flux_x")); \
CCTK_REAL * CCTK_RESTRICT S_radx_flux_xp1 = (cctki_dummy_int = &S_radx_flux_xp1 - &S_radx_flux_xp1, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "S_radx_flux_xp1")); \
CCTK_REAL * CCTK_RESTRICT S_radx_nue_flux = (cctki_dummy_int = &S_radx_nue_flux - &S_radx_nue_flux, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "S_radx_nue_flux")); \
CCTK_REAL * CCTK_RESTRICT S_radx_nux_flux = (cctki_dummy_int = &S_radx_nux_flux - &S_radx_nux_flux, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "S_radx_nux_flux")); \
CCTK_REAL * CCTK_RESTRICT S_rady_flux = (cctki_dummy_int = &S_rady_flux - &S_rady_flux, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "S_rady_flux")); \
CCTK_REAL * CCTK_RESTRICT S_rady_nue_flux = (cctki_dummy_int = &S_rady_nue_flux - &S_rady_nue_flux, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "S_rady_nue_flux")); \
CCTK_REAL * CCTK_RESTRICT S_rady_nux_flux = (cctki_dummy_int = &S_rady_nux_flux - &S_rady_nux_flux, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "S_rady_nux_flux")); \
CCTK_REAL * CCTK_RESTRICT S_radz_flux = (cctki_dummy_int = &S_radz_flux - &S_radz_flux, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "S_radz_flux")); \
CCTK_REAL * CCTK_RESTRICT S_radz_nue_flux = (cctki_dummy_int = &S_radz_nue_flux - &S_radz_nue_flux, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "S_radz_nue_flux")); \
CCTK_REAL * CCTK_RESTRICT S_radz_nux_flux = (cctki_dummy_int = &S_radz_nux_flux - &S_radz_nux_flux, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "S_radz_nux_flux")); \
CCTK_REAL * CCTK_RESTRICT ftxy = (cctki_dummy_int = &ftxy - &ftxy, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "ftxy")); \
CCTK_REAL * CCTK_RESTRICT ftxz = (cctki_dummy_int = &ftxz - &ftxz, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "ftxz")); \
CCTK_REAL * CCTK_RESTRICT ftyx = (cctki_dummy_int = &ftyx - &ftyx, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "ftyx")); \
CCTK_REAL * CCTK_RESTRICT ftyz = (cctki_dummy_int = &ftyz - &ftyz, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "ftyz")); \
CCTK_REAL * CCTK_RESTRICT ftzx = (cctki_dummy_int = &ftzx - &ftzx, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "ftzx")); \
CCTK_REAL * CCTK_RESTRICT ftzy = (cctki_dummy_int = &ftzy - &ftzy, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "ftzy")); \
CCTK_REAL * CCTK_RESTRICT fxy = (cctki_dummy_int = &fxy - &fxy, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "fxy")); \
CCTK_REAL * CCTK_RESTRICT fxz = (cctki_dummy_int = &fxz - &fxz, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "fxz")); \
CCTK_REAL * CCTK_RESTRICT fyx = (cctki_dummy_int = &fyx - &fyx, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "fyx")); \
CCTK_REAL * CCTK_RESTRICT fyz = (cctki_dummy_int = &fyz - &fyz, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "fyz")); \
CCTK_REAL * CCTK_RESTRICT fzx = (cctki_dummy_int = &fzx - &fzx, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "fzx")); \
CCTK_REAL * CCTK_RESTRICT fzy = (cctki_dummy_int = &fzy - &fzy, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "fzy")); \
CCTK_REAL * CCTK_RESTRICT tau_rad_advect_diag = (cctki_dummy_int = &tau_rad_advect_diag - &tau_rad_advect_diag, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "tau_rad_advect_diag")); \
CCTK_REAL * CCTK_RESTRICT tau_rad_flux = (cctki_dummy_int = &tau_rad_flux - &tau_rad_flux, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "tau_rad_flux")); \
CCTK_REAL * CCTK_RESTRICT tau_rad_flux_diag = (cctki_dummy_int = &tau_rad_flux_diag - &tau_rad_flux_diag, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "tau_rad_flux_diag")); \
CCTK_REAL * CCTK_RESTRICT tau_rad_flux_x = (cctki_dummy_int = &tau_rad_flux_x - &tau_rad_flux_x, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "tau_rad_flux_x")); \
CCTK_REAL * CCTK_RESTRICT tau_rad_nue_flux = (cctki_dummy_int = &tau_rad_nue_flux - &tau_rad_nue_flux, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "tau_rad_nue_flux")); \
CCTK_REAL * CCTK_RESTRICT tau_rad_nux_flux = (cctki_dummy_int = &tau_rad_nux_flux - &tau_rad_nux_flux, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "tau_rad_nux_flux")); \
CCTK_REAL * CCTK_RESTRICT tau_rad_scalar_diag = (cctki_dummy_int = &tau_rad_scalar_diag - &tau_rad_scalar_diag, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MHD_EVOLVE", "tau_rad_scalar_diag"));

#define DECLARE_MHD_EVOLVE_PRIVATE_C2F \
static int CCTKARGNUM_S_radx_flux = -1; \
static int CCTKGROUPNUM_rad_fijs = -1; \
static int CCTKARGNUM_S_radx_flux_x = -1; \
static int CCTKGROUPNUM_rad_fijs_diag = -1; \
static int CCTKARGNUM_S_radx_flux_xp1 = -1; \
static int CCTKARGNUM_S_radx_nue_flux = -1; \
static int CCTKARGNUM_S_radx_nux_flux = -1; \
static int CCTKARGNUM_S_rady_flux = -1; \
static int CCTKARGNUM_S_rady_nue_flux = -1; \
static int CCTKARGNUM_S_rady_nux_flux = -1; \
static int CCTKARGNUM_S_radz_flux = -1; \
static int CCTKARGNUM_S_radz_nue_flux = -1; \
static int CCTKARGNUM_S_radz_nux_flux = -1; \
static int CCTKARGNUM_ftxy = -1; \
static int CCTKGROUPNUM_em_ftijs = -1; \
static int CCTKARGNUM_ftxz = -1; \
static int CCTKARGNUM_ftyx = -1; \
static int CCTKARGNUM_ftyz = -1; \
static int CCTKARGNUM_ftzx = -1; \
static int CCTKARGNUM_ftzy = -1; \
static int CCTKARGNUM_fxy = -1; \
static int CCTKGROUPNUM_em_fijs = -1; \
static int CCTKARGNUM_fxz = -1; \
static int CCTKARGNUM_fyx = -1; \
static int CCTKARGNUM_fyz = -1; \
static int CCTKARGNUM_fzx = -1; \
static int CCTKARGNUM_fzy = -1; \
static int CCTKARGNUM_tau_rad_advect_diag = -1; \
static int CCTKARGNUM_tau_rad_flux = -1; \
static int CCTKARGNUM_tau_rad_flux_diag = -1; \
static int CCTKARGNUM_tau_rad_flux_x = -1; \
static int CCTKARGNUM_tau_rad_nue_flux = -1; \
static int CCTKARGNUM_tau_rad_nux_flux = -1; \
static int CCTKARGNUM_tau_rad_scalar_diag = -1;

#define INITIALISE_MHD_EVOLVE_PRIVATE_C2F \
if(CCTKARGNUM_S_radx_flux == -1) CCTKARGNUM_S_radx_flux = CCTK_VarIndex("mhd_evolve::S_radx_flux"); \
if(CCTKGROUPNUM_rad_fijs == -1) CCTKGROUPNUM_rad_fijs = CCTK_GroupIndex("mhd_evolve::rad_fijs"); \
if(CCTKARGNUM_S_radx_flux_x == -1) CCTKARGNUM_S_radx_flux_x = CCTK_VarIndex("mhd_evolve::S_radx_flux_x"); \
if(CCTKGROUPNUM_rad_fijs_diag == -1) CCTKGROUPNUM_rad_fijs_diag = CCTK_GroupIndex("mhd_evolve::rad_fijs_diag"); \
if(CCTKARGNUM_S_radx_flux_xp1 == -1) CCTKARGNUM_S_radx_flux_xp1 = CCTK_VarIndex("mhd_evolve::S_radx_flux_xp1"); \
if(CCTKARGNUM_S_radx_nue_flux == -1) CCTKARGNUM_S_radx_nue_flux = CCTK_VarIndex("mhd_evolve::S_radx_nue_flux"); \
if(CCTKARGNUM_S_radx_nux_flux == -1) CCTKARGNUM_S_radx_nux_flux = CCTK_VarIndex("mhd_evolve::S_radx_nux_flux"); \
if(CCTKARGNUM_S_rady_flux == -1) CCTKARGNUM_S_rady_flux = CCTK_VarIndex("mhd_evolve::S_rady_flux"); \
if(CCTKARGNUM_S_rady_nue_flux == -1) CCTKARGNUM_S_rady_nue_flux = CCTK_VarIndex("mhd_evolve::S_rady_nue_flux"); \
if(CCTKARGNUM_S_rady_nux_flux == -1) CCTKARGNUM_S_rady_nux_flux = CCTK_VarIndex("mhd_evolve::S_rady_nux_flux"); \
if(CCTKARGNUM_S_radz_flux == -1) CCTKARGNUM_S_radz_flux = CCTK_VarIndex("mhd_evolve::S_radz_flux"); \
if(CCTKARGNUM_S_radz_nue_flux == -1) CCTKARGNUM_S_radz_nue_flux = CCTK_VarIndex("mhd_evolve::S_radz_nue_flux"); \
if(CCTKARGNUM_S_radz_nux_flux == -1) CCTKARGNUM_S_radz_nux_flux = CCTK_VarIndex("mhd_evolve::S_radz_nux_flux"); \
if(CCTKARGNUM_ftxy == -1) CCTKARGNUM_ftxy = CCTK_VarIndex("mhd_evolve::ftxy"); \
if(CCTKGROUPNUM_em_ftijs == -1) CCTKGROUPNUM_em_ftijs = CCTK_GroupIndex("mhd_evolve::em_ftijs"); \
if(CCTKARGNUM_ftxz == -1) CCTKARGNUM_ftxz = CCTK_VarIndex("mhd_evolve::ftxz"); \
if(CCTKARGNUM_ftyx == -1) CCTKARGNUM_ftyx = CCTK_VarIndex("mhd_evolve::ftyx"); \
if(CCTKARGNUM_ftyz == -1) CCTKARGNUM_ftyz = CCTK_VarIndex("mhd_evolve::ftyz"); \
if(CCTKARGNUM_ftzx == -1) CCTKARGNUM_ftzx = CCTK_VarIndex("mhd_evolve::ftzx"); \
if(CCTKARGNUM_ftzy == -1) CCTKARGNUM_ftzy = CCTK_VarIndex("mhd_evolve::ftzy"); \
if(CCTKARGNUM_fxy == -1) CCTKARGNUM_fxy = CCTK_VarIndex("mhd_evolve::fxy"); \
if(CCTKGROUPNUM_em_fijs == -1) CCTKGROUPNUM_em_fijs = CCTK_GroupIndex("mhd_evolve::em_fijs"); \
if(CCTKARGNUM_fxz == -1) CCTKARGNUM_fxz = CCTK_VarIndex("mhd_evolve::fxz"); \
if(CCTKARGNUM_fyx == -1) CCTKARGNUM_fyx = CCTK_VarIndex("mhd_evolve::fyx"); \
if(CCTKARGNUM_fyz == -1) CCTKARGNUM_fyz = CCTK_VarIndex("mhd_evolve::fyz"); \
if(CCTKARGNUM_fzx == -1) CCTKARGNUM_fzx = CCTK_VarIndex("mhd_evolve::fzx"); \
if(CCTKARGNUM_fzy == -1) CCTKARGNUM_fzy = CCTK_VarIndex("mhd_evolve::fzy"); \
if(CCTKARGNUM_tau_rad_advect_diag == -1) CCTKARGNUM_tau_rad_advect_diag = CCTK_VarIndex("mhd_evolve::tau_rad_advect_diag"); \
if(CCTKARGNUM_tau_rad_flux == -1) CCTKARGNUM_tau_rad_flux = CCTK_VarIndex("mhd_evolve::tau_rad_flux"); \
if(CCTKARGNUM_tau_rad_flux_diag == -1) CCTKARGNUM_tau_rad_flux_diag = CCTK_VarIndex("mhd_evolve::tau_rad_flux_diag"); \
if(CCTKARGNUM_tau_rad_flux_x == -1) CCTKARGNUM_tau_rad_flux_x = CCTK_VarIndex("mhd_evolve::tau_rad_flux_x"); \
if(CCTKARGNUM_tau_rad_nue_flux == -1) CCTKARGNUM_tau_rad_nue_flux = CCTK_VarIndex("mhd_evolve::tau_rad_nue_flux"); \
if(CCTKARGNUM_tau_rad_nux_flux == -1) CCTKARGNUM_tau_rad_nux_flux = CCTK_VarIndex("mhd_evolve::tau_rad_nux_flux"); \
if(CCTKARGNUM_tau_rad_scalar_diag == -1) CCTKARGNUM_tau_rad_scalar_diag = CCTK_VarIndex("mhd_evolve::tau_rad_scalar_diag");

#define MHD_EVOLVE_PRIVATE_C2F_PROTO \
const int *,const int *,const int *,const int *,const int *,const int *,const int *,const int *,const int *,const int *,const int *,const int *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *

#define PASS_MHD_EVOLVE_PRIVATE_C2F(GH) \
PASS_GROUPSIZE(em_fijs, 0),\
PASS_GROUPSIZE(em_ftijs, 0),\
PASS_GROUPSIZE(rad_fijs, 0),\
PASS_GROUPSIZE(rad_fijs_diag, 0),\
PASS_GROUPSIZE(em_fijs, 1),\
PASS_GROUPSIZE(em_ftijs, 1),\
PASS_GROUPSIZE(rad_fijs, 1),\
PASS_GROUPSIZE(rad_fijs_diag, 1),\
PASS_GROUPSIZE(em_fijs, 2),\
PASS_GROUPSIZE(em_ftijs, 2),\
PASS_GROUPSIZE(rad_fijs, 2),\
PASS_GROUPSIZE(rad_fijs_diag, 2),\
(CCTK_REAL *)(PASS_REFERENCE(S_radx_flux, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(S_radx_flux_x, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(S_radx_flux_xp1, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(S_radx_nue_flux, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(S_radx_nux_flux, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(S_rady_flux, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(S_rady_nue_flux, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(S_rady_nux_flux, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(S_radz_flux, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(S_radz_nue_flux, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(S_radz_nux_flux, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(ftxy, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(ftxz, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(ftyx, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(ftyz, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(ftzx, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(ftzy, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(fxy, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(fxz, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(fyx, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(fyz, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(fzx, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(fzy, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(tau_rad_advect_diag, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(tau_rad_flux, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(tau_rad_flux_diag, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(tau_rad_flux_x, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(tau_rad_nue_flux, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(tau_rad_nux_flux, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(tau_rad_scalar_diag, 0))

#endif /* CCODE */

#ifdef FCODE
#define DECLARE_MHD_EVOLVE_PROTECTED_FARGUMENTS \
INTEGER X0BSSN_AH&&\
...
#define MHD_EVOLVE_PROTECTED_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_MHD_EVOLVE_PROTECTED_CARGUMENTS \
...
#define DECLARE_MHD_EVOLVE_PROTECTED_C2F \
...
#define INITIALISE_MHD_EVOLVE_PROTECTED_C2F \
...
#define MHD_EVOLVE_PROTECTED_C2F_PROTO \
...
#define PASS_MHD_EVOLVE_PROTECTED_C2F(GH) \
...
#ifdef FCODE
#define DECLARE_MHD_EVOLVE_PUBLIC_FARGUMENTS \
...
#define DECLARE_MHD_EVOLVE_PUBLIC_C2F \
...
#define INITIALISE_MHD_EVOLVE_PUBLIC_C2F \
...
#ifdef FCODE
#define MHD_EVOLVE_FARGUMENTS _CCTK_FARGUMENTS, MHD_EVOLVE_PRIVATE_FARGUMENTS, MHD_EVOLVE_PROTECTED_FARGUMENTS, MHD_EVOLVE_PUBLIC_FARGUMENTS

#define DECLARE_MHD_EVOLVE_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_MHD_EVOLVE_PRIVATE_FARGUMENTS DECLARE_MHD_EVOLVE_PROTECTED_FARGUMENTS DECLARE_MHD_EVOLVE_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_MHD_EVOLVE_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_MHD_EVOLVE_PRIVATE_CARGUMENTS DECLARE_MHD_EVOLVE_PROTECTED_CARGUMENTS DECLARE_MHD_EVOLVE_PUBLIC_CARGUMENTS

#define MHD_EVOLVE_C2F_PROTO _CCTK_C2F_PROTO, MHD_EVOLVE_PRIVATE_C2F_PROTO, MHD_EVOLVE_PROTECTED_C2F_PROTO, MHD_EVOLVE_PUBLIC_C2F_PROTO

#define PASS_MHD_EVOLVE_C2F(GH) _PASS_CCTK_C2F(GH), PASS_MHD_EVOLVE_PRIVATE_C2F(GH), PASS_MHD_EVOLVE_PROTECTED_C2F(GH), PASS_MHD_EVOLVE_PUBLIC_C2F(GH)

#define DECLARE_MHD_EVOLVE_C2F _DECLARE_CCTK_C2F DECLARE_MHD_EVOLVE_PRIVATE_C2F DECLARE_MHD_EVOLVE_PROTECTED_C2F DECLARE_MHD_EVOLVE_PUBLIC_C2F

#define INITIALISE_MHD_EVOLVE_C2F _INITIALISE_CCTK_C2F INITIALISE_MHD_EVOLVE_PRIVATE_C2F INITIALISE_MHD_EVOLVE_PROTECTED_C2F INITIALISE_MHD_EVOLVE_PUBLIC_C2F

#define MHD_EVOLVE_CARGUMENTS cGH *cctkGH
