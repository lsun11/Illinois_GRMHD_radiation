/*@@
   @header  OS_collapse_Prototypes.h
...
#ifndef _OS_COLLAPSE_PROTOTYPES_H_
#define _OS_COLLAPSE_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_OS_COLLAPSE_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
