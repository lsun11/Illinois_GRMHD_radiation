/*@@
   @header  OS_toy_arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn OS_toy
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_OS_TOY_PRIVATE_FARGUMENTS \
INTEGER X0Tracer&&\
INTEGER X0analytic&&\
...
CCTK_REAL E_anal(X0pcle_stuff)&&\
CCTK_REAL E_rad_gradient(X0pcle_stuff)&&\
CCTK_REAL E_rad_pcle(X0pcle_stuff)&&\
CCTK_REAL Ec_anal(X0pcle_stuff)&&\
CCTK_REAL Ec_pcle(X0pcle_stuff)&&\
CCTK_REAL F_anal(X0pcle_stuff)&&\
CCTK_REAL F_coeff(X0pcle_stuff)&&\
CCTK_REAL F_radx_pcle(X0pcle_stuff)&&\
CCTK_REAL Fc_anal(X0pcle_stuff)&&\
CCTK_REAL Fc_pcle(X0pcle_stuff)&&\
CCTK_REAL OS_rest_mass_integrand(X0mhd_OS_private,X1mhd_OS_private,X2mhd_OS_private)&&\
CCTK_REAL OS_restmass_VolInt&&\
CCTK_REAL P_pcle(X0pcle_stuff)&&\
CCTK_REAL Q(X0pcle_stuff)&&\
CCTK_REAL areal_radius(X0pcle_stuff)&&\
CCTK_REAL coord(X0particle_tracer_coord,X1particle_tracer_coord)&&\
CCTK_REAL coordt(X0particle_tracer_coord,X1particle_tracer_coord)&&\
CCTK_REAL eta(X0pcle_stuff)&&\
CCTK_REAL gxx_pcle(X0pcle_stuff)&&\
CCTK_REAL gxz_pcle(X0pcle_stuff)&&\
CCTK_REAL gzz_pcle(X0pcle_stuff)&&\
CCTK_REAL phi_pcle(X0pcle_stuff)&&\
CCTK_REAL pos(X0more_pcle_stuff,X1more_pcle_stuff)&&\
CCTK_REAL rho_b_anal(X0pcle_stuff)&&\
CCTK_REAL rho_b_analytic(X0analytic,X1analytic,X2analytic)&&\
CCTK_REAL rho_b_pcle(X0pcle_stuff)&&\
CCTK_REAL slope(X0particle_tracer_coord,X1particle_tracer_coord)&&\
CCTK_REAL slopem(X0particle_tracer_coord,X1particle_tracer_coord)&&\
CCTK_REAL slopet(X0particle_tracer_coord,X1particle_tracer_coord)&&\
CCTK_REAL tau_center_OS&&\
CCTK_REAL u0_int(X0Tracer)&&\
CCTK_REAL u0_p(X0v_previous,X1v_previous,X2v_previous)&&\
CCTK_REAL u0_p_int(X0Tracer)&&\
CCTK_REAL u0_pcle(X0pcle_stuff)&&\
CCTK_REAL vx_int(X0Tracer)&&\
CCTK_REAL vx_p(X0v_previous,X1v_previous,X2v_previous)&&\
CCTK_REAL vx_p_int(X0Tracer)&&\
CCTK_REAL vy_int(X0Tracer)&&\
CCTK_REAL vy_p(X0v_previous,X1v_previous,X2v_previous)&&\
CCTK_REAL vy_p_int(X0Tracer)&&\
CCTK_REAL vz_int(X0Tracer)&&\
CCTK_REAL vz_p(X0v_previous,X1v_previous,X2v_previous)&&\
CCTK_REAL vz_p_int(X0Tracer)&&\
CCTK_REAL z_anal(X0pcle_stuff)&&\


#define OS_TOY_PRIVATE_FARGUMENTS \
X0Tracer,X0analytic,X0mhd_OS_private,X0more_pcle_stuff,X0particle_tracer_coord,X0pcle_stuff,X0v_previous,X1analytic,X1mhd_OS_private,X1more_pcle_stuff,X1particle_tracer_coord,X1v_previous,X2analytic,X2mhd_OS_private,X2v_previous,E_anal,E_rad_gradient,E_rad_pcle,Ec_anal,Ec_pcle,F_anal,F_coeff,F_radx_pcle,Fc_anal,Fc_pcle,OS_rest_mass_integrand,OS_restmass_VolInt,P_pcle,Q,areal_radius,coord,coordt,eta,gxx_pcle,gxz_pcle,gzz_pcle,phi_pcle,pos,rho_b_anal,rho_b_analytic,rho_b_pcle,slope,slopem,slopet,tau_center_OS,u0_int,u0_p,u0_p_int,u0_pcle,vx_int,vx_p,vx_p_int,vy_int,vy_p,vy_p_int,vz_int,vz_p,vz_p_int,z_anal

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_OS_TOY_PRIVATE_CARGUMENTS \
CCTK_REAL * CCTK_RESTRICT E_anal = (cctki_dummy_int = &E_anal - &E_anal, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "E_anal")); \
CCTK_REAL * CCTK_RESTRICT E_rad_gradient = (cctki_dummy_int = &E_rad_gradient - &E_rad_gradient, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "E_rad_gradient")); \
CCTK_REAL * CCTK_RESTRICT E_rad_pcle = (cctki_dummy_int = &E_rad_pcle - &E_rad_pcle, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "E_rad_pcle")); \
CCTK_REAL * CCTK_RESTRICT Ec_anal = (cctki_dummy_int = &Ec_anal - &Ec_anal, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "Ec_anal")); \
CCTK_REAL * CCTK_RESTRICT Ec_pcle = (cctki_dummy_int = &Ec_pcle - &Ec_pcle, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "Ec_pcle")); \
CCTK_REAL * CCTK_RESTRICT F_anal = (cctki_dummy_int = &F_anal - &F_anal, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "F_anal")); \
CCTK_REAL * CCTK_RESTRICT F_coeff = (cctki_dummy_int = &F_coeff - &F_coeff, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "F_coeff")); \
CCTK_REAL * CCTK_RESTRICT F_radx_pcle = (cctki_dummy_int = &F_radx_pcle - &F_radx_pcle, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "F_radx_pcle")); \
CCTK_REAL * CCTK_RESTRICT Fc_anal = (cctki_dummy_int = &Fc_anal - &Fc_anal, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "Fc_anal")); \
CCTK_REAL * CCTK_RESTRICT Fc_pcle = (cctki_dummy_int = &Fc_pcle - &Fc_pcle, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "Fc_pcle")); \
CCTK_REAL * CCTK_RESTRICT OS_rest_mass_integrand = (cctki_dummy_int = &OS_rest_mass_integrand - &OS_rest_mass_integrand, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "OS_rest_mass_integrand")); \
CCTK_REAL * CCTK_RESTRICT OS_restmass_VolInt = (cctki_dummy_int = &OS_restmass_VolInt - &OS_restmass_VolInt, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "OS_restmass_VolInt")); \
CCTK_REAL * CCTK_RESTRICT P_pcle = (cctki_dummy_int = &P_pcle - &P_pcle, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "P_pcle")); \
CCTK_REAL * CCTK_RESTRICT Q = (cctki_dummy_int = &Q - &Q, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "Q")); \
CCTK_REAL * CCTK_RESTRICT areal_radius = (cctki_dummy_int = &areal_radius - &areal_radius, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "areal_radius")); \
CCTK_REAL * CCTK_RESTRICT coord = (cctki_dummy_int = &coord - &coord, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "coord")); \
CCTK_REAL * CCTK_RESTRICT coordt = (cctki_dummy_int = &coordt - &coordt, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "coordt")); \
CCTK_REAL * CCTK_RESTRICT eta = (cctki_dummy_int = &eta - &eta, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "eta")); \
CCTK_REAL * CCTK_RESTRICT gxx_pcle = (cctki_dummy_int = &gxx_pcle - &gxx_pcle, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "gxx_pcle")); \
CCTK_REAL * CCTK_RESTRICT gxz_pcle = (cctki_dummy_int = &gxz_pcle - &gxz_pcle, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "gxz_pcle")); \
CCTK_REAL * CCTK_RESTRICT gzz_pcle = (cctki_dummy_int = &gzz_pcle - &gzz_pcle, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "gzz_pcle")); \
CCTK_REAL * CCTK_RESTRICT phi_pcle = (cctki_dummy_int = &phi_pcle - &phi_pcle, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "phi_pcle")); \
CCTK_REAL * CCTK_RESTRICT pos = (cctki_dummy_int = &pos - &pos, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "pos")); \
CCTK_REAL * CCTK_RESTRICT rho_b_anal = (cctki_dummy_int = &rho_b_anal - &rho_b_anal, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "rho_b_anal")); \
CCTK_REAL * CCTK_RESTRICT rho_b_analytic = (cctki_dummy_int = &rho_b_analytic - &rho_b_analytic, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "rho_b_analytic")); \
CCTK_REAL * CCTK_RESTRICT rho_b_pcle = (cctki_dummy_int = &rho_b_pcle - &rho_b_pcle, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "rho_b_pcle")); \
CCTK_REAL * CCTK_RESTRICT slope = (cctki_dummy_int = &slope - &slope, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "slope")); \
CCTK_REAL * CCTK_RESTRICT slopem = (cctki_dummy_int = &slopem - &slopem, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "slopem")); \
CCTK_REAL * CCTK_RESTRICT slopet = (cctki_dummy_int = &slopet - &slopet, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "slopet")); \
CCTK_REAL * CCTK_RESTRICT tau_center_OS = (cctki_dummy_int = &tau_center_OS - &tau_center_OS, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "tau_center_OS")); \
CCTK_REAL * CCTK_RESTRICT u0_int = (cctki_dummy_int = &u0_int - &u0_int, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "u0_int")); \
CCTK_REAL * CCTK_RESTRICT u0_p = (cctki_dummy_int = &u0_p - &u0_p, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "u0_p")); \
CCTK_REAL * CCTK_RESTRICT u0_p_int = (cctki_dummy_int = &u0_p_int - &u0_p_int, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "u0_p_int")); \
CCTK_REAL * CCTK_RESTRICT u0_pcle = (cctki_dummy_int = &u0_pcle - &u0_pcle, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "u0_pcle")); \
CCTK_REAL * CCTK_RESTRICT vx_int = (cctki_dummy_int = &vx_int - &vx_int, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "vx_int")); \
CCTK_REAL * CCTK_RESTRICT vx_p = (cctki_dummy_int = &vx_p - &vx_p, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "vx_p")); \
CCTK_REAL * CCTK_RESTRICT vx_p_int = (cctki_dummy_int = &vx_p_int - &vx_p_int, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "vx_p_int")); \
CCTK_REAL * CCTK_RESTRICT vy_int = (cctki_dummy_int = &vy_int - &vy_int, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "vy_int")); \
CCTK_REAL * CCTK_RESTRICT vy_p = (cctki_dummy_int = &vy_p - &vy_p, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "vy_p")); \
CCTK_REAL * CCTK_RESTRICT vy_p_int = (cctki_dummy_int = &vy_p_int - &vy_p_int, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "vy_p_int")); \
CCTK_REAL * CCTK_RESTRICT vz_int = (cctki_dummy_int = &vz_int - &vz_int, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "vz_int")); \
CCTK_REAL * CCTK_RESTRICT vz_p = (cctki_dummy_int = &vz_p - &vz_p, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "vz_p")); \
CCTK_REAL * CCTK_RESTRICT vz_p_int = (cctki_dummy_int = &vz_p_int - &vz_p_int, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "vz_p_int")); \
CCTK_REAL * CCTK_RESTRICT z_anal = (cctki_dummy_int = &z_anal - &z_anal, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "OS_TOY", "z_anal"));

#define DECLARE_OS_TOY_PRIVATE_C2F \
static int CCTKARGNUM_E_anal = -1; \
static int CCTKGROUPNUM_pcle_stuff = -1; \
static int CCTKARGNUM_E_rad_gradient = -1; \
static int CCTKARGNUM_E_rad_pcle = -1; \
static int CCTKARGNUM_Ec_anal = -1; \
static int CCTKARGNUM_Ec_pcle = -1; \
static int CCTKARGNUM_F_anal = -1; \
static int CCTKARGNUM_F_coeff = -1; \
static int CCTKARGNUM_F_radx_pcle = -1; \
static int CCTKARGNUM_Fc_anal = -1; \
static int CCTKARGNUM_Fc_pcle = -1; \
static int CCTKARGNUM_OS_rest_mass_integrand = -1; \
static int CCTKGROUPNUM_mhd_OS_private = -1; \
static int CCTKARGNUM_OS_restmass_VolInt = -1; \
static int CCTKGROUPNUM_mhd_OS_VolInt = -1; \
static int CCTKARGNUM_P_pcle = -1; \
static int CCTKARGNUM_Q = -1; \
static int CCTKARGNUM_areal_radius = -1; \
static int CCTKARGNUM_coord = -1; \
static int CCTKGROUPNUM_particle_tracer_coord = -1; \
static int CCTKARGNUM_coordt = -1; \
static int CCTKARGNUM_eta = -1; \
static int CCTKARGNUM_gxx_pcle = -1; \
static int CCTKARGNUM_gxz_pcle = -1; \
static int CCTKARGNUM_gzz_pcle = -1; \
static int CCTKARGNUM_phi_pcle = -1; \
static int CCTKARGNUM_pos = -1; \
static int CCTKGROUPNUM_more_pcle_stuff = -1; \
static int CCTKARGNUM_rho_b_anal = -1; \
static int CCTKARGNUM_rho_b_analytic = -1; \
static int CCTKGROUPNUM_analytic = -1; \
static int CCTKARGNUM_rho_b_pcle = -1; \
static int CCTKARGNUM_slope = -1; \
static int CCTKARGNUM_slopem = -1; \
static int CCTKARGNUM_slopet = -1; \
static int CCTKARGNUM_tau_center_OS = -1; \
static int CCTKGROUPNUM_OS_center_diagnostics = -1; \
static int CCTKARGNUM_u0_int = -1; \
static int CCTKGROUPNUM_Tracer = -1; \
static int CCTKARGNUM_u0_p = -1; \
static int CCTKGROUPNUM_v_previous = -1; \
static int CCTKARGNUM_u0_p_int = -1; \
static int CCTKARGNUM_u0_pcle = -1; \
static int CCTKARGNUM_vx_int = -1; \
static int CCTKARGNUM_vx_p = -1; \
static int CCTKARGNUM_vx_p_int = -1; \
static int CCTKARGNUM_vy_int = -1; \
static int CCTKARGNUM_vy_p = -1; \
static int CCTKARGNUM_vy_p_int = -1; \
static int CCTKARGNUM_vz_int = -1; \
static int CCTKARGNUM_vz_p = -1; \
static int CCTKARGNUM_vz_p_int = -1; \
static int CCTKARGNUM_z_anal = -1;

#define INITIALISE_OS_TOY_PRIVATE_C2F \
if(CCTKARGNUM_E_anal == -1) CCTKARGNUM_E_anal = CCTK_VarIndex("OS_toy::E_anal"); \
if(CCTKGROUPNUM_pcle_stuff == -1) CCTKGROUPNUM_pcle_stuff = CCTK_GroupIndex("OS_toy::pcle_stuff"); \
if(CCTKARGNUM_E_rad_gradient == -1) CCTKARGNUM_E_rad_gradient = CCTK_VarIndex("OS_toy::E_rad_gradient"); \
if(CCTKARGNUM_E_rad_pcle == -1) CCTKARGNUM_E_rad_pcle = CCTK_VarIndex("OS_toy::E_rad_pcle"); \
if(CCTKARGNUM_Ec_anal == -1) CCTKARGNUM_Ec_anal = CCTK_VarIndex("OS_toy::Ec_anal"); \
if(CCTKARGNUM_Ec_pcle == -1) CCTKARGNUM_Ec_pcle = CCTK_VarIndex("OS_toy::Ec_pcle"); \
if(CCTKARGNUM_F_anal == -1) CCTKARGNUM_F_anal = CCTK_VarIndex("OS_toy::F_anal"); \
if(CCTKARGNUM_F_coeff == -1) CCTKARGNUM_F_coeff = CCTK_VarIndex("OS_toy::F_coeff"); \
if(CCTKARGNUM_F_radx_pcle == -1) CCTKARGNUM_F_radx_pcle = CCTK_VarIndex("OS_toy::F_radx_pcle"); \
if(CCTKARGNUM_Fc_anal == -1) CCTKARGNUM_Fc_anal = CCTK_VarIndex("OS_toy::Fc_anal"); \
if(CCTKARGNUM_Fc_pcle == -1) CCTKARGNUM_Fc_pcle = CCTK_VarIndex("OS_toy::Fc_pcle"); \
if(CCTKARGNUM_OS_rest_mass_integrand == -1) CCTKARGNUM_OS_rest_mass_integrand = CCTK_VarIndex("OS_toy::OS_rest_mass_integrand"); \
if(CCTKGROUPNUM_mhd_OS_private == -1) CCTKGROUPNUM_mhd_OS_private = CCTK_GroupIndex("OS_toy::mhd_OS_private"); \
if(CCTKARGNUM_OS_restmass_VolInt == -1) CCTKARGNUM_OS_restmass_VolInt = CCTK_VarIndex("OS_toy::OS_restmass_VolInt"); \
if(CCTKGROUPNUM_mhd_OS_VolInt == -1) CCTKGROUPNUM_mhd_OS_VolInt = CCTK_GroupIndex("OS_toy::mhd_OS_VolInt"); \
if(CCTKARGNUM_P_pcle == -1) CCTKARGNUM_P_pcle = CCTK_VarIndex("OS_toy::P_pcle"); \
if(CCTKARGNUM_Q == -1) CCTKARGNUM_Q = CCTK_VarIndex("OS_toy::Q"); \
if(CCTKARGNUM_areal_radius == -1) CCTKARGNUM_areal_radius = CCTK_VarIndex("OS_toy::areal_radius"); \
if(CCTKARGNUM_coord == -1) CCTKARGNUM_coord = CCTK_VarIndex("OS_toy::coord"); \
if(CCTKGROUPNUM_particle_tracer_coord == -1) CCTKGROUPNUM_particle_tracer_coord = CCTK_GroupIndex("OS_toy::particle_tracer_coord"); \
if(CCTKARGNUM_coordt == -1) CCTKARGNUM_coordt = CCTK_VarIndex("OS_toy::coordt"); \
if(CCTKARGNUM_eta == -1) CCTKARGNUM_eta = CCTK_VarIndex("OS_toy::eta"); \
if(CCTKARGNUM_gxx_pcle == -1) CCTKARGNUM_gxx_pcle = CCTK_VarIndex("OS_toy::gxx_pcle"); \
if(CCTKARGNUM_gxz_pcle == -1) CCTKARGNUM_gxz_pcle = CCTK_VarIndex("OS_toy::gxz_pcle"); \
if(CCTKARGNUM_gzz_pcle == -1) CCTKARGNUM_gzz_pcle = CCTK_VarIndex("OS_toy::gzz_pcle"); \
if(CCTKARGNUM_phi_pcle == -1) CCTKARGNUM_phi_pcle = CCTK_VarIndex("OS_toy::phi_pcle"); \
if(CCTKARGNUM_pos == -1) CCTKARGNUM_pos = CCTK_VarIndex("OS_toy::pos"); \
if(CCTKGROUPNUM_more_pcle_stuff == -1) CCTKGROUPNUM_more_pcle_stuff = CCTK_GroupIndex("OS_toy::more_pcle_stuff"); \
if(CCTKARGNUM_rho_b_anal == -1) CCTKARGNUM_rho_b_anal = CCTK_VarIndex("OS_toy::rho_b_anal"); \
if(CCTKARGNUM_rho_b_analytic == -1) CCTKARGNUM_rho_b_analytic = CCTK_VarIndex("OS_toy::rho_b_analytic"); \
if(CCTKGROUPNUM_analytic == -1) CCTKGROUPNUM_analytic = CCTK_GroupIndex("OS_toy::analytic"); \
if(CCTKARGNUM_rho_b_pcle == -1) CCTKARGNUM_rho_b_pcle = CCTK_VarIndex("OS_toy::rho_b_pcle"); \
if(CCTKARGNUM_slope == -1) CCTKARGNUM_slope = CCTK_VarIndex("OS_toy::slope"); \
if(CCTKARGNUM_slopem == -1) CCTKARGNUM_slopem = CCTK_VarIndex("OS_toy::slopem"); \
if(CCTKARGNUM_slopet == -1) CCTKARGNUM_slopet = CCTK_VarIndex("OS_toy::slopet"); \
if(CCTKARGNUM_tau_center_OS == -1) CCTKARGNUM_tau_center_OS = CCTK_VarIndex("OS_toy::tau_center_OS"); \
if(CCTKGROUPNUM_OS_center_diagnostics == -1) CCTKGROUPNUM_OS_center_diagnostics = CCTK_GroupIndex("OS_toy::OS_center_diagnostics"); \
if(CCTKARGNUM_u0_int == -1) CCTKARGNUM_u0_int = CCTK_VarIndex("OS_toy::u0_int"); \
if(CCTKGROUPNUM_Tracer == -1) CCTKGROUPNUM_Tracer = CCTK_GroupIndex("OS_toy::Tracer"); \
if(CCTKARGNUM_u0_p == -1) CCTKARGNUM_u0_p = CCTK_VarIndex("OS_toy::u0_p"); \
if(CCTKGROUPNUM_v_previous == -1) CCTKGROUPNUM_v_previous = CCTK_GroupIndex("OS_toy::v_previous"); \
if(CCTKARGNUM_u0_p_int == -1) CCTKARGNUM_u0_p_int = CCTK_VarIndex("OS_toy::u0_p_int"); \
if(CCTKARGNUM_u0_pcle == -1) CCTKARGNUM_u0_pcle = CCTK_VarIndex("OS_toy::u0_pcle"); \
if(CCTKARGNUM_vx_int == -1) CCTKARGNUM_vx_int = CCTK_VarIndex("OS_toy::vx_int"); \
if(CCTKARGNUM_vx_p == -1) CCTKARGNUM_vx_p = CCTK_VarIndex("OS_toy::vx_p"); \
if(CCTKARGNUM_vx_p_int == -1) CCTKARGNUM_vx_p_int = CCTK_VarIndex("OS_toy::vx_p_int"); \
if(CCTKARGNUM_vy_int == -1) CCTKARGNUM_vy_int = CCTK_VarIndex("OS_toy::vy_int"); \
if(CCTKARGNUM_vy_p == -1) CCTKARGNUM_vy_p = CCTK_VarIndex("OS_toy::vy_p"); \
if(CCTKARGNUM_vy_p_int == -1) CCTKARGNUM_vy_p_int = CCTK_VarIndex("OS_toy::vy_p_int"); \
if(CCTKARGNUM_vz_int == -1) CCTKARGNUM_vz_int = CCTK_VarIndex("OS_toy::vz_int"); \
if(CCTKARGNUM_vz_p == -1) CCTKARGNUM_vz_p = CCTK_VarIndex("OS_toy::vz_p"); \
if(CCTKARGNUM_vz_p_int == -1) CCTKARGNUM_vz_p_int = CCTK_VarIndex("OS_toy::vz_p_int"); \
if(CCTKARGNUM_z_anal == -1) CCTKARGNUM_z_anal = CCTK_VarIndex("OS_toy::z_anal");

#define OS_TOY_PRIVATE_C2F_PROTO \
const int *,const int *,const int *,const int *,const int *,const int *,const int *,const int *,const int *,const int *,const int *,const int *,const int *,const int *,const int *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *

#define PASS_OS_TOY_PRIVATE_C2F(GH) \
PASS_GROUPSIZE(Tracer, 0),\
PASS_GROUPSIZE(analytic, 0),\
PASS_GROUPSIZE(mhd_OS_private, 0),\
PASS_GROUPSIZE(more_pcle_stuff, 0),\
PASS_GROUPSIZE(particle_tracer_coord, 0),\
PASS_GROUPSIZE(pcle_stuff, 0),\
PASS_GROUPSIZE(v_previous, 0),\
PASS_GROUPSIZE(analytic, 1),\
PASS_GROUPSIZE(mhd_OS_private, 1),\
PASS_GROUPSIZE(more_pcle_stuff, 1),\
PASS_GROUPSIZE(particle_tracer_coord, 1),\
PASS_GROUPSIZE(v_previous, 1),\
PASS_GROUPSIZE(analytic, 2),\
PASS_GROUPSIZE(mhd_OS_private, 2),\
PASS_GROUPSIZE(v_previous, 2),\
(CCTK_REAL *)(PASS_REFERENCE(E_anal, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(E_rad_gradient, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(E_rad_pcle, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(Ec_anal, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(Ec_pcle, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(F_anal, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(F_coeff, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(F_radx_pcle, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(Fc_anal, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(Fc_pcle, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(OS_rest_mass_integrand, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(OS_restmass_VolInt, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(P_pcle, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(Q, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(areal_radius, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(coord, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(coordt, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(eta, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(gxx_pcle, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(gxz_pcle, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(gzz_pcle, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(phi_pcle, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(pos, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(rho_b_anal, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(rho_b_analytic, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(rho_b_pcle, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(slope, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(slopem, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(slopet, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(tau_center_OS, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(u0_int, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(u0_p, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(u0_p_int, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(u0_pcle, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(vx_int, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(vx_p, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(vx_p_int, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(vy_int, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(vy_p, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(vy_p_int, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(vz_int, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(vz_p, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(vz_p_int, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(z_anal, 0))

#endif /* CCODE */

#ifdef FCODE
#define DECLARE_OS_TOY_PROTECTED_FARGUMENTS \
INTEGER X0BSSN_AH&&\
...
#define OS_TOY_PROTECTED_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_OS_TOY_PROTECTED_CARGUMENTS \
...
#define DECLARE_OS_TOY_PROTECTED_C2F \
...
#define INITIALISE_OS_TOY_PROTECTED_C2F \
...
#define OS_TOY_PROTECTED_C2F_PROTO \
...
#define PASS_OS_TOY_PROTECTED_C2F(GH) \
...
#ifdef FCODE
#define DECLARE_OS_TOY_PUBLIC_FARGUMENTS \
...
#define DECLARE_OS_TOY_PUBLIC_C2F \
...
#define INITIALISE_OS_TOY_PUBLIC_C2F \
...
#ifdef FCODE
#define OS_TOY_FARGUMENTS _CCTK_FARGUMENTS, OS_TOY_PRIVATE_FARGUMENTS, OS_TOY_PROTECTED_FARGUMENTS, OS_TOY_PUBLIC_FARGUMENTS

#define DECLARE_OS_TOY_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_OS_TOY_PRIVATE_FARGUMENTS DECLARE_OS_TOY_PROTECTED_FARGUMENTS DECLARE_OS_TOY_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_OS_TOY_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_OS_TOY_PRIVATE_CARGUMENTS DECLARE_OS_TOY_PROTECTED_CARGUMENTS DECLARE_OS_TOY_PUBLIC_CARGUMENTS

#define OS_TOY_C2F_PROTO _CCTK_C2F_PROTO, OS_TOY_PRIVATE_C2F_PROTO, OS_TOY_PROTECTED_C2F_PROTO, OS_TOY_PUBLIC_C2F_PROTO

#define PASS_OS_TOY_C2F(GH) _PASS_CCTK_C2F(GH), PASS_OS_TOY_PRIVATE_C2F(GH), PASS_OS_TOY_PROTECTED_C2F(GH), PASS_OS_TOY_PUBLIC_C2F(GH)

#define DECLARE_OS_TOY_C2F _DECLARE_CCTK_C2F DECLARE_OS_TOY_PRIVATE_C2F DECLARE_OS_TOY_PROTECTED_C2F DECLARE_OS_TOY_PUBLIC_C2F

#define INITIALISE_OS_TOY_C2F _INITIALISE_CCTK_C2F INITIALISE_OS_TOY_PRIVATE_C2F INITIALISE_OS_TOY_PROTECTED_C2F INITIALISE_OS_TOY_PUBLIC_C2F

#define OS_TOY_CARGUMENTS cGH *cctkGH
