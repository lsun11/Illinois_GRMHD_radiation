...
INTEGER X1ahmask&&\
INTEGER X2ahmask&&\
CCTK_REAL ahmask(X0ahmask,X1ahmask,X2ahmask)&&\
CCTK_REAL ahmask_p(X0ahmask,X1ahmask,X2ahmask)&&\
CCTK_REAL ahmask_p_p(X0ahmask,X1ahmask,X2ahmask)&&\


#define AHFINDERDIRECT_PRIVATE_FARGUMENTS \
X0ahmask,X1ahmask,X2ahmask,ahmask,ahmask_p,ahmask_p_p

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_AHFINDERDIRECT_PRIVATE_CARGUMENTS \
CCTK_REAL * CCTK_RESTRICT ahmask = (cctki_dummy_int = &ahmask - &ahmask, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "AHFINDERDIRECT", "ahmask")); \
CCTK_REAL * CCTK_RESTRICT ahmask_p = (cctki_dummy_int = &ahmask_p - &ahmask_p, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 1, "AHFINDERDIRECT", "ahmask")); \
CCTK_REAL * CCTK_RESTRICT ahmask_p_p = (cctki_dummy_int = &ahmask_p_p - &ahmask_p_p, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 2, "AHFINDERDIRECT", "ahmask"));
...
PASS_GROUPSIZE(ahmask, 0),\
PASS_GROUPSIZE(ahmask, 1),\
PASS_GROUPSIZE(ahmask, 2),\
...
#ifdef FCODE
#define AHFINDERDIRECT_FARGUMENTS _CCTK_FARGUMENTS, AHFINDERDIRECT_PRIVATE_FARGUMENTS, AHFINDERDIRECT_PROTECTED_FARGUMENTS, AHFINDERDIRECT_PUBLIC_FARGUMENTS

#define DECLARE_AHFINDERDIRECT_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_AHFINDERDIRECT_PRIVATE_FARGUMENTS DECLARE_AHFINDERDIRECT_PROTECTED_FARGUMENTS DECLARE_AHFINDERDIRECT_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_AHFINDERDIRECT_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_AHFINDERDIRECT_PRIVATE_CARGUMENTS DECLARE_AHFINDERDIRECT_PROTECTED_CARGUMENTS DECLARE_AHFINDERDIRECT_PUBLIC_CARGUMENTS

#define AHFINDERDIRECT_C2F_PROTO _CCTK_C2F_PROTO, AHFINDERDIRECT_PRIVATE_C2F_PROTO, AHFINDERDIRECT_PROTECTED_C2F_PROTO, AHFINDERDIRECT_PUBLIC_C2F_PROTO

#define PASS_AHFINDERDIRECT_C2F(GH) _PASS_CCTK_C2F(GH), PASS_AHFINDERDIRECT_PRIVATE_C2F(GH), PASS_AHFINDERDIRECT_PROTECTED_C2F(GH), PASS_AHFINDERDIRECT_PUBLIC_C2F(GH)

#define DECLARE_AHFINDERDIRECT_C2F _DECLARE_CCTK_C2F DECLARE_AHFINDERDIRECT_PRIVATE_C2F DECLARE_AHFINDERDIRECT_PROTECTED_C2F DECLARE_AHFINDERDIRECT_PUBLIC_C2F

#define INITIALISE_AHFINDERDIRECT_C2F _INITIALISE_CCTK_C2F INITIALISE_AHFINDERDIRECT_PRIVATE_C2F INITIALISE_AHFINDERDIRECT_PROTECTED_C2F INITIALISE_AHFINDERDIRECT_PUBLIC_C2F
