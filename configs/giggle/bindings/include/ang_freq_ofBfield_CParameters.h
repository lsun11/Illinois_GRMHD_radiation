/*@@
   @header  ang_freq_ofBfield_CParameters.h
   @author  Automatically generated by CreateParameterBindings.pl
   @desc
            Declares parameters of thorn ang_freq_ofBfield
   @enddesc
 @@*/


#ifndef _ANG_FREQ_OFBFIELD_PARAMETERS_H_
#define _ANG_FREQ_OFBFIELD_PARAMETERS_H_ 1

#include "ParameterCGlobal.h"
#include "ParameterCPrivateANG_FREQ_OFBFIELD.h"
...
#define DECLARE_CCTK_PARAMETERS \
  ...
  DECLARE_PRIVATE_ANG_FREQ_OFBFIELD_STRUCT_PARAMS \
...
#endif  /* _ANG_FREQ_OFBFIELD_PARAMETERS_H_ */
