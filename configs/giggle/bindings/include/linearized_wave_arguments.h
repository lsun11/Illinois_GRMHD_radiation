/*@@
   @header  linearized_wave_arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn linearized_wave
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_LINEARIZED_WAVE_PRIVATE_FARGUMENTS \
INTEGER X0linearized_wave_analytic&&\
INTEGER X1linearized_wave_analytic&&\
INTEGER X2linearized_wave_analytic&&\
CCTK_REAL Kxx_analy(X0linearized_wave_analytic,X1linearized_wave_analytic,X2linearized_wave_analytic)&&\
CCTK_REAL Kxy_analy(X0linearized_wave_analytic,X1linearized_wave_analytic,X2linearized_wave_analytic)&&\
CCTK_REAL Kxz_analy(X0linearized_wave_analytic,X1linearized_wave_analytic,X2linearized_wave_analytic)&&\
CCTK_REAL Kyy_analy(X0linearized_wave_analytic,X1linearized_wave_analytic,X2linearized_wave_analytic)&&\
CCTK_REAL Kyz_analy(X0linearized_wave_analytic,X1linearized_wave_analytic,X2linearized_wave_analytic)&&\
CCTK_REAL Kzz_analy(X0linearized_wave_analytic,X1linearized_wave_analytic,X2linearized_wave_analytic)&&\
CCTK_REAL gxx_analy(X0linearized_wave_analytic,X1linearized_wave_analytic,X2linearized_wave_analytic)&&\
CCTK_REAL gxy_analy(X0linearized_wave_analytic,X1linearized_wave_analytic,X2linearized_wave_analytic)&&\
CCTK_REAL gxz_analy(X0linearized_wave_analytic,X1linearized_wave_analytic,X2linearized_wave_analytic)&&\
CCTK_REAL gyy_analy(X0linearized_wave_analytic,X1linearized_wave_analytic,X2linearized_wave_analytic)&&\
CCTK_REAL gyz_analy(X0linearized_wave_analytic,X1linearized_wave_analytic,X2linearized_wave_analytic)&&\
CCTK_REAL gzz_analy(X0linearized_wave_analytic,X1linearized_wave_analytic,X2linearized_wave_analytic)&&\


#define LINEARIZED_WAVE_PRIVATE_FARGUMENTS \
X0linearized_wave_analytic,X1linearized_wave_analytic,X2linearized_wave_analytic,Kxx_analy,Kxy_analy,Kxz_analy,Kyy_analy,Kyz_analy,Kzz_analy,gxx_analy,gxy_analy,gxz_analy,gyy_analy,gyz_analy,gzz_analy

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_LINEARIZED_WAVE_PRIVATE_CARGUMENTS \
CCTK_REAL * CCTK_RESTRICT Kxx_analy = (cctki_dummy_int = &Kxx_analy - &Kxx_analy, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "LINEARIZED_WAVE", "Kxx_analy")); \
CCTK_REAL * CCTK_RESTRICT Kxy_analy = (cctki_dummy_int = &Kxy_analy - &Kxy_analy, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "LINEARIZED_WAVE", "Kxy_analy")); \
CCTK_REAL * CCTK_RESTRICT Kxz_analy = (cctki_dummy_int = &Kxz_analy - &Kxz_analy, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "LINEARIZED_WAVE", "Kxz_analy")); \
CCTK_REAL * CCTK_RESTRICT Kyy_analy = (cctki_dummy_int = &Kyy_analy - &Kyy_analy, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "LINEARIZED_WAVE", "Kyy_analy")); \
CCTK_REAL * CCTK_RESTRICT Kyz_analy = (cctki_dummy_int = &Kyz_analy - &Kyz_analy, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "LINEARIZED_WAVE", "Kyz_analy")); \
CCTK_REAL * CCTK_RESTRICT Kzz_analy = (cctki_dummy_int = &Kzz_analy - &Kzz_analy, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "LINEARIZED_WAVE", "Kzz_analy")); \
CCTK_REAL * CCTK_RESTRICT gxx_analy = (cctki_dummy_int = &gxx_analy - &gxx_analy, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "LINEARIZED_WAVE", "gxx_analy")); \
CCTK_REAL * CCTK_RESTRICT gxy_analy = (cctki_dummy_int = &gxy_analy - &gxy_analy, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "LINEARIZED_WAVE", "gxy_analy")); \
CCTK_REAL * CCTK_RESTRICT gxz_analy = (cctki_dummy_int = &gxz_analy - &gxz_analy, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "LINEARIZED_WAVE", "gxz_analy")); \
CCTK_REAL * CCTK_RESTRICT gyy_analy = (cctki_dummy_int = &gyy_analy - &gyy_analy, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "LINEARIZED_WAVE", "gyy_analy")); \
CCTK_REAL * CCTK_RESTRICT gyz_analy = (cctki_dummy_int = &gyz_analy - &gyz_analy, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "LINEARIZED_WAVE", "gyz_analy")); \
CCTK_REAL * CCTK_RESTRICT gzz_analy = (cctki_dummy_int = &gzz_analy - &gzz_analy, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "LINEARIZED_WAVE", "gzz_analy"));

#define DECLARE_LINEARIZED_WAVE_PRIVATE_C2F \
static int CCTKARGNUM_Kxx_analy = -1; \
static int CCTKGROUPNUM_linearized_wave_analytic = -1; \
static int CCTKARGNUM_Kxy_analy = -1; \
static int CCTKARGNUM_Kxz_analy = -1; \
static int CCTKARGNUM_Kyy_analy = -1; \
static int CCTKARGNUM_Kyz_analy = -1; \
static int CCTKARGNUM_Kzz_analy = -1; \
static int CCTKARGNUM_gxx_analy = -1; \
static int CCTKARGNUM_gxy_analy = -1; \
static int CCTKARGNUM_gxz_analy = -1; \
static int CCTKARGNUM_gyy_analy = -1; \
static int CCTKARGNUM_gyz_analy = -1; \
static int CCTKARGNUM_gzz_analy = -1;

#define INITIALISE_LINEARIZED_WAVE_PRIVATE_C2F \
if(CCTKARGNUM_Kxx_analy == -1) CCTKARGNUM_Kxx_analy = CCTK_VarIndex("linearized_wave::Kxx_analy"); \
if(CCTKGROUPNUM_linearized_wave_analytic == -1) CCTKGROUPNUM_linearized_wave_analytic = CCTK_GroupIndex("linearized_wave::linearized_wave_analytic"); \
if(CCTKARGNUM_Kxy_analy == -1) CCTKARGNUM_Kxy_analy = CCTK_VarIndex("linearized_wave::Kxy_analy"); \
if(CCTKARGNUM_Kxz_analy == -1) CCTKARGNUM_Kxz_analy = CCTK_VarIndex("linearized_wave::Kxz_analy"); \
if(CCTKARGNUM_Kyy_analy == -1) CCTKARGNUM_Kyy_analy = CCTK_VarIndex("linearized_wave::Kyy_analy"); \
if(CCTKARGNUM_Kyz_analy == -1) CCTKARGNUM_Kyz_analy = CCTK_VarIndex("linearized_wave::Kyz_analy"); \
if(CCTKARGNUM_Kzz_analy == -1) CCTKARGNUM_Kzz_analy = CCTK_VarIndex("linearized_wave::Kzz_analy"); \
if(CCTKARGNUM_gxx_analy == -1) CCTKARGNUM_gxx_analy = CCTK_VarIndex("linearized_wave::gxx_analy"); \
if(CCTKARGNUM_gxy_analy == -1) CCTKARGNUM_gxy_analy = CCTK_VarIndex("linearized_wave::gxy_analy"); \
if(CCTKARGNUM_gxz_analy == -1) CCTKARGNUM_gxz_analy = CCTK_VarIndex("linearized_wave::gxz_analy"); \
if(CCTKARGNUM_gyy_analy == -1) CCTKARGNUM_gyy_analy = CCTK_VarIndex("linearized_wave::gyy_analy"); \
if(CCTKARGNUM_gyz_analy == -1) CCTKARGNUM_gyz_analy = CCTK_VarIndex("linearized_wave::gyz_analy"); \
if(CCTKARGNUM_gzz_analy == -1) CCTKARGNUM_gzz_analy = CCTK_VarIndex("linearized_wave::gzz_analy");

#define LINEARIZED_WAVE_PRIVATE_C2F_PROTO \
...
#define PASS_LINEARIZED_WAVE_PRIVATE_C2F(GH) \
PASS_GROUPSIZE(linearized_wave_analytic, 0),\
PASS_GROUPSIZE(linearized_wave_analytic, 1),\
PASS_GROUPSIZE(linearized_wave_analytic, 2),\
(CCTK_REAL *)(PASS_REFERENCE(Kxx_analy, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(Kxy_analy, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(Kxz_analy, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(Kyy_analy, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(Kyz_analy, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(Kzz_analy, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(gxx_analy, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(gxy_analy, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(gxz_analy, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(gyy_analy, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(gyz_analy, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(gzz_analy, 0))

#endif /* CCODE */

#ifdef FCODE
#define DECLARE_LINEARIZED_WAVE_PROTECTED_FARGUMENTS \
INTEGER X0BSSN_AH&&\
...
#define LINEARIZED_WAVE_PROTECTED_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_LINEARIZED_WAVE_PROTECTED_CARGUMENTS \
...
#define DECLARE_LINEARIZED_WAVE_PROTECTED_C2F \
...
#define INITIALISE_LINEARIZED_WAVE_PROTECTED_C2F \
...
#define LINEARIZED_WAVE_PROTECTED_C2F_PROTO \
...
#define PASS_LINEARIZED_WAVE_PROTECTED_C2F(GH) \
...
#ifdef FCODE
#define DECLARE_LINEARIZED_WAVE_PUBLIC_FARGUMENTS \
...
#define LINEARIZED_WAVE_PUBLIC_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_LINEARIZED_WAVE_PUBLIC_CARGUMENTS \
...
#define DECLARE_LINEARIZED_WAVE_PUBLIC_C2F \
...
#define INITIALISE_LINEARIZED_WAVE_PUBLIC_C2F \
...
#define LINEARIZED_WAVE_PUBLIC_C2F_PROTO \
...
#define PASS_LINEARIZED_WAVE_PUBLIC_C2F(GH) \
...
#ifdef FCODE
#define LINEARIZED_WAVE_FARGUMENTS _CCTK_FARGUMENTS, LINEARIZED_WAVE_PRIVATE_FARGUMENTS, LINEARIZED_WAVE_PROTECTED_FARGUMENTS, LINEARIZED_WAVE_PUBLIC_FARGUMENTS

#define DECLARE_LINEARIZED_WAVE_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_LINEARIZED_WAVE_PRIVATE_FARGUMENTS DECLARE_LINEARIZED_WAVE_PROTECTED_FARGUMENTS DECLARE_LINEARIZED_WAVE_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_LINEARIZED_WAVE_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_LINEARIZED_WAVE_PRIVATE_CARGUMENTS DECLARE_LINEARIZED_WAVE_PROTECTED_CARGUMENTS DECLARE_LINEARIZED_WAVE_PUBLIC_CARGUMENTS

#define LINEARIZED_WAVE_C2F_PROTO _CCTK_C2F_PROTO, LINEARIZED_WAVE_PRIVATE_C2F_PROTO, LINEARIZED_WAVE_PROTECTED_C2F_PROTO, LINEARIZED_WAVE_PUBLIC_C2F_PROTO

#define PASS_LINEARIZED_WAVE_C2F(GH) _PASS_CCTK_C2F(GH), PASS_LINEARIZED_WAVE_PRIVATE_C2F(GH), PASS_LINEARIZED_WAVE_PROTECTED_C2F(GH), PASS_LINEARIZED_WAVE_PUBLIC_C2F(GH)

#define DECLARE_LINEARIZED_WAVE_C2F _DECLARE_CCTK_C2F DECLARE_LINEARIZED_WAVE_PRIVATE_C2F DECLARE_LINEARIZED_WAVE_PROTECTED_C2F DECLARE_LINEARIZED_WAVE_PUBLIC_C2F

#define INITIALISE_LINEARIZED_WAVE_C2F _INITIALISE_CCTK_C2F INITIALISE_LINEARIZED_WAVE_PRIVATE_C2F INITIALISE_LINEARIZED_WAVE_PROTECTED_C2F INITIALISE_LINEARIZED_WAVE_PUBLIC_C2F

#define LINEARIZED_WAVE_CARGUMENTS cGH *cctkGH
