/*@@
   @header  disk_powerlaw_arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn disk_powerlaw
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_DISK_POWERLAW_PRIVATE_FARGUMENTS \
INTEGER X0disk_powerlaw_last_data&&\
CCTK_REAL ah1_radii_last_disk_powerlaw(X0disk_powerlaw_last_data)&&\
CCTK_REAL ah2_radii_last_disk_powerlaw(X0disk_powerlaw_last_data)&&\
CCTK_REAL ah3_radii_last_disk_powerlaw(X0disk_powerlaw_last_data)&&\
CCTK_REAL surf1_radii_last_disk_powerlaw(X0disk_powerlaw_last_data)&&\
CCTK_REAL surf2_radii_last_disk_powerlaw(X0disk_powerlaw_last_data)&&\
CCTK_REAL surf3_radii_last_disk_powerlaw(X0disk_powerlaw_last_data)&&\
CCTK_REAL surf4_radii_last_disk_powerlaw(X0disk_powerlaw_last_data)&&\
CCTK_REAL t_last_disk_powerlaw&&\
CCTK_REAL xh1_last_disk_powerlaw&&\
CCTK_REAL xh2_last_disk_powerlaw&&\
CCTK_REAL xh3_last_disk_powerlaw&&\
CCTK_REAL yh1_last_disk_powerlaw&&\
CCTK_REAL yh2_last_disk_powerlaw&&\
CCTK_REAL yh3_last_disk_powerlaw&&\
CCTK_REAL zh1_last_disk_powerlaw&&\
CCTK_REAL zh2_last_disk_powerlaw&&\
CCTK_REAL zh3_last_disk_powerlaw&&\


#define DISK_POWERLAW_PRIVATE_FARGUMENTS \
X0disk_powerlaw_last_data,ah1_radii_last_disk_powerlaw,ah2_radii_last_disk_powerlaw,ah3_radii_last_disk_powerlaw,surf1_radii_last_disk_powerlaw,surf2_radii_last_disk_powerlaw,surf3_radii_last_disk_powerlaw,surf4_radii_last_disk_powerlaw,t_last_disk_powerlaw,xh1_last_disk_powerlaw,xh2_last_disk_powerlaw,xh3_last_disk_powerlaw,yh1_last_disk_powerlaw,yh2_last_disk_powerlaw,yh3_last_disk_powerlaw,zh1_last_disk_powerlaw,zh2_last_disk_powerlaw,zh3_last_disk_powerlaw

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_DISK_POWERLAW_PRIVATE_CARGUMENTS \
CCTK_REAL * CCTK_RESTRICT ah1_radii_last_disk_powerlaw = (cctki_dummy_int = &ah1_radii_last_disk_powerlaw - &ah1_radii_last_disk_powerlaw, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "DISK_POWERLAW", "ah1_radii_last_disk_powerlaw")); \
CCTK_REAL * CCTK_RESTRICT ah2_radii_last_disk_powerlaw = (cctki_dummy_int = &ah2_radii_last_disk_powerlaw - &ah2_radii_last_disk_powerlaw, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "DISK_POWERLAW", "ah2_radii_last_disk_powerlaw")); \
CCTK_REAL * CCTK_RESTRICT ah3_radii_last_disk_powerlaw = (cctki_dummy_int = &ah3_radii_last_disk_powerlaw - &ah3_radii_last_disk_powerlaw, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "DISK_POWERLAW", "ah3_radii_last_disk_powerlaw")); \
CCTK_REAL * CCTK_RESTRICT surf1_radii_last_disk_powerlaw = (cctki_dummy_int = &surf1_radii_last_disk_powerlaw - &surf1_radii_last_disk_powerlaw, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "DISK_POWERLAW", "surf1_radii_last_disk_powerlaw")); \
CCTK_REAL * CCTK_RESTRICT surf2_radii_last_disk_powerlaw = (cctki_dummy_int = &surf2_radii_last_disk_powerlaw - &surf2_radii_last_disk_powerlaw, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "DISK_POWERLAW", "surf2_radii_last_disk_powerlaw")); \
CCTK_REAL * CCTK_RESTRICT surf3_radii_last_disk_powerlaw = (cctki_dummy_int = &surf3_radii_last_disk_powerlaw - &surf3_radii_last_disk_powerlaw, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "DISK_POWERLAW", "surf3_radii_last_disk_powerlaw")); \
CCTK_REAL * CCTK_RESTRICT surf4_radii_last_disk_powerlaw = (cctki_dummy_int = &surf4_radii_last_disk_powerlaw - &surf4_radii_last_disk_powerlaw, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "DISK_POWERLAW", "surf4_radii_last_disk_powerlaw")); \
CCTK_REAL * CCTK_RESTRICT t_last_disk_powerlaw = (cctki_dummy_int = &t_last_disk_powerlaw - &t_last_disk_powerlaw, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "DISK_POWERLAW", "t_last_disk_powerlaw")); \
CCTK_REAL * CCTK_RESTRICT xh1_last_disk_powerlaw = (cctki_dummy_int = &xh1_last_disk_powerlaw - &xh1_last_disk_powerlaw, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "DISK_POWERLAW", "xh1_last_disk_powerlaw")); \
CCTK_REAL * CCTK_RESTRICT xh2_last_disk_powerlaw = (cctki_dummy_int = &xh2_last_disk_powerlaw - &xh2_last_disk_powerlaw, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "DISK_POWERLAW", "xh2_last_disk_powerlaw")); \
CCTK_REAL * CCTK_RESTRICT xh3_last_disk_powerlaw = (cctki_dummy_int = &xh3_last_disk_powerlaw - &xh3_last_disk_powerlaw, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "DISK_POWERLAW", "xh3_last_disk_powerlaw")); \
CCTK_REAL * CCTK_RESTRICT yh1_last_disk_powerlaw = (cctki_dummy_int = &yh1_last_disk_powerlaw - &yh1_last_disk_powerlaw, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "DISK_POWERLAW", "yh1_last_disk_powerlaw")); \
CCTK_REAL * CCTK_RESTRICT yh2_last_disk_powerlaw = (cctki_dummy_int = &yh2_last_disk_powerlaw - &yh2_last_disk_powerlaw, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "DISK_POWERLAW", "yh2_last_disk_powerlaw")); \
CCTK_REAL * CCTK_RESTRICT yh3_last_disk_powerlaw = (cctki_dummy_int = &yh3_last_disk_powerlaw - &yh3_last_disk_powerlaw, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "DISK_POWERLAW", "yh3_last_disk_powerlaw")); \
CCTK_REAL * CCTK_RESTRICT zh1_last_disk_powerlaw = (cctki_dummy_int = &zh1_last_disk_powerlaw - &zh1_last_disk_powerlaw, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "DISK_POWERLAW", "zh1_last_disk_powerlaw")); \
CCTK_REAL * CCTK_RESTRICT zh2_last_disk_powerlaw = (cctki_dummy_int = &zh2_last_disk_powerlaw - &zh2_last_disk_powerlaw, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "DISK_POWERLAW", "zh2_last_disk_powerlaw")); \
CCTK_REAL * CCTK_RESTRICT zh3_last_disk_powerlaw = (cctki_dummy_int = &zh3_last_disk_powerlaw - &zh3_last_disk_powerlaw, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "DISK_POWERLAW", "zh3_last_disk_powerlaw"));

#define DECLARE_DISK_POWERLAW_PRIVATE_C2F \
static int CCTKARGNUM_ah1_radii_last_disk_powerlaw = -1; \
static int CCTKGROUPNUM_disk_powerlaw_last_data = -1; \
static int CCTKARGNUM_ah2_radii_last_disk_powerlaw = -1; \
static int CCTKARGNUM_ah3_radii_last_disk_powerlaw = -1; \
static int CCTKARGNUM_surf1_radii_last_disk_powerlaw = -1; \
static int CCTKARGNUM_surf2_radii_last_disk_powerlaw = -1; \
static int CCTKARGNUM_surf3_radii_last_disk_powerlaw = -1; \
static int CCTKARGNUM_surf4_radii_last_disk_powerlaw = -1; \
static int CCTKARGNUM_t_last_disk_powerlaw = -1; \
static int CCTKGROUPNUM_disk_powerlaw_M0dot_BH = -1; \
static int CCTKARGNUM_xh1_last_disk_powerlaw = -1; \
static int CCTKARGNUM_xh2_last_disk_powerlaw = -1; \
static int CCTKARGNUM_xh3_last_disk_powerlaw = -1; \
static int CCTKARGNUM_yh1_last_disk_powerlaw = -1; \
static int CCTKARGNUM_yh2_last_disk_powerlaw = -1; \
static int CCTKARGNUM_yh3_last_disk_powerlaw = -1; \
static int CCTKARGNUM_zh1_last_disk_powerlaw = -1; \
static int CCTKARGNUM_zh2_last_disk_powerlaw = -1; \
static int CCTKARGNUM_zh3_last_disk_powerlaw = -1;

#define INITIALISE_DISK_POWERLAW_PRIVATE_C2F \
if(CCTKARGNUM_ah1_radii_last_disk_powerlaw == -1) CCTKARGNUM_ah1_radii_last_disk_powerlaw = CCTK_VarIndex("disk_powerlaw::ah1_radii_last_disk_powerlaw"); \
if(CCTKGROUPNUM_disk_powerlaw_last_data == -1) CCTKGROUPNUM_disk_powerlaw_last_data = CCTK_GroupIndex("disk_powerlaw::disk_powerlaw_last_data"); \
if(CCTKARGNUM_ah2_radii_last_disk_powerlaw == -1) CCTKARGNUM_ah2_radii_last_disk_powerlaw = CCTK_VarIndex("disk_powerlaw::ah2_radii_last_disk_powerlaw"); \
if(CCTKARGNUM_ah3_radii_last_disk_powerlaw == -1) CCTKARGNUM_ah3_radii_last_disk_powerlaw = CCTK_VarIndex("disk_powerlaw::ah3_radii_last_disk_powerlaw"); \
if(CCTKARGNUM_surf1_radii_last_disk_powerlaw == -1) CCTKARGNUM_surf1_radii_last_disk_powerlaw = CCTK_VarIndex("disk_powerlaw::surf1_radii_last_disk_powerlaw"); \
if(CCTKARGNUM_surf2_radii_last_disk_powerlaw == -1) CCTKARGNUM_surf2_radii_last_disk_powerlaw = CCTK_VarIndex("disk_powerlaw::surf2_radii_last_disk_powerlaw"); \
if(CCTKARGNUM_surf3_radii_last_disk_powerlaw == -1) CCTKARGNUM_surf3_radii_last_disk_powerlaw = CCTK_VarIndex("disk_powerlaw::surf3_radii_last_disk_powerlaw"); \
if(CCTKARGNUM_surf4_radii_last_disk_powerlaw == -1) CCTKARGNUM_surf4_radii_last_disk_powerlaw = CCTK_VarIndex("disk_powerlaw::surf4_radii_last_disk_powerlaw"); \
if(CCTKARGNUM_t_last_disk_powerlaw == -1) CCTKARGNUM_t_last_disk_powerlaw = CCTK_VarIndex("disk_powerlaw::t_last_disk_powerlaw"); \
if(CCTKGROUPNUM_disk_powerlaw_M0dot_BH == -1) CCTKGROUPNUM_disk_powerlaw_M0dot_BH = CCTK_GroupIndex("disk_powerlaw::disk_powerlaw_M0dot_BH"); \
if(CCTKARGNUM_xh1_last_disk_powerlaw == -1) CCTKARGNUM_xh1_last_disk_powerlaw = CCTK_VarIndex("disk_powerlaw::xh1_last_disk_powerlaw"); \
if(CCTKARGNUM_xh2_last_disk_powerlaw == -1) CCTKARGNUM_xh2_last_disk_powerlaw = CCTK_VarIndex("disk_powerlaw::xh2_last_disk_powerlaw"); \
if(CCTKARGNUM_xh3_last_disk_powerlaw == -1) CCTKARGNUM_xh3_last_disk_powerlaw = CCTK_VarIndex("disk_powerlaw::xh3_last_disk_powerlaw"); \
if(CCTKARGNUM_yh1_last_disk_powerlaw == -1) CCTKARGNUM_yh1_last_disk_powerlaw = CCTK_VarIndex("disk_powerlaw::yh1_last_disk_powerlaw"); \
if(CCTKARGNUM_yh2_last_disk_powerlaw == -1) CCTKARGNUM_yh2_last_disk_powerlaw = CCTK_VarIndex("disk_powerlaw::yh2_last_disk_powerlaw"); \
if(CCTKARGNUM_yh3_last_disk_powerlaw == -1) CCTKARGNUM_yh3_last_disk_powerlaw = CCTK_VarIndex("disk_powerlaw::yh3_last_disk_powerlaw"); \
if(CCTKARGNUM_zh1_last_disk_powerlaw == -1) CCTKARGNUM_zh1_last_disk_powerlaw = CCTK_VarIndex("disk_powerlaw::zh1_last_disk_powerlaw"); \
if(CCTKARGNUM_zh2_last_disk_powerlaw == -1) CCTKARGNUM_zh2_last_disk_powerlaw = CCTK_VarIndex("disk_powerlaw::zh2_last_disk_powerlaw"); \
if(CCTKARGNUM_zh3_last_disk_powerlaw == -1) CCTKARGNUM_zh3_last_disk_powerlaw = CCTK_VarIndex("disk_powerlaw::zh3_last_disk_powerlaw");

#define DISK_POWERLAW_PRIVATE_C2F_PROTO \
const int *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *

#define PASS_DISK_POWERLAW_PRIVATE_C2F(GH) \
PASS_GROUPSIZE(disk_powerlaw_last_data, 0),\
(CCTK_REAL *)(PASS_REFERENCE(ah1_radii_last_disk_powerlaw, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(ah2_radii_last_disk_powerlaw, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(ah3_radii_last_disk_powerlaw, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(surf1_radii_last_disk_powerlaw, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(surf2_radii_last_disk_powerlaw, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(surf3_radii_last_disk_powerlaw, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(surf4_radii_last_disk_powerlaw, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(t_last_disk_powerlaw, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(xh1_last_disk_powerlaw, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(xh2_last_disk_powerlaw, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(xh3_last_disk_powerlaw, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(yh1_last_disk_powerlaw, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(yh2_last_disk_powerlaw, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(yh3_last_disk_powerlaw, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(zh1_last_disk_powerlaw, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(zh2_last_disk_powerlaw, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(zh3_last_disk_powerlaw, 0))

#endif /* CCODE */

#ifdef FCODE
#define DECLARE_DISK_POWERLAW_PROTECTED_FARGUMENTS \
INTEGER X0BSSN_AH&&\
...
#define DISK_POWERLAW_PROTECTED_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_DISK_POWERLAW_PROTECTED_CARGUMENTS \
...
#define DECLARE_DISK_POWERLAW_PROTECTED_C2F \
...
#define INITIALISE_DISK_POWERLAW_PROTECTED_C2F \
...
#define DISK_POWERLAW_PROTECTED_C2F_PROTO \
...
#define PASS_DISK_POWERLAW_PROTECTED_C2F(GH) \
...
#ifdef FCODE
#define DECLARE_DISK_POWERLAW_PUBLIC_FARGUMENTS \
...
#define DISK_POWERLAW_PUBLIC_FARGUMENTS \
X0coordinates,X1coordinates,X2coordinates,coarse_dx,coarse_dy,coarse_dz,r,x,y,z

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_DISK_POWERLAW_PUBLIC_CARGUMENTS \
...
#define DECLARE_DISK_POWERLAW_PUBLIC_C2F \
...
#define INITIALISE_DISK_POWERLAW_PUBLIC_C2F \
...
#ifdef FCODE
#define DISK_POWERLAW_FARGUMENTS _CCTK_FARGUMENTS, DISK_POWERLAW_PRIVATE_FARGUMENTS, DISK_POWERLAW_PROTECTED_FARGUMENTS, DISK_POWERLAW_PUBLIC_FARGUMENTS

#define DECLARE_DISK_POWERLAW_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_DISK_POWERLAW_PRIVATE_FARGUMENTS DECLARE_DISK_POWERLAW_PROTECTED_FARGUMENTS DECLARE_DISK_POWERLAW_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_DISK_POWERLAW_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_DISK_POWERLAW_PRIVATE_CARGUMENTS DECLARE_DISK_POWERLAW_PROTECTED_CARGUMENTS DECLARE_DISK_POWERLAW_PUBLIC_CARGUMENTS

#define DISK_POWERLAW_C2F_PROTO _CCTK_C2F_PROTO, DISK_POWERLAW_PRIVATE_C2F_PROTO, DISK_POWERLAW_PROTECTED_C2F_PROTO, DISK_POWERLAW_PUBLIC_C2F_PROTO

#define PASS_DISK_POWERLAW_C2F(GH) _PASS_CCTK_C2F(GH), PASS_DISK_POWERLAW_PRIVATE_C2F(GH), PASS_DISK_POWERLAW_PROTECTED_C2F(GH), PASS_DISK_POWERLAW_PUBLIC_C2F(GH)

#define DECLARE_DISK_POWERLAW_C2F _DECLARE_CCTK_C2F DECLARE_DISK_POWERLAW_PRIVATE_C2F DECLARE_DISK_POWERLAW_PROTECTED_C2F DECLARE_DISK_POWERLAW_PUBLIC_C2F

#define INITIALISE_DISK_POWERLAW_C2F _INITIALISE_CCTK_C2F INITIALISE_DISK_POWERLAW_PRIVATE_C2F INITIALISE_DISK_POWERLAW_PROTECTED_C2F INITIALISE_DISK_POWERLAW_PUBLIC_C2F

#define DISK_POWERLAW_CARGUMENTS cGH *cctkGH
