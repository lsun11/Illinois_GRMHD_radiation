/*@@
   @header  scalarwaveMoL_Prototypes.h
...
#ifndef _SCALARWAVEMOL_PROTOTYPES_H_
#define _SCALARWAVEMOL_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_SCALARWAVEMOL_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
