/*@@
   @header  CarpetReduce_Prototypes.h
...
#ifndef _CARPETREDUCE_PROTOTYPES_H_
#define _CARPETREDUCE_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_CARPETREDUCE_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
