/*@@
   @header  CarpetInterp_Prototypes.h
...
#ifndef _CARPETINTERP_PROTOTYPES_H_
#define _CARPETINTERP_PROTOTYPES_H_  1
...
CCTK_INT Carpet_DriverInterpolate(const CCTK_POINTER_TO_CONST cctkGH ,
 const CCTK_INT N_dims ,
 const CCTK_INT local_interp_handle ,
 const CCTK_INT param_table_handle ,
 const CCTK_INT coord_system_handle ,
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_CARPETINTERP_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
