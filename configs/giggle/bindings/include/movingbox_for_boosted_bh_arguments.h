/*@@
   @header  movingbox_for_boosted_bh_arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn movingbox_for_boosted_bh
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_MOVINGBOX_FOR_BOOSTED_BH_PRIVATE_FARGUMENTS \
INTEGER X0tmp_gfs&&\
INTEGER X1tmp_gfs&&\
INTEGER X2tmp_gfs&&\
CCTK_INT find_max_phi&&\
CCTK_REAL max_phi&&\
CCTK_REAL temp0(X0tmp_gfs,X1tmp_gfs,X2tmp_gfs)&&\
CCTK_REAL tempx(X0tmp_gfs,X1tmp_gfs,X2tmp_gfs)&&\
CCTK_REAL tempy(X0tmp_gfs,X1tmp_gfs,X2tmp_gfs)&&\
CCTK_REAL xc_prev&&\
CCTK_REAL yc_prev&&\
CCTK_REAL zc_prev&&\


#define MOVINGBOX_FOR_BOOSTED_BH_PRIVATE_FARGUMENTS \
X0tmp_gfs,X1tmp_gfs,X2tmp_gfs,find_max_phi,max_phi,temp0,tempx,tempy,xc_prev,yc_prev,zc_prev

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_MOVINGBOX_FOR_BOOSTED_BH_PRIVATE_CARGUMENTS \
CCTK_INT * CCTK_RESTRICT find_max_phi = (cctki_dummy_int = &find_max_phi - &find_max_phi, (CCTK_INT *) CCTKi_VarDataPtr(cctkGH, 0, "MOVINGBOX_FOR_BOOSTED_BH", "find_max_phi")); \
CCTK_REAL * CCTK_RESTRICT max_phi = (cctki_dummy_int = &max_phi - &max_phi, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MOVINGBOX_FOR_BOOSTED_BH", "max_phi")); \
CCTK_REAL * CCTK_RESTRICT temp0 = (cctki_dummy_int = &temp0 - &temp0, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MOVINGBOX_FOR_BOOSTED_BH", "temp0")); \
CCTK_REAL * CCTK_RESTRICT tempx = (cctki_dummy_int = &tempx - &tempx, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MOVINGBOX_FOR_BOOSTED_BH", "tempx")); \
CCTK_REAL * CCTK_RESTRICT tempy = (cctki_dummy_int = &tempy - &tempy, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MOVINGBOX_FOR_BOOSTED_BH", "tempy")); \
CCTK_REAL * CCTK_RESTRICT xc_prev = (cctki_dummy_int = &xc_prev - &xc_prev, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MOVINGBOX_FOR_BOOSTED_BH", "xc_prev")); \
CCTK_REAL * CCTK_RESTRICT yc_prev = (cctki_dummy_int = &yc_prev - &yc_prev, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MOVINGBOX_FOR_BOOSTED_BH", "yc_prev")); \
CCTK_REAL * CCTK_RESTRICT zc_prev = (cctki_dummy_int = &zc_prev - &zc_prev, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "MOVINGBOX_FOR_BOOSTED_BH", "zc_prev"));

#define DECLARE_MOVINGBOX_FOR_BOOSTED_BH_PRIVATE_C2F \
static int CCTKARGNUM_find_max_phi = -1; \
static int CCTKGROUPNUM_max_phi_flag = -1; \
static int CCTKARGNUM_max_phi = -1; \
static int CCTKGROUPNUM_center_origin = -1; \
static int CCTKARGNUM_temp0 = -1; \
static int CCTKGROUPNUM_tmp_gfs = -1; \
static int CCTKARGNUM_tempx = -1; \
static int CCTKARGNUM_tempy = -1; \
static int CCTKARGNUM_xc_prev = -1; \
static int CCTKARGNUM_yc_prev = -1; \
static int CCTKARGNUM_zc_prev = -1;

#define INITIALISE_MOVINGBOX_FOR_BOOSTED_BH_PRIVATE_C2F \
if(CCTKARGNUM_find_max_phi == -1) CCTKARGNUM_find_max_phi = CCTK_VarIndex("movingbox_for_boosted_bh::find_max_phi"); \
if(CCTKGROUPNUM_max_phi_flag == -1) CCTKGROUPNUM_max_phi_flag = CCTK_GroupIndex("movingbox_for_boosted_bh::max_phi_flag"); \
if(CCTKARGNUM_max_phi == -1) CCTKARGNUM_max_phi = CCTK_VarIndex("movingbox_for_boosted_bh::max_phi"); \
if(CCTKGROUPNUM_center_origin == -1) CCTKGROUPNUM_center_origin = CCTK_GroupIndex("movingbox_for_boosted_bh::center_origin"); \
if(CCTKARGNUM_temp0 == -1) CCTKARGNUM_temp0 = CCTK_VarIndex("movingbox_for_boosted_bh::temp0"); \
if(CCTKGROUPNUM_tmp_gfs == -1) CCTKGROUPNUM_tmp_gfs = CCTK_GroupIndex("movingbox_for_boosted_bh::tmp_gfs"); \
if(CCTKARGNUM_tempx == -1) CCTKARGNUM_tempx = CCTK_VarIndex("movingbox_for_boosted_bh::tempx"); \
if(CCTKARGNUM_tempy == -1) CCTKARGNUM_tempy = CCTK_VarIndex("movingbox_for_boosted_bh::tempy"); \
if(CCTKARGNUM_xc_prev == -1) CCTKARGNUM_xc_prev = CCTK_VarIndex("movingbox_for_boosted_bh::xc_prev"); \
if(CCTKARGNUM_yc_prev == -1) CCTKARGNUM_yc_prev = CCTK_VarIndex("movingbox_for_boosted_bh::yc_prev"); \
if(CCTKARGNUM_zc_prev == -1) CCTKARGNUM_zc_prev = CCTK_VarIndex("movingbox_for_boosted_bh::zc_prev");

#define MOVINGBOX_FOR_BOOSTED_BH_PRIVATE_C2F_PROTO \
const int *,const int *,const int *,CCTK_INT *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *

#define PASS_MOVINGBOX_FOR_BOOSTED_BH_PRIVATE_C2F(GH) \
PASS_GROUPSIZE(tmp_gfs, 0),\
PASS_GROUPSIZE(tmp_gfs, 1),\
PASS_GROUPSIZE(tmp_gfs, 2),\
(CCTK_INT *)(PASS_REFERENCE(find_max_phi, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(max_phi, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(temp0, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(tempx, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(tempy, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(xc_prev, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(yc_prev, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(zc_prev, 0))

#endif /* CCODE */

#ifdef FCODE
#define DECLARE_MOVINGBOX_FOR_BOOSTED_BH_PROTECTED_FARGUMENTS \
INTEGER X0BSSN_AH&&\
...
#define MOVINGBOX_FOR_BOOSTED_BH_PROTECTED_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_MOVINGBOX_FOR_BOOSTED_BH_PROTECTED_CARGUMENTS \
...
#define DECLARE_MOVINGBOX_FOR_BOOSTED_BH_PROTECTED_C2F \
...
#define INITIALISE_MOVINGBOX_FOR_BOOSTED_BH_PROTECTED_C2F \
...
#define MOVINGBOX_FOR_BOOSTED_BH_PROTECTED_C2F_PROTO \
...
#define PASS_MOVINGBOX_FOR_BOOSTED_BH_PROTECTED_C2F(GH) \
...
#ifdef FCODE
#define DECLARE_MOVINGBOX_FOR_BOOSTED_BH_PUBLIC_FARGUMENTS \
...
#define MOVINGBOX_FOR_BOOSTED_BH_PUBLIC_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_MOVINGBOX_FOR_BOOSTED_BH_PUBLIC_CARGUMENTS \
...
#define DECLARE_MOVINGBOX_FOR_BOOSTED_BH_PUBLIC_C2F \
...
#define INITIALISE_MOVINGBOX_FOR_BOOSTED_BH_PUBLIC_C2F \
...
#define MOVINGBOX_FOR_BOOSTED_BH_PUBLIC_C2F_PROTO \
...
#define PASS_MOVINGBOX_FOR_BOOSTED_BH_PUBLIC_C2F(GH) \
...
#ifdef FCODE
#define MOVINGBOX_FOR_BOOSTED_BH_FARGUMENTS _CCTK_FARGUMENTS, MOVINGBOX_FOR_BOOSTED_BH_PRIVATE_FARGUMENTS, MOVINGBOX_FOR_BOOSTED_BH_PROTECTED_FARGUMENTS, MOVINGBOX_FOR_BOOSTED_BH_PUBLIC_FARGUMENTS

#define DECLARE_MOVINGBOX_FOR_BOOSTED_BH_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_MOVINGBOX_FOR_BOOSTED_BH_PRIVATE_FARGUMENTS DECLARE_MOVINGBOX_FOR_BOOSTED_BH_PROTECTED_FARGUMENTS DECLARE_MOVINGBOX_FOR_BOOSTED_BH_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_MOVINGBOX_FOR_BOOSTED_BH_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_MOVINGBOX_FOR_BOOSTED_BH_PRIVATE_CARGUMENTS DECLARE_MOVINGBOX_FOR_BOOSTED_BH_PROTECTED_CARGUMENTS DECLARE_MOVINGBOX_FOR_BOOSTED_BH_PUBLIC_CARGUMENTS

#define MOVINGBOX_FOR_BOOSTED_BH_C2F_PROTO _CCTK_C2F_PROTO, MOVINGBOX_FOR_BOOSTED_BH_PRIVATE_C2F_PROTO, MOVINGBOX_FOR_BOOSTED_BH_PROTECTED_C2F_PROTO, MOVINGBOX_FOR_BOOSTED_BH_PUBLIC_C2F_PROTO

#define PASS_MOVINGBOX_FOR_BOOSTED_BH_C2F(GH) _PASS_CCTK_C2F(GH), PASS_MOVINGBOX_FOR_BOOSTED_BH_PRIVATE_C2F(GH), PASS_MOVINGBOX_FOR_BOOSTED_BH_PROTECTED_C2F(GH), PASS_MOVINGBOX_FOR_BOOSTED_BH_PUBLIC_C2F(GH)

#define DECLARE_MOVINGBOX_FOR_BOOSTED_BH_C2F _DECLARE_CCTK_C2F DECLARE_MOVINGBOX_FOR_BOOSTED_BH_PRIVATE_C2F DECLARE_MOVINGBOX_FOR_BOOSTED_BH_PROTECTED_C2F DECLARE_MOVINGBOX_FOR_BOOSTED_BH_PUBLIC_C2F

#define INITIALISE_MOVINGBOX_FOR_BOOSTED_BH_C2F _INITIALISE_CCTK_C2F INITIALISE_MOVINGBOX_FOR_BOOSTED_BH_PRIVATE_C2F INITIALISE_MOVINGBOX_FOR_BOOSTED_BH_PROTECTED_C2F INITIALISE_MOVINGBOX_FOR_BOOSTED_BH_PUBLIC_C2F

#define MOVINGBOX_FOR_BOOSTED_BH_CARGUMENTS cGH *cctkGH
