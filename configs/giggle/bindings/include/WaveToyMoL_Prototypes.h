/*@@
   @header  WaveToyMoL_Prototypes.h
...
#ifndef _WAVETOYMOL_PROTOTYPES_H_
#define _WAVETOYMOL_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_WAVETOYMOL_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
