/*@@
   @header  mhd_evolve_Prototypes.h
...
#ifndef _MHD_EVOLVE_PROTOTYPES_H_
#define _MHD_EVOLVE_PROTOTYPES_H_  1
...
#ifdef FCODE
#ifdef F90CODE
#define DECLARE_MHD_EVOLVE_FUNCTIONS _DECLARE_CCTK_FUNCTIONS \
  interface &&\
