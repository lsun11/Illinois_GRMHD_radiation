/*@@
   @header  lapse_CParameters.h
   @author  Automatically generated by CreateParameterBindings.pl
   @desc
            Declares parameters of thorn lapse
   @enddesc
 @@*/


#ifndef _LAPSE_PARAMETERS_H_
#define _LAPSE_PARAMETERS_H_ 1

#include "ParameterCGlobal.h"
#include "ParameterCRestrictedLAPSE.h"
#include "ParameterCPrivateLAPSE.h"
...
#define DECLARE_CCTK_PARAMETERS \
  ...
  DECLARE_RESTRICTED_LAPSE_STRUCT_PARAMS \
  DECLARE_PRIVATE_LAPSE_STRUCT_PARAMS \
