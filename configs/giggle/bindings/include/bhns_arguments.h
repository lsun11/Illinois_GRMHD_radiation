/*@@
   @header  bhns_arguments.h
   @author  Automatically generated by GridFuncStuff.pl
   @desc
            Defines macros to declare/define/pass function arguments
            in calls from C to Fortran for thorn bhns
   @enddesc
 @@*/


#ifdef FCODE
#define DECLARE_BHNS_PRIVATE_FARGUMENTS \
...
CCTK_REAL Axintr(X0Axyzintrgroup,X1Axyzintrgroup,X2Axyzintrgroup)&&\
CCTK_REAL Ayintr(X0Axyzintrgroup,X1Axyzintrgroup,X2Axyzintrgroup)&&\
CCTK_REAL Azintr(X0Axyzintrgroup,X1Axyzintrgroup,X2Axyzintrgroup)&&\
CCTK_REAL M0dot_last&&\
CCTK_REAL Pintr(X0Axyzintrgroup,X1Axyzintrgroup,X2Axyzintrgroup)&&\
CCTK_REAL ah_radii_last(X0last_ah_data)&&\
CCTK_INT bhnsEthermalNOW&&\
CCTK_INT bhns_rk4_particle_tracer_step&&\
CCTK_INT bhnsinsertBNOW&&\
CCTK_INT bhnsinsertRADNOW&&\
CCTK_REAL int_M0dot&&\
CCTK_REAL local_density(X0Tracergroup)&&\
CCTK_REAL m1_minus_u_lower_zero(X0Tracergroup)&&\
CCTK_REAL rhobintr(X0Axyzintrgroup,X1Axyzintrgroup,X2Axyzintrgroup)&&\
CCTK_REAL t_last&&\
CCTK_REAL taul_rhs(X0Tracer_rhs_group,X1Tracer_rhs_group)&&\
CCTK_REAL tracer_taul(X0Tracergroup)&&\
CCTK_REAL tracer_x(X0Tracergroup)&&\
CCTK_REAL tracer_xc(X0Tracergroup)&&\
CCTK_REAL tracer_y(X0Tracergroup)&&\
CCTK_REAL tracer_yc(X0Tracergroup)&&\
CCTK_REAL tracer_z(X0Tracergroup)&&\
CCTK_REAL u_x_local(X0Tracergroup)&&\
CCTK_REAL u_y_local(X0Tracergroup)&&\
CCTK_REAL x_rhs(X0Tracer_rhs_group,X1Tracer_rhs_group)&&\
CCTK_REAL xc_rhs(X0Tracer_rhs_group,X1Tracer_rhs_group)&&\
CCTK_REAL xh_last&&\
CCTK_REAL y_rhs(X0Tracer_rhs_group,X1Tracer_rhs_group)&&\
CCTK_REAL yc_rhs(X0Tracer_rhs_group,X1Tracer_rhs_group)&&\
CCTK_REAL yh_last&&\
CCTK_REAL z_rhs(X0Tracer_rhs_group,X1Tracer_rhs_group)&&\
CCTK_REAL zh_last&&\


#define BHNS_PRIVATE_FARGUMENTS \
X0Axyzintrgroup,X0Tracer_rhs_group,X0Tracergroup,X0last_ah_data,X1Axyzintrgroup,X1Tracer_rhs_group,X2Axyzintrgroup,Axintr,Ayintr,Azintr,M0dot_last,Pintr,ah_radii_last,bhnsEthermalNOW,bhns_rk4_particle_tracer_step,bhnsinsertBNOW,bhnsinsertRADNOW,int_M0dot,local_density,m1_minus_u_lower_zero,rhobintr,t_last,taul_rhs,tracer_taul,tracer_x,tracer_xc,tracer_y,tracer_yc,tracer_z,u_x_local,u_y_local,x_rhs,xc_rhs,xh_last,y_rhs,yc_rhs,yh_last,z_rhs,zh_last

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_BHNS_PRIVATE_CARGUMENTS \
CCTK_REAL * CCTK_RESTRICT Axintr = (cctki_dummy_int = &Axintr - &Axintr, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "Axintr")); \
CCTK_REAL * CCTK_RESTRICT Ayintr = (cctki_dummy_int = &Ayintr - &Ayintr, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "Ayintr")); \
CCTK_REAL * CCTK_RESTRICT Azintr = (cctki_dummy_int = &Azintr - &Azintr, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "Azintr")); \
CCTK_REAL * CCTK_RESTRICT M0dot_last = (cctki_dummy_int = &M0dot_last - &M0dot_last, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "M0dot_last")); \
CCTK_REAL * CCTK_RESTRICT Pintr = (cctki_dummy_int = &Pintr - &Pintr, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "Pintr")); \
CCTK_REAL * CCTK_RESTRICT ah_radii_last = (cctki_dummy_int = &ah_radii_last - &ah_radii_last, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "ah_radii_last")); \
CCTK_INT * CCTK_RESTRICT bhnsEthermalNOW = (cctki_dummy_int = &bhnsEthermalNOW - &bhnsEthermalNOW, (CCTK_INT *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "bhnsEthermalNOW")); \
CCTK_INT * CCTK_RESTRICT bhns_rk4_particle_tracer_step = (cctki_dummy_int = &bhns_rk4_particle_tracer_step - &bhns_rk4_particle_tracer_step, (CCTK_INT *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "bhns_rk4_particle_tracer_step")); \
CCTK_INT * CCTK_RESTRICT bhnsinsertBNOW = (cctki_dummy_int = &bhnsinsertBNOW - &bhnsinsertBNOW, (CCTK_INT *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "bhnsinsertBNOW")); \
CCTK_INT * CCTK_RESTRICT bhnsinsertRADNOW = (cctki_dummy_int = &bhnsinsertRADNOW - &bhnsinsertRADNOW, (CCTK_INT *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "bhnsinsertRADNOW")); \
CCTK_REAL * CCTK_RESTRICT int_M0dot = (cctki_dummy_int = &int_M0dot - &int_M0dot, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "int_M0dot")); \
CCTK_REAL * CCTK_RESTRICT local_density = (cctki_dummy_int = &local_density - &local_density, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "local_density")); \
CCTK_REAL * CCTK_RESTRICT m1_minus_u_lower_zero = (cctki_dummy_int = &m1_minus_u_lower_zero - &m1_minus_u_lower_zero, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "m1_minus_u_lower_zero")); \
CCTK_REAL * CCTK_RESTRICT rhobintr = (cctki_dummy_int = &rhobintr - &rhobintr, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "rhobintr")); \
CCTK_REAL * CCTK_RESTRICT t_last = (cctki_dummy_int = &t_last - &t_last, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "t_last")); \
CCTK_REAL * CCTK_RESTRICT taul_rhs = (cctki_dummy_int = &taul_rhs - &taul_rhs, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "taul_rhs")); \
CCTK_REAL * CCTK_RESTRICT tracer_taul = (cctki_dummy_int = &tracer_taul - &tracer_taul, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "tracer_taul")); \
CCTK_REAL * CCTK_RESTRICT tracer_x = (cctki_dummy_int = &tracer_x - &tracer_x, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "tracer_x")); \
CCTK_REAL * CCTK_RESTRICT tracer_xc = (cctki_dummy_int = &tracer_xc - &tracer_xc, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "tracer_xc")); \
CCTK_REAL * CCTK_RESTRICT tracer_y = (cctki_dummy_int = &tracer_y - &tracer_y, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "tracer_y")); \
CCTK_REAL * CCTK_RESTRICT tracer_yc = (cctki_dummy_int = &tracer_yc - &tracer_yc, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "tracer_yc")); \
CCTK_REAL * CCTK_RESTRICT tracer_z = (cctki_dummy_int = &tracer_z - &tracer_z, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "tracer_z")); \
CCTK_REAL * CCTK_RESTRICT u_x_local = (cctki_dummy_int = &u_x_local - &u_x_local, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "u_x_local")); \
CCTK_REAL * CCTK_RESTRICT u_y_local = (cctki_dummy_int = &u_y_local - &u_y_local, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "u_y_local")); \
CCTK_REAL * CCTK_RESTRICT x_rhs = (cctki_dummy_int = &x_rhs - &x_rhs, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "x_rhs")); \
CCTK_REAL * CCTK_RESTRICT xc_rhs = (cctki_dummy_int = &xc_rhs - &xc_rhs, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "xc_rhs")); \
CCTK_REAL * CCTK_RESTRICT xh_last = (cctki_dummy_int = &xh_last - &xh_last, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "xh_last")); \
CCTK_REAL * CCTK_RESTRICT y_rhs = (cctki_dummy_int = &y_rhs - &y_rhs, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "y_rhs")); \
CCTK_REAL * CCTK_RESTRICT yc_rhs = (cctki_dummy_int = &yc_rhs - &yc_rhs, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "yc_rhs")); \
CCTK_REAL * CCTK_RESTRICT yh_last = (cctki_dummy_int = &yh_last - &yh_last, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "yh_last")); \
CCTK_REAL * CCTK_RESTRICT z_rhs = (cctki_dummy_int = &z_rhs - &z_rhs, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "z_rhs")); \
CCTK_REAL * CCTK_RESTRICT zh_last = (cctki_dummy_int = &zh_last - &zh_last, (CCTK_REAL *) CCTKi_VarDataPtr(cctkGH, 0, "BHNS", "zh_last"));

#define DECLARE_BHNS_PRIVATE_C2F \
static int CCTKARGNUM_Axintr = -1; \
static int CCTKGROUPNUM_Axyzintrgroup = -1; \
static int CCTKARGNUM_Ayintr = -1; \
static int CCTKARGNUM_Azintr = -1; \
static int CCTKARGNUM_M0dot_last = -1; \
static int CCTKGROUPNUM_int_Mdot = -1; \
static int CCTKARGNUM_Pintr = -1; \
static int CCTKARGNUM_ah_radii_last = -1; \
static int CCTKGROUPNUM_last_ah_data = -1; \
static int CCTKARGNUM_bhnsEthermalNOW = -1; \
static int CCTKGROUPNUM_Tracer_substep_count = -1; \
static int CCTKARGNUM_bhns_rk4_particle_tracer_step = -1; \
static int CCTKARGNUM_bhnsinsertBNOW = -1; \
static int CCTKARGNUM_bhnsinsertRADNOW = -1; \
static int CCTKARGNUM_int_M0dot = -1; \
static int CCTKARGNUM_local_density = -1; \
static int CCTKGROUPNUM_Tracergroup = -1; \
static int CCTKARGNUM_m1_minus_u_lower_zero = -1; \
static int CCTKARGNUM_rhobintr = -1; \
static int CCTKARGNUM_t_last = -1; \
static int CCTKARGNUM_taul_rhs = -1; \
static int CCTKGROUPNUM_Tracer_rhs_group = -1; \
static int CCTKARGNUM_tracer_taul = -1; \
static int CCTKARGNUM_tracer_x = -1; \
static int CCTKARGNUM_tracer_xc = -1; \
static int CCTKARGNUM_tracer_y = -1; \
static int CCTKARGNUM_tracer_yc = -1; \
static int CCTKARGNUM_tracer_z = -1; \
static int CCTKARGNUM_u_x_local = -1; \
static int CCTKARGNUM_u_y_local = -1; \
static int CCTKARGNUM_x_rhs = -1; \
static int CCTKARGNUM_xc_rhs = -1; \
static int CCTKARGNUM_xh_last = -1; \
static int CCTKARGNUM_y_rhs = -1; \
static int CCTKARGNUM_yc_rhs = -1; \
static int CCTKARGNUM_yh_last = -1; \
static int CCTKARGNUM_z_rhs = -1; \
static int CCTKARGNUM_zh_last = -1;

#define INITIALISE_BHNS_PRIVATE_C2F \
if(CCTKARGNUM_Axintr == -1) CCTKARGNUM_Axintr = CCTK_VarIndex("bhns::Axintr"); \
if(CCTKGROUPNUM_Axyzintrgroup == -1) CCTKGROUPNUM_Axyzintrgroup = CCTK_GroupIndex("bhns::Axyzintrgroup"); \
if(CCTKARGNUM_Ayintr == -1) CCTKARGNUM_Ayintr = CCTK_VarIndex("bhns::Ayintr"); \
if(CCTKARGNUM_Azintr == -1) CCTKARGNUM_Azintr = CCTK_VarIndex("bhns::Azintr"); \
if(CCTKARGNUM_M0dot_last == -1) CCTKARGNUM_M0dot_last = CCTK_VarIndex("bhns::M0dot_last"); \
if(CCTKGROUPNUM_int_Mdot == -1) CCTKGROUPNUM_int_Mdot = CCTK_GroupIndex("bhns::int_Mdot"); \
if(CCTKARGNUM_Pintr == -1) CCTKARGNUM_Pintr = CCTK_VarIndex("bhns::Pintr"); \
if(CCTKARGNUM_ah_radii_last == -1) CCTKARGNUM_ah_radii_last = CCTK_VarIndex("bhns::ah_radii_last"); \
if(CCTKGROUPNUM_last_ah_data == -1) CCTKGROUPNUM_last_ah_data = CCTK_GroupIndex("bhns::last_ah_data"); \
if(CCTKARGNUM_bhnsEthermalNOW == -1) CCTKARGNUM_bhnsEthermalNOW = CCTK_VarIndex("bhns::bhnsEthermalNOW"); \
if(CCTKGROUPNUM_Tracer_substep_count == -1) CCTKGROUPNUM_Tracer_substep_count = CCTK_GroupIndex("bhns::Tracer_substep_count"); \
if(CCTKARGNUM_bhns_rk4_particle_tracer_step == -1) CCTKARGNUM_bhns_rk4_particle_tracer_step = CCTK_VarIndex("bhns::bhns_rk4_particle_tracer_step"); \
if(CCTKARGNUM_bhnsinsertBNOW == -1) CCTKARGNUM_bhnsinsertBNOW = CCTK_VarIndex("bhns::bhnsinsertBNOW"); \
if(CCTKARGNUM_bhnsinsertRADNOW == -1) CCTKARGNUM_bhnsinsertRADNOW = CCTK_VarIndex("bhns::bhnsinsertRADNOW"); \
if(CCTKARGNUM_int_M0dot == -1) CCTKARGNUM_int_M0dot = CCTK_VarIndex("bhns::int_M0dot"); \
if(CCTKARGNUM_local_density == -1) CCTKARGNUM_local_density = CCTK_VarIndex("bhns::local_density"); \
if(CCTKGROUPNUM_Tracergroup == -1) CCTKGROUPNUM_Tracergroup = CCTK_GroupIndex("bhns::Tracergroup"); \
if(CCTKARGNUM_m1_minus_u_lower_zero == -1) CCTKARGNUM_m1_minus_u_lower_zero = CCTK_VarIndex("bhns::m1_minus_u_lower_zero"); \
if(CCTKARGNUM_rhobintr == -1) CCTKARGNUM_rhobintr = CCTK_VarIndex("bhns::rhobintr"); \
if(CCTKARGNUM_t_last == -1) CCTKARGNUM_t_last = CCTK_VarIndex("bhns::t_last"); \
if(CCTKARGNUM_taul_rhs == -1) CCTKARGNUM_taul_rhs = CCTK_VarIndex("bhns::taul_rhs"); \
if(CCTKGROUPNUM_Tracer_rhs_group == -1) CCTKGROUPNUM_Tracer_rhs_group = CCTK_GroupIndex("bhns::Tracer_rhs_group"); \
if(CCTKARGNUM_tracer_taul == -1) CCTKARGNUM_tracer_taul = CCTK_VarIndex("bhns::tracer_taul"); \
if(CCTKARGNUM_tracer_x == -1) CCTKARGNUM_tracer_x = CCTK_VarIndex("bhns::tracer_x"); \
if(CCTKARGNUM_tracer_xc == -1) CCTKARGNUM_tracer_xc = CCTK_VarIndex("bhns::tracer_xc"); \
if(CCTKARGNUM_tracer_y == -1) CCTKARGNUM_tracer_y = CCTK_VarIndex("bhns::tracer_y"); \
if(CCTKARGNUM_tracer_yc == -1) CCTKARGNUM_tracer_yc = CCTK_VarIndex("bhns::tracer_yc"); \
if(CCTKARGNUM_tracer_z == -1) CCTKARGNUM_tracer_z = CCTK_VarIndex("bhns::tracer_z"); \
if(CCTKARGNUM_u_x_local == -1) CCTKARGNUM_u_x_local = CCTK_VarIndex("bhns::u_x_local"); \
if(CCTKARGNUM_u_y_local == -1) CCTKARGNUM_u_y_local = CCTK_VarIndex("bhns::u_y_local"); \
if(CCTKARGNUM_x_rhs == -1) CCTKARGNUM_x_rhs = CCTK_VarIndex("bhns::x_rhs"); \
if(CCTKARGNUM_xc_rhs == -1) CCTKARGNUM_xc_rhs = CCTK_VarIndex("bhns::xc_rhs"); \
if(CCTKARGNUM_xh_last == -1) CCTKARGNUM_xh_last = CCTK_VarIndex("bhns::xh_last"); \
if(CCTKARGNUM_y_rhs == -1) CCTKARGNUM_y_rhs = CCTK_VarIndex("bhns::y_rhs"); \
if(CCTKARGNUM_yc_rhs == -1) CCTKARGNUM_yc_rhs = CCTK_VarIndex("bhns::yc_rhs"); \
if(CCTKARGNUM_yh_last == -1) CCTKARGNUM_yh_last = CCTK_VarIndex("bhns::yh_last"); \
if(CCTKARGNUM_z_rhs == -1) CCTKARGNUM_z_rhs = CCTK_VarIndex("bhns::z_rhs"); \
if(CCTKARGNUM_zh_last == -1) CCTKARGNUM_zh_last = CCTK_VarIndex("bhns::zh_last");

#define BHNS_PRIVATE_C2F_PROTO \
const int *,const int *,const int *,const int *,const int *,const int *,const int *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_INT *,CCTK_INT *,CCTK_INT *,CCTK_INT *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *,CCTK_REAL *

#define PASS_BHNS_PRIVATE_C2F(GH) \
PASS_GROUPSIZE(Axyzintrgroup, 0),\
PASS_GROUPSIZE(Tracer_rhs_group, 0),\
PASS_GROUPSIZE(Tracergroup, 0),\
PASS_GROUPSIZE(last_ah_data, 0),\
PASS_GROUPSIZE(Axyzintrgroup, 1),\
PASS_GROUPSIZE(Tracer_rhs_group, 1),\
PASS_GROUPSIZE(Axyzintrgroup, 2),\
(CCTK_REAL *)(PASS_REFERENCE(Axintr, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(Ayintr, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(Azintr, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(M0dot_last, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(Pintr, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(ah_radii_last, 0)),\
(CCTK_INT *)(PASS_REFERENCE(bhnsEthermalNOW, 0)),\
(CCTK_INT *)(PASS_REFERENCE(bhns_rk4_particle_tracer_step, 0)),\
(CCTK_INT *)(PASS_REFERENCE(bhnsinsertBNOW, 0)),\
(CCTK_INT *)(PASS_REFERENCE(bhnsinsertRADNOW, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(int_M0dot, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(local_density, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(m1_minus_u_lower_zero, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(rhobintr, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(t_last, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(taul_rhs, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(tracer_taul, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(tracer_x, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(tracer_xc, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(tracer_y, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(tracer_yc, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(tracer_z, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(u_x_local, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(u_y_local, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(x_rhs, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(xc_rhs, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(xh_last, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(y_rhs, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(yc_rhs, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(yh_last, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(z_rhs, 0)),\
(CCTK_REAL *)(PASS_REFERENCE(zh_last, 0))

#endif /* CCODE */

#ifdef FCODE
#define DECLARE_BHNS_PROTECTED_FARGUMENTS \
INTEGER X0BSSN_AH&&\
...
#define BHNS_PROTECTED_FARGUMENTS \
...
#ifdef CCODE
#define DECLARE_BHNS_PROTECTED_CARGUMENTS \
...
#define DECLARE_BHNS_PROTECTED_C2F \
...
#define INITIALISE_BHNS_PROTECTED_C2F \
...
#define BHNS_PROTECTED_C2F_PROTO \
...
#define PASS_BHNS_PROTECTED_C2F(GH) \
...
#ifdef FCODE
#define DECLARE_BHNS_PUBLIC_FARGUMENTS \
...
#define DECLARE_BHNS_PUBLIC_C2F \
...
#define INITIALISE_BHNS_PUBLIC_C2F \
...
#ifdef FCODE
#define BHNS_FARGUMENTS _CCTK_FARGUMENTS, BHNS_PRIVATE_FARGUMENTS, BHNS_PROTECTED_FARGUMENTS, BHNS_PUBLIC_FARGUMENTS

#define DECLARE_BHNS_FARGUMENTS _DECLARE_CCTK_FARGUMENTS DECLARE_BHNS_PRIVATE_FARGUMENTS DECLARE_BHNS_PROTECTED_FARGUMENTS DECLARE_BHNS_PUBLIC_FARGUMENTS

#endif /* FCODE */

#ifdef CCODE
#define DECLARE_BHNS_CARGUMENTS _DECLARE_CCTK_CARGUMENTS DECLARE_BHNS_PRIVATE_CARGUMENTS DECLARE_BHNS_PROTECTED_CARGUMENTS DECLARE_BHNS_PUBLIC_CARGUMENTS

#define BHNS_C2F_PROTO _CCTK_C2F_PROTO, BHNS_PRIVATE_C2F_PROTO, BHNS_PROTECTED_C2F_PROTO, BHNS_PUBLIC_C2F_PROTO

#define PASS_BHNS_C2F(GH) _PASS_CCTK_C2F(GH), PASS_BHNS_PRIVATE_C2F(GH), PASS_BHNS_PROTECTED_C2F(GH), PASS_BHNS_PUBLIC_C2F(GH)

#define DECLARE_BHNS_C2F _DECLARE_CCTK_C2F DECLARE_BHNS_PRIVATE_C2F DECLARE_BHNS_PROTECTED_C2F DECLARE_BHNS_PUBLIC_C2F

#define INITIALISE_BHNS_C2F _INITIALISE_CCTK_C2F INITIALISE_BHNS_PRIVATE_C2F INITIALISE_BHNS_PROTECTED_C2F INITIALISE_BHNS_PUBLIC_C2F

#define BHNS_CARGUMENTS cGH *cctkGH
