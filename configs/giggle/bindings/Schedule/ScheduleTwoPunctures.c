...
extern int CCTK_FNAME(TwoPunctures_read_inputfile_driver)(void);
extern int CCTK_FNAME(TwoPunctures_initialdata)(void);
extern int CCTK_FNAME(TwoPunctures_diagnostics)(void);
...
void CCTKi_BindingsSchedule_TwoPunctures(void)
{
  ...
  CCTKi_ScheduleGroupStorage("TwoPunctures::M_ADM",1);
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(TwoPunctures_read_inputfile_driver),
                           "TwoPunctures_readinfiles",
                           "TwoPunctures",
                           "TwoPunctures",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(TwoPunctures_initialdata),
                           "TwoPunctures_initialdata",
                           "TwoPunctures",
                           "TwoPunctures",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(TwoPunctures_diagnostics),
                           "poststep",
                           "TwoPunctures",
                           "TwoPunctures",
