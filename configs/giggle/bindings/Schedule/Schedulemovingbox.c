...
extern int CCTK_FNAME(compute_movingbox_vol_integrands)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_movingbox)(void);
extern int CCTK_FNAME(movingbox_update_centers)(void);
...
void CCTKi_BindingsSchedule_movingbox(void)
{
  ...
  CCTKi_ScheduleGroupStorage("movingbox::diag_movingbox_gf",1);
  {
    ...
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(compute_movingbox_vol_integrands),
  ...
  }
  {
    ...
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(Integrate_vol_integrand_movingbox),
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(movingbox_update_centers),
