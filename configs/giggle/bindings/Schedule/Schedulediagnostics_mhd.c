...
extern int CCTK_FNAME(kinetic_energy_T_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(minternal_hybrid_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(fluid_energy_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(em_energy_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(mag_energies_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(em_energy2_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(b_phi_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(monopole_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(radiation_energy_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(CoM_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(meq0_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(meq12_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(meq34_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(meq56_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(bremsstrahlung_qei_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(bremsstrahlung_qee_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(synchrotron_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(rest_mass_4surf_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(fluid_energy_4surf_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(fluid_J_4surf_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(minternal_hybrid_4surf_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(minternal_cold_hybrid_4surf_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(rest_mass_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(rest_mass_inside_AH_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(escaping_rest_mass_30M_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(escaping_rest_mass_50M_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(escaping_rest_mass_70M_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
extern int CCTK_FNAME(escaping_rest_mass_100M_integrand)(void);
extern int CCTK_FNAME(Integrate_vol_integrand_mhd)(void);
...
void CCTKi_BindingsSchedule_diagnostics_mhd(void)
{
  ...
  CCTKi_ScheduleGroupStorage("diagnostics_mhd::volIntegrals_mhd",1);
  {
    ...
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(kinetic_energy_T_integrand),
                           "T_integrand",
                           "diagnostics_mhd",
                           "diagnostics_mhd",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(Integrate_vol_integrand_mhd),
                           "T_integrate",
                           "diagnostics_mhd",
                           "diagnostics_mhd",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(minternal_hybrid_integrand),
                           "minternal_integrand",
                           "diagnostics_mhd",
                           "diagnostics_mhd",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(fluid_energy_integrand),
...
if(em_evolve_enable==1) {
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(em_energy_integrand),
                           "em_energy_integrand",
                           "diagnostics_mhd",
                           "diagnostics_mhd",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(mag_energies_integrand),
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(em_energy2_integrand),
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(b_phi_integrand),
                           "b_phi_integrand",
                           "diagnostics_mhd",
                           "diagnostics_mhd",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(monopole_integrand),
                           "monopole_integrand",
                           "diagnostics_mhd",
                           "diagnostics_mhd",
...
if(rad_evolve_enable==1) {
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(radiation_energy_integrand),
                           "rad_integrand",
                           "diagnostics_mhd",
                           "diagnostics_mhd",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(CoM_integrand),
                           "CoM_integrand",
                           "diagnostics_mhd",
                           "diagnostics_mhd",
                           "Fill in Center of Mass integrand",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(meq0_integrand),
                           "meq0_integrand",
                           "diagnostics_mhd",
                           "diagnostics_mhd",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(meq12_integrand),
                           "meq12_integrand",
                           "diagnostics_mhd",
                           "diagnostics_mhd",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(meq34_integrand),
                           "meq34_integrand",
                           "diagnostics_mhd",
                           "diagnostics_mhd",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(meq56_integrand),
                           "meq56_integrand",
                           "diagnostics_mhd",
                           "diagnostics_mhd",
...
if(luminosity_diagnostics==1){
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(bremsstrahlung_qei_integrand),
                           "brem_qei_integrand",
                           "diagnostics_mhd",
                           "diagnostics_mhd",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(bremsstrahlung_qee_integrand),
                           "brem_qee_integrand",
                           "diagnostics_mhd",
                           "diagnostics_mhd",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(synchrotron_integrand),
                           "synch_integrand",
                           "diagnostics_mhd",
                           "diagnostics_mhd",
...
if(const_rad_surf_diagnostics==1){
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(rest_mass_4surf_integrand),
                           "M0_4surf_integrand",
                           "diagnostics_mhd",
                           "diagnostics_mhd",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(fluid_energy_4surf_integrand),
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(fluid_J_4surf_integrand),
                           "J_4surf_integrand",
                           "diagnostics_mhd",
                           "diagnostics_mhd",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(minternal_hybrid_4surf_integrand),
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(minternal_cold_hybrid_4surf_integrand),
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(rest_mass_integrand),
                           "M0_integrand",
                           "diagnostics_mhd",
                           "diagnostics_mhd",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(rest_mass_inside_AH_integrand),
                           "M0_AH_integrand",
                           "diagnostics_mhd",
                           "diagnostics_mhd",
...
if (escape_mass_diag == 1){
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(escaping_rest_mass_30M_integrand),
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(escaping_rest_mass_50M_integrand),
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(escaping_rest_mass_70M_integrand),
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(escaping_rest_mass_100M_integrand),
