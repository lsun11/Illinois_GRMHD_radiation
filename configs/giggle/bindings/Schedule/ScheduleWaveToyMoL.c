...
extern int CCTK_FNAME(WaveToyMol_Startup)(void);
extern int CCTK_FNAME(WaveToyMoL_InitSymBound)(void);
extern int CCTK_FNAME(WaveToyMoL_RegisterVars)(void);
extern int CCTK_FNAME(WaveToyMoL_CalcRHS)(void);
extern int CCTK_FNAME(WaveToyMoL_Boundaries)(void);
extern int CCTK_FNAME(WaveToyMoL_EstimateError)(void);
extern int CCTK_FNAME(WaveToyMoL_EstimateErrorBoundaries)(void);
...
void CCTKi_BindingsSchedule_WaveToyMoL(void)
{
  ...
  CCTKi_ScheduleGroupStorage("WaveToyMoL::scalarevolvedot",1);
  {
    ...
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(WaveToyMol_Startup),
                           "WaveToyMol_Startup",
                           "WaveToyMoL",
                           "WaveToyMoL",
                           "Register banner",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(WaveToyMoL_InitSymBound),
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(WaveToyMoL_RegisterVars),
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(WaveToyMoL_CalcRHS),
                           "WaveToyMoL_CalcRHS",
                           "WaveToyMoL",
                           "WaveToyMoL",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(WaveToyMoL_Boundaries),
...
if (estimate_error)
{
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(WaveToyMoL_EstimateError),
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(WaveToyMoL_EstimateErrorBoundaries),
