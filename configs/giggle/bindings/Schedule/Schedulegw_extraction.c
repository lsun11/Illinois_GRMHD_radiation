...
extern int CCTK_FNAME(setup_gw_extraction)(void);
extern int CCTK_FNAME(PsiKadelia_InitSym)(void);
extern int CCTK_FNAME(PsiKadelia_postregrid)(void);
extern int CCTK_FNAME(PsiKadelia_driver)(void);
extern int CCTK_FNAME(psikad_diagnostics)(void);
...
void CCTKi_BindingsSchedule_gw_extraction(void)
{
  ...
  CCTKi_ScheduleGroupStorage("gw_extraction::Psi4_gw",3);
  {
    ...
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(setup_gw_extraction),
                           "setup_gw_extract",
                           "gw_extraction",
                           "gw_extraction",
  ...
  }
  {
    ...
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(PsiKadelia_InitSym),
                           "PsiKadelia_InitSym",
                           "gw_extraction",
                           "gw_extraction",
                           "Set symmetries",
...
if(cowling_enable==0 && num_extraction_radii>0) {
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(PsiKadelia_postregrid),
                           "PsiKad",
                           "gw_extraction",
                           "gw_extraction",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(PsiKadelia_driver),
                           "PsiKad",
                           "gw_extraction",
                           "gw_extraction",
                           "PsiKadelia scalars and invariants",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(psikad_diagnostics),
                           "psikad_diagnostics",
                           "gw_extraction",
                           "gw_extraction",
