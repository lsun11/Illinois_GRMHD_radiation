...
extern int CCTK_FNAME(mag_bondi_initialdata_part2)(void);
extern int CCTK_FNAME(mag_bondi_initialdata_part2p5)(void);
extern int CCTK_FNAME(mag_bondi_initialdata_part3)(void);
extern int CCTK_FNAME(mag_bondi_analytic_horizon_data)(void);
extern int CCTK_FNAME(driver_mag_bondi_post_regrid)(void);
extern int CCTK_FNAME(driver_mag_bondi_post_regrid)(void);
extern int CCTK_FNAME(driver_mag_bondi_post_regrid)(void);
extern int CCTK_FNAME(driver_mag_bondi_post_regrid)(void);
extern int CCTK_FNAME(mag_bondi_some_radius_conversions)(void);
extern int CCTK_FNAME(mag_bondi_compute_b2)(void);
extern int CCTK_FNAME(diagnostic_mag_bondi_accretion)(void);
...
void CCTKi_BindingsSchedule_mag_bondi(void)
{
  ...
  CCTKi_ScheduleGroupStorage("mag_bondi::horizon_data_arrays",1);
  {
    ...
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(mag_bondi_initialdata_part2),
                           "second_initialdata",
                           "mag_bondi",
                           "mag_bondi",
...
"mag_bondi_postid",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(mag_bondi_initialdata_part2p5),
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(mag_bondi_initialdata_part3),
                           "third_initialdata",
                           "mag_bondi",
                           "mag_bondi",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(mag_bondi_analytic_horizon_data),
                           "forth_initialdata",
                           "mag_bondi",
                           "mag_bondi",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(driver_mag_bondi_post_regrid),
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(mag_bondi_some_radius_conversions),
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(mag_bondi_compute_b2),
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(diagnostic_mag_bondi_accretion),
                           "poststep",
                           "mag_bondi",
                           "mag_bondi",
