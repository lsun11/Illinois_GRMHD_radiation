...
extern int CCTK_FNAME(Setup_Initial_Shift)(void);
extern int CCTK_FNAME(shift_PostInitialData)(void);
extern int shift_RegisterVars(void);
extern int CCTK_FNAME(shift_timestepping)(void);
extern int CCTK_FNAME(shift_update_bc)(void);
extern int CCTK_FNAME(shift_postbc)(void);
...
void CCTKi_BindingsSchedule_shift(void)
{
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(Setup_Initial_Shift),
                           "shift_initialdata",
                           "shift",
                           "shift",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(shift_PostInitialData),
                           "shiftpostid",
                           "shift",
                           "shift",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(shift_timestepping),
                           "shift_rhs",
                           "shift",
                           "shift",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(shift_update_bc),
                           "shift_update_bc",
                           "shift",
                           "shift",
                           "Update shift bc's",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(shift_postbc),
                           "shift_postbc",
                           "shift",
                           "shift",
