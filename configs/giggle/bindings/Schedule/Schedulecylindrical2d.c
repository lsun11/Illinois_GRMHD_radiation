...
extern int CCTK_FNAME(cylindrical2d_initialdata_local)(void);
extern int CCTK_FNAME(cylindrical2d_initialdata_global)(void);
extern int CCTK_FNAME(cylindrical2d_recompute_primitives)(void);
extern int CCTK_FNAME(cylindrical2d_compute_b2_u0)(void);
...
void CCTKi_BindingsSchedule_cylindrical2d(void)
{
  ...
  CCTKi_ScheduleGroupStorage("diagnostics_mhd::volIntegrals_mhd",1);
  {
    ...
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(cylindrical2d_initialdata_local),
                           "cy_initialdata",
                           "cylindrical2d",
                           "cylindrical2d",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(cylindrical2d_initialdata_global),
                           "third_initialdata",
                           "cylindrical2d",
                           "cylindrical2d",
                           "Set rho_b_atm, etc.",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(cylindrical2d_recompute_primitives),
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(cylindrical2d_compute_b2_u0),
                           "compute_b2_u0",
                           "cylindrical2d",
                           "cylindrical2d",
