...
extern int CCTK_FNAME(disk_powerlaw_matter_id)(void);
extern int CCTK_FNAME(disk_powerlaw_compute_rho_b_atm)(void);
extern int CCTK_FNAME(disk_powerlaw_setup_remaining_matter_quantities)(void);
extern int CCTK_FNAME(disk_powerlaw_compute_P_max)(void);
extern int CCTK_FNAME(disk_powerlaw_setup_emfields)(void);
extern int CCTK_FNAME(disk_powerlaw_compute_rhostar_tau_max)(void);
extern int CCTK_FNAME(disk_powerlaw_recompute_primitives)(void);
extern int CCTK_FNAME(driver_spatial_derivs)(void);
extern int CCTK_FNAME(disk_powerlaw_diagnostics)(void);
extern int CCTK_FNAME(disk_powerlaw_diagnostics)(void);
...
void CCTKi_BindingsSchedule_disk_powerlaw(void)
{
  ...
  CCTKi_ScheduleGroupStorage("mhd_evolve::mhd_temps",1);
  {
    ...
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(disk_powerlaw_matter_id),
                           "matter_id",
                           "disk_powerlaw",
                           "disk_powerlaw",
...
"disk_powerlaw_postid",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(disk_powerlaw_compute_rho_b_atm),
                           "first_postid",
                           "disk_powerlaw",
                           "disk_powerlaw",
                           "Compute rho_b_atm",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(disk_powerlaw_setup_remaining_matter_quantities),
                           "second_postid",
                           "disk_powerlaw",
                           "disk_powerlaw",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(disk_powerlaw_compute_P_max),
                           "third_postid",
                           "disk_powerlaw",
                           "disk_powerlaw",
                           "Compute P_max",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(disk_powerlaw_setup_emfields),
                           "fourth_postid",
                           "disk_powerlaw",
                           "disk_powerlaw",
                           "Set up emfields",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(disk_powerlaw_compute_rhostar_tau_max),
                           "fifth_postid",
                           "disk_powerlaw",
                           "disk_powerlaw",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(disk_powerlaw_recompute_primitives),
                           "sixth_postid",
                           "disk_powerlaw",
                           "disk_powerlaw",
...
if (1==1){
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(driver_spatial_derivs),
                           "spatial_derivs",
                           "disk_powerlaw",
                           "disk_powerlaw",
  ...
  {
    int cctkschedulei_tlevelarray[] = {0};
    CCTKi_ScheduleFunction((void *)CCTK_FNAME(disk_powerlaw_diagnostics),
                           "poststep_hydro",
                           "disk_powerlaw",
                           "disk_powerlaw",
